...
public uint teleport_protect_time { get; set; }  
 /// <summary> : </summary>
public uint absorb_stun_buff_pause { get; set; }  } [Serializable] public class passive:IShowSchemeConfig,IGameConfig {  
 /// <summary> : </summary>
