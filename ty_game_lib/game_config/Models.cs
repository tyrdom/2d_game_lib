...
public int LocalRotate { get; set; }  
 /// <summary> 超过对手的steady值才可以造成stun效果: </summary>
...
public int[] GrassIdx { get; set; }  
 /// <summary> : </summary>
public int[] PoolIdx { get; set; }  } [Serializable] public enum item_id{[Description("exp")]@exp,[Description("chip_2")]@chip_2,[Description("chip_4")]@chip_4,[Description("chip_3")]@chip_3,[Description("rand_show")]@rand_show,[Description("coin")]@coin,[Description("chip")]@chip,[Description("free_ticket")]@free_ticket}[Serializable] public enum ItemType{[Description("forShow")]@forShow,[Description("battle_exp")]@battle_exp,[Description("money")]@money,[Description("bag")]@bag}[Serializable] public enum play_buff_id{[Description("pullMark")]@pullMark,[Description("makeDamageAdd")]@makeDamageAdd,[Description("changeComboStatus")]@changeComboStatus,[Description("takeDamageAdd")]@takeDamageAdd,[Description("takeDamageDecrease")]@takeDamageDecrease,[Description("break")]@break,[Description("bow_damage_up")]@bow_damage_up,[Description("tough_up")]@tough_up,[Description("makeDamageAdd2")]@makeDamageAdd2,[Description("maxSpeedDown")]@maxSpeedDown,[Description("bow_power_up")]@bow_power_up,[Description("hitDaze")]@hitDaze,[Description("tough")]@tough}[Serializable] public enum can_be_hit{[Description("vehicle")]@vehicle,[Description("character")]@character,[Description("trap")]@trap}[Serializable] public enum action_type{[Description("interaction")]@interaction,[Description("prop")]@prop,[Description("skill")]@skill}[Serializable] public enum hit_media{[Description("lock_area")]@lock_area,[Description("radar_wave")]@radar_wave,[Description("bullet")]@bullet}[Serializable] public enum botOp{[Description("op1")]@op1,[Description("op2")]@op2,[Description("none")]@none}[Serializable] public enum size{[Description("big")]@big,[Description("default")]@default,[Description("medium")]@medium,[Description("tiny")]@tiny,[Description("small")]@small}[Serializable] public enum interactableType{[Description("default")]@default,[Description("weapon")]@weapon,[Description("prop")]@prop,[Description("vehicle")]@vehicle}[Serializable] public enum bullet_id{[Description("test_ss_l_1_b_3")]@test_ss_l_1_b_3,[Description("test_ss_l_1_b_2")]@test_ss_l_1_b_2,[Description("test_cb_h_2")]@test_cb_h_2,[Description("test_ss_h_1_b_1")]@test_ss_h_1_b_1,[Description("mine_atk")]@mine_atk,[Description("test_cb_h_1")]@test_cb_h_1,[Description("rocket_punch")]@rocket_punch,[Description("vehicle_boom")]@vehicle_boom,[Description("test_spr_l_1_b_1")]@test_spr_l_1_b_1,[Description("test_cb_l_1")]@test_cb_l_1,[Description("test_axe_l_1_b_3")]@test_axe_l_1_b_3,[Description("test_cb_t_2")]@test_cb_t_2,[Description("test_ss_l_1_b_1")]@test_ss_l_1_b_1,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("default_block_1")]@default_block_1,[Description("test_axe_h_1_b_2")]@test_axe_h_1_b_2,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("test_cb_l_3")]@test_cb_l_3,[Description("test_axe_l_1_b_2")]@test_axe_l_1_b_2,[Description("test_axe_l_1_b_1")]@test_axe_l_1_b_1,[Description("test_ss_h_1_sp_1")]@test_ss_h_1_sp_1,[Description("test_cb_h_3")]@test_cb_h_3,[Description("test_cb_l_2")]@test_cb_l_2,[Description("test_b_1_b_1")]@test_b_1_b_1,[Description("test_l_1_k_1")]@test_l_1_k_1,[Description("test_cb_t_3")]@test_cb_t_3,[Description("test_cb_t_1")]@test_cb_t_1,[Description("test_ss_h_1_b_2")]@test_ss_h_1_b_2,[Description("test_axe_h_1_b_1")]@test_axe_h_1_b_1,[Description("test_spr_h_1_b_1")]@test_spr_h_1_b_1,[Description("test_ss_h_1_sp_2")]@test_ss_h_1_sp_2,[Description("test_spr_l_1_b_2")]@test_spr_l_1_b_2,[Description("test_axe_h_1_b_3")]@test_axe_h_1_b_3,[Description("test_l_1_b_1")]@test_l_1_b_1,[Description("test_spr_l_1_b_3")]@test_spr_l_1_b_3}[Serializable] public enum raw_shape{[Description("round")]@round,[Description("sector")]@sector,[Description("rectangle")]@rectangle,[Description("line")]@line}[Serializable] public enum buff_type{[Description("caught_buff")]@caught_buff,[Description("push_buff")]@push_buff,[Description("pull_buff")]@pull_buff}[Serializable] public enum hit_type{[Description("range")]@range,[Description("melee")]@melee}[Serializable] public enum target_type{[Description("all_team")]@all_team,[Description("other_team")]@other_team}[Serializable] public enum interactionAct{[Description("kick_vehicle")]@kick_vehicle,[Description("get_info")]@get_info,[Description("apply")]@apply,[Description("recycle_cage")]@recycle_cage,[Description("pick_up_cage")]@pick_up_cage,[Description("get_in_vehicle")]@get_in_vehicle}[Serializable] public enum lock_area_id{[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_h_1_lock")]@test_h_1_lock}[Serializable] public enum passive_id{[Description("ticket_add")]@ticket_add,[Description("emergency_armor")]@emergency_armor,[Description("light_armor2")]@light_armor2,[Description("shield_reg_boost")]@shield_reg_boost,[Description("sturdy_up")]@sturdy_up,[Description("armor_absorb")]@armor_absorb,[Description("push_power")]@push_power,[Description("on_break")]@on_break,[Description("sharded_atk")]@sharded_atk,[Description("other_to_hp")]@other_to_hp,[Description("shield_trans")]@shield_trans,[Description("energy_armor")]@energy_armor,[Description("shield_overload")]@shield_overload,[Description("emergency_shield")]@emergency_shield,[Description("weakness")]@weakness,[Description("shield_overload1")]@shield_overload1,[Description("sturdy_weight_up")]@sturdy_weight_up,[Description("revenge")]@revenge,[Description("vicious_armor1")]@vicious_armor1,[Description("charge_boost")]@charge_boost,[Description("vicious_armor")]@vicious_armor,[Description("prop_boost")]@prop_boost,[Description("main_atk_small")]@main_atk_small,[Description("ammo_absorb")]@ammo_absorb,[Description("other_to_shield")]@other_to_shield,[Description("light_armor1")]@light_armor1,[Description("back_stab")]@back_stab,[Description("light_armor")]@light_armor,[Description("weight_up")]@weight_up,[Description("protect_time_boost")]@protect_time_boost,[Description("defence_boost")]@defence_boost,[Description("sharded_atk_power")]@sharded_atk_power,[Description("reload_boost")]@reload_boost,[Description("life_power")]@life_power,[Description("speed_boost")]@speed_boost,[Description("recycle_boost")]@recycle_boost,[Description("hp_absorb")]@hp_absorb,[Description("tough_max")]@tough_max,[Description("shield_absorb")]@shield_absorb,[Description("stun_power")]@stun_power,[Description("max_ammo_boost")]@max_ammo_boost,[Description("main_atk_power")]@main_atk_power,[Description("hp_boost")]@hp_boost,[Description("absorb_up")]@absorb_up,[Description("shield_boost")]@shield_boost,[Description("protect_absorb")]@protect_absorb,[Description("shield_trans1")]@shield_trans1,[Description("trap_atk")]@trap_atk,[Description("fix_boost")]@fix_boost,[Description("armor_boost")]@armor_boost,[Description("main_atk")]@main_atk,[Description("sharded_atk_small")]@sharded_atk_small,[Description("heal_effect_boost")]@heal_effect_boost,[Description("ticket_add_5")]@ticket_add_5,[Description("other_to_armor")]@other_to_armor,[Description("trap_survive")]@trap_survive,[Description("back_stab_small")]@back_stab_small,[Description("sweep")]@sweep}[Serializable] public enum passive_type{[Description("Regen")]@Regen,[Description("TickAdd")]@TickAdd,[Description("TrapAbout")]@TrapAbout,[Description("AbsorbAdd")]@AbsorbAdd,[Description("TransRegeneration")]@TransRegeneration,[Description("StunFix")]@StunFix,[Description("Other")]@Other,[Description("AddItem")]@AddItem,[Description("Attack")]@Attack,[Description("Survive")]@Survive,[Description("SpecialDamageAdd")]@SpecialDamageAdd,[Description("HitWinBuff")]@HitWinBuff}[Serializable] public enum play_buff_effect_type{[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("PullMark")]@PullMark,[Description("MaxSpeedChange")]@MaxSpeedChange,[Description("ChangeComboStatus")]@ChangeComboStatus,[Description("ToughUp")]@ToughUp,[Description("Break")]@Break,[Description("PowerUp")]@PowerUp,[Description("Tough")]@Tough,[Description("TakeDamageAdd")]@TakeDamageAdd}[Serializable] public enum stack_mode{[Description("OverWrite")]@OverWrite,[Description("Time")]@Time,[Description("Stack")]@Stack}[Serializable] public enum prop_id{[Description("ammos")]@ammos,[Description("heal")]@heal,[Description("repair")]@repair,[Description("radar")]@radar,[Description("all_reg")]@all_reg,[Description("trap")]@trap,[Description("alert")]@alert,[Description("rocket_boost")]@rocket_boost,[Description("battery")]@battery}[Serializable] public enum effect_media_type{[Description("radar_wave")]@radar_wave,[Description("self")]@self,[Description("summon")]@summon,[Description("bullet")]@bullet}[Serializable] public enum bot_use_cond{[Description("EnemyOnSight")]@EnemyOnSight,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("HpBlowPercent")]@HpBlowPercent,[Description("CantUse")]@CantUse,[Description("ShieldBlowPercent")]@ShieldBlowPercent}[Serializable] public enum PushType{[Description("Vector")]@Vector,[Description("Center")]@Center}[Serializable] public enum radar_wave_id{[Description("mine_trick_r")]@mine_trick_r,[Description("alert_trick_r")]@alert_trick_r,[Description("r1")]@r1}[Serializable] public enum sale_type{[Description("prop")]@prop,[Description("weapon")]@weapon,[Description("passive")]@passive}[Serializable] public enum self_id{[Description("c1")]@c1,[Description("r1")]@r1,[Description("h1")]@h1,[Description("a1")]@a1,[Description("f1")]@f1}[Serializable] public enum skill_id{[Description("test_sword_shield_l_2")]@test_sword_shield_l_2,[Description("axe_block")]@axe_block,[Description("test_r_1")]@test_r_1,[Description("test_axe_h_3")]@test_axe_h_3,[Description("test_bow_switch")]@test_bow_switch,[Description("test_h_2")]@test_h_2,[Description("sword_block")]@sword_block,[Description("test_r_2")]@test_r_2,[Description("test_spear_h_1")]@test_spear_h_1,[Description("test_cross_bow_h_1")]@test_cross_bow_h_1,[Description("test_bow_l_3")]@test_bow_l_3,[Description("test_cross_bow_switch")]@test_cross_bow_switch,[Description("test_spear_l_2")]@test_spear_l_2,[Description("test_spear_switch")]@test_spear_switch,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_axe_h_1")]@test_axe_h_1,[Description("test_axe_l_3")]@test_axe_l_3,[Description("test_r_3")]@test_r_3,[Description("test_cought_skill")]@test_cought_skill,[Description("test_r_s")]@test_r_s,[Description("test_cross_bow_l_1")]@test_cross_bow_l_1,[Description("test_spear_sp_2")]@test_spear_sp_2,[Description("test_l_2")]@test_l_2,[Description("test_l_3")]@test_l_3,[Description("test_spear_l_3")]@test_spear_l_3,[Description("test_axe_l_2")]@test_axe_l_2,[Description("test_spear_l_1")]@test_spear_l_1,[Description("test_axe_l_1")]@test_axe_l_1,[Description("test_spear_block")]@test_spear_block,[Description("test_h_3")]@test_h_3,[Description("test_bow_l_1")]@test_bow_l_1,[Description("test_sword_shield_l_1")]@test_sword_shield_l_1,[Description("test_spear_sp_1")]@test_spear_sp_1,[Description("out_vehicle")]@out_vehicle,[Description("test_s_1")]@test_s_1,[Description("test_bow_h_1")]@test_bow_h_1,[Description("bow_block")]@bow_block,[Description("test_axe_h_2")]@test_axe_h_2,[Description("gun_block")]@gun_block,[Description("test_sword_shield_l_3")]@test_sword_shield_l_3,[Description("cross_bow_block")]@cross_bow_block,[Description("test_h_1")]@test_h_1,[Description("test_sword_shield_h_1")]@test_sword_shield_h_1,[Description("test_bow_l_2")]@test_bow_l_2,[Description("test_cross_bow_h_trick")]@test_cross_bow_h_trick,[Description("test_l_1")]@test_l_1,[Description("test_sword_shield_switch")]@test_sword_shield_switch,[Description("test_axe_switch")]@test_axe_switch,[Description("test_sword_shield_block")]@test_sword_shield_block,[Description("default_take_out")]@default_take_out}[Serializable] public enum op_Act{[Description("Block")]@Block,[Description("Switch")]@Switch,[Description("BreakAway")]@BreakAway,[Description("TakeOut")]@TakeOut,[Description("Op1")]@Op1,[Description("Op2")]@Op2,[Description("CaughtTrick")]@CaughtTrick,[Description("ByTrick")]@ByTrick}[Serializable] public enum weapon_id{[Description("test_sword")]@test_sword,[Description("test_spear")]@test_spear,[Description("test_axe")]@test_axe,[Description("test_sword_shield")]@test_sword_shield,[Description("test_bow")]@test_bow,[Description("test_gun")]@test_gun,[Description("unarmed")]@unarmed,[Description("test_cross_bow")]@test_cross_bow}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum trap_id{[Description("mine")]@mine,[Description("alert")]@alert}[Serializable] public enum vehicle_id{[Description("type_b")]@type_b,[Description("type_a")]@type_a,[Description("type_c")]@type_c}[Serializable] public enum direction{[Description("East")]@East,[Description("South")]@South,[Description("North")]@North,[Description("West")]@West}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bot_other_config), "bot_other_config_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(new_helper), "new_helper_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(pull_buff), "pull_buff_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(sale_unit), "sale_unit_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"},{typeof(map_raws), "map_raws_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_bot","battle_npc","body","bot_other_config","bullet","caught_buff","character","interaction","item","lock_area","new_helper","other_config","passive","play_buff","prop","pull_buff","push_buff","radar_wave","rogue_game_chapter","sale_unit","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon","map_raws"};}[Serializable] public  class ConfigDictionaries { 
