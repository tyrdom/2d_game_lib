...
public float rogueRebornCountDownTime { get; set; }  
 /// <summary> rogue模式复活计时时间: </summary>
public float rogueChapterPassCountDownTime { get; set; }  
 /// <summary> : </summary>
...
public int BigEliteNum { get; set; }  
 /// <summary> : </summary>
public int[] BigBossCreepRandIn { get; set; }  } [Serializable] public class sale_unit:IGameConfig {  
 /// <summary> : </summary>
public int id { get; set; }  
...
public int Snipe2 { get; set; }  
 /// <summary> : </summary>
public int Snipe3 { get; set; }  } [Serializable] public enum item_id{[Description("chip_4")]@chip_4,[Description("chip_3")]@chip_3,[Description("chip")]@chip,[Description("chip_2")]@chip_2,[Description("free_ticket")]@free_ticket,[Description("coin")]@coin,[Description("exp")]@exp}[Serializable] public enum ItemType{[Description("bag")]@bag,[Description("battle_exp")]@battle_exp,[Description("money")]@money}[Serializable] public enum can_be_hit{[Description("vehicle")]@vehicle,[Description("character")]@character,[Description("trap")]@trap}[Serializable] public enum action_type{[Description("prop")]@prop,[Description("skill")]@skill,[Description("interaction")]@interaction}[Serializable] public enum hit_media{[Description("lock_area")]@lock_area,[Description("bullet")]@bullet,[Description("radar_wave")]@radar_wave}[Serializable] public enum botOp{[Description("none")]@none,[Description("op1")]@op1,[Description("op2")]@op2}[Serializable] public enum size{[Description("small")]@small,[Description("tiny")]@tiny,[Description("default")]@default,[Description("big")]@big,[Description("medium")]@medium}[Serializable] public enum interactableType{[Description("weapon")]@weapon,[Description("prop")]@prop,[Description("vehicle")]@vehicle}[Serializable] public enum bullet_id{[Description("vehicle_boom")]@vehicle_boom,[Description("test_l_1_b_1")]@test_l_1_b_1,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("test_r_1_b_1")]@test_r_1_b_1}[Serializable] public enum raw_shape{[Description("line")]@line,[Description("round")]@round,[Description("rectangle")]@rectangle,[Description("sector")]@sector}[Serializable] public enum buff_type{[Description("push_buff")]@push_buff,[Description("caught_buff")]@caught_buff}[Serializable] public enum hit_type{[Description("range")]@range,[Description("melee")]@melee}[Serializable] public enum target_type{[Description("all_team")]@all_team,[Description("other_team")]@other_team}[Serializable] public enum interactionAct{[Description("pick_up_cage")]@pick_up_cage,[Description("recycle_cage")]@recycle_cage,[Description("kick_vehicle")]@kick_vehicle,[Description("get_in_vehicle")]@get_in_vehicle,[Description("get_info")]@get_info,[Description("apply")]@apply}[Serializable] public enum lock_area_id{[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_h_1_lock")]@test_h_1_lock}[Serializable] public enum direction{[Description("North")]@North,[Description("East")]@East,[Description("West")]@West,[Description("South")]@South}[Serializable] public enum passive_id{[Description("back_stab")]@back_stab,[Description("trap_survive")]@trap_survive,[Description("protect_time_boost")]@protect_time_boost,[Description("shield_reg_boost")]@shield_reg_boost,[Description("max_ammo_boost")]@max_ammo_boost,[Description("recycle_boost")]@recycle_boost,[Description("sweep")]@sweep,[Description("shield_boost")]@shield_boost,[Description("ammo_absorb")]@ammo_absorb,[Description("prop_boost")]@prop_boost,[Description("heal_effect_boost")]@heal_effect_boost,[Description("hp_absorb")]@hp_absorb,[Description("main_atk")]@main_atk,[Description("armor_absorb")]@armor_absorb,[Description("ticket_add")]@ticket_add,[Description("defence_boost")]@defence_boost,[Description("sharded_atk")]@sharded_atk,[Description("hp_boost")]@hp_boost,[Description("back_stab_small")]@back_stab_small,[Description("shield_absorb")]@shield_absorb,[Description("protect_absorb")]@protect_absorb,[Description("trap_atk")]@trap_atk,[Description("fix_boost")]@fix_boost,[Description("main_atk_small")]@main_atk_small,[Description("reload_boost")]@reload_boost,[Description("charge_boost")]@charge_boost,[Description("speed_boost")]@speed_boost,[Description("ticket_add_5")]@ticket_add_5,[Description("armor_boost")]@armor_boost,[Description("tough_max")]@tough_max,[Description("sharded_atk_small")]@sharded_atk_small}[Serializable] public enum passive_type{[Description("Attack")]@Attack,[Description("Other")]@Other,[Description("AbsorbAdd")]@AbsorbAdd,[Description("TickAdd")]@TickAdd,[Description("HitWinBuff")]@HitWinBuff,[Description("Regen")]@Regen,[Description("Survive")]@Survive,[Description("TrapAbout")]@TrapAbout,[Description("AddItem")]@AddItem}[Serializable] public enum play_buff_effect_type{[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("Tough")]@Tough,[Description("Break")]@Break,[Description("TakeDamageAdd")]@TakeDamageAdd}[Serializable] public enum stack_mode{[Description("Stack")]@Stack,[Description("Time")]@Time,[Description("OverWrite")]@OverWrite}[Serializable] public enum prop_id{[Description("repair")]@repair,[Description("rocket_boost")]@rocket_boost,[Description("trap")]@trap,[Description("battery")]@battery,[Description("heal")]@heal,[Description("radar")]@radar,[Description("alert")]@alert,[Description("ammos")]@ammos}[Serializable] public enum effect_media_type{[Description("radar_wave")]@radar_wave,[Description("bullet")]@bullet,[Description("self")]@self,[Description("summon")]@summon}[Serializable] public enum bot_use_cond{[Description("ShieldBlowPercent")]@ShieldBlowPercent,[Description("CantUse")]@CantUse,[Description("EnemyOnSight")]@EnemyOnSight,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("HpBlowPercent")]@HpBlowPercent}[Serializable] public enum PushType{[Description("Center")]@Center,[Description("Vector")]@Vector}[Serializable] public enum radar_wave_id{[Description("alert_trick_r")]@alert_trick_r,[Description("r1")]@r1,[Description("mine_trick_r")]@mine_trick_r}[Serializable] public enum sale_type{[Description("prop")]@prop,[Description("passive")]@passive}[Serializable] public enum self_id{[Description("r1")]@r1,[Description("h1")]@h1,[Description("c1")]@c1,[Description("f1")]@f1}[Serializable] public enum skill_id{[Description("out_vehicle")]@out_vehicle,[Description("test_r_1")]@test_r_1,[Description("default_take_out")]@default_take_out,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_h_2")]@test_h_2,[Description("test_r_3")]@test_r_3,[Description("test_r_2")]@test_r_2,[Description("test_h_1")]@test_h_1,[Description("test_h_3")]@test_h_3,[Description("test_cought_skill")]@test_cought_skill,[Description("test_s_1")]@test_s_1,[Description("test_l_2")]@test_l_2,[Description("test_r_s")]@test_r_s,[Description("test_l_1")]@test_l_1,[Description("test_l_3")]@test_l_3}[Serializable] public enum op_Act{[Description("BreakAway")]@BreakAway,[Description("TakeOut")]@TakeOut,[Description("Op2")]@Op2,[Description("CaughtTrick")]@CaughtTrick,[Description("Op1")]@Op1,[Description("Switch")]@Switch}[Serializable] public enum weapon_id{[Description("unarmed")]@unarmed,[Description("test_sword")]@test_sword,[Description("test_gun")]@test_gun}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum vehicle_id{[Description("type_b")]@type_b,[Description("type_c")]@type_c,[Description("type_a")]@type_a}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(sale_unit), "sale_unit_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_bot","battle_npc","body","bullet","caught_buff","character","interaction","item","lock_area","map_raws","other_config","passive","play_buff","prop","push_buff","radar_wave","rogue_game_chapter","sale_unit","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
