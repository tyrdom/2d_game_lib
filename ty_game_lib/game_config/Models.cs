...
public float TotalTime { get; set; }  } [Serializable] public class item:IGameConfig {  
 /// <summary> id: </summary>
...
public int Snipe2 { get; set; }  
 /// <summary> : </summary>
public int Snipe3 { get; set; }  } [Serializable] public enum item_id{[Description("芯片")]@芯片,[Description("芯片_2")]@芯片_2,[Description("代金券")]@代金券,[Description("芯片_4")]@芯片_4,[Description("战斗经验")]@战斗经验,[Description("金币")]@金币,[Description("芯片_3")]@芯片_3}[Serializable] public enum ItemType{[Description("battle_exp")]@battle_exp,[Description("bag")]@bag,[Description("money")]@money}[Serializable] public enum size{[Description("small")]@small,[Description("tiny")]@tiny,[Description("big")]@big,[Description("medium")]@medium,[Description("default")]@default}[Serializable] public enum interactableType{[Description("weapon")]@weapon,[Description("prop")]@prop,[Description("vehicle")]@vehicle}[Serializable] public enum botOp{[Description("none")]@none,[Description("op1")]@op1,[Description("op2")]@op2}[Serializable] public enum bullet_id{[Description("vehicle_boom")]@vehicle_boom,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_l_1_b_1")]@test_l_1_b_1}[Serializable] public enum raw_shape{[Description("rectangle")]@rectangle,[Description("sector")]@sector,[Description("round")]@round}[Serializable] public enum buff_type{[Description("push_buff")]@push_buff,[Description("caught_buff")]@caught_buff}[Serializable] public enum hit_type{[Description("melee")]@melee,[Description("range")]@range}[Serializable] public enum target_type{[Description("other_team")]@other_team,[Description("all_team")]@all_team}[Serializable] public enum interactionAct{[Description("get_in_vehicle")]@get_in_vehicle,[Description("pick_up_cage")]@pick_up_cage,[Description("recycle_cage")]@recycle_cage,[Description("kick_vehicle")]@kick_vehicle,[Description("get_info")]@get_info,[Description("apply")]@apply}[Serializable] public enum lock_area_id{[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_h_1_lock")]@test_h_1_lock}[Serializable] public enum direction{[Description("South")]@South,[Description("West")]@West,[Description("East")]@East,[Description("North")]@North}[Serializable] public enum passive_id{[Description("back_stab_small")]@back_stab_small,[Description("protect_absorb")]@protect_absorb,[Description("defence_boost")]@defence_boost,[Description("trap_atk")]@trap_atk,[Description("max_ammo_boost")]@max_ammo_boost,[Description("recycle_boost")]@recycle_boost,[Description("shield_reg_boost")]@shield_reg_boost,[Description("charge_boost")]@charge_boost,[Description("protect_time_boost")]@protect_time_boost,[Description("ammo_absorb")]@ammo_absorb,[Description("fix_boost")]@fix_boost,[Description("armor_boost")]@armor_boost,[Description("main_atk")]@main_atk,[Description("ticket_add")]@ticket_add,[Description("shield_boost")]@shield_boost,[Description("armor_absorb")]@armor_absorb,[Description("trap_survive")]@trap_survive,[Description("heal_effect_boost")]@heal_effect_boost,[Description("reload_boost")]@reload_boost,[Description("hp_boost")]@hp_boost,[Description("hp_absorb")]@hp_absorb,[Description("speed_boost")]@speed_boost,[Description("back_stab")]@back_stab,[Description("ticket_add_5")]@ticket_add_5,[Description("sweep")]@sweep,[Description("sharded_atk")]@sharded_atk,[Description("tough_max")]@tough_max,[Description("sharded_atk_small")]@sharded_atk_small,[Description("main_atk_small")]@main_atk_small,[Description("shield_absorb")]@shield_absorb,[Description("prop_boost")]@prop_boost}[Serializable] public enum passive_type{[Description("Attack")]@Attack,[Description("Other")]@Other,[Description("Regen")]@Regen,[Description("AbsorbAdd")]@AbsorbAdd,[Description("Survive")]@Survive,[Description("AddItem")]@AddItem,[Description("TickAdd")]@TickAdd,[Description("TrapAbout")]@TrapAbout,[Description("HitWinBuff")]@HitWinBuff}[Serializable] public enum play_buff_effect_type{[Description("Tough")]@Tough,[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("TakeDamageAdd")]@TakeDamageAdd,[Description("Break")]@Break}[Serializable] public enum stack_mode{[Description("OverWrite")]@OverWrite,[Description("Time")]@Time,[Description("Stack")]@Stack}[Serializable] public enum prop_id{[Description("trap")]@trap,[Description("heal")]@heal,[Description("battery")]@battery,[Description("alert")]@alert,[Description("rocket_boost")]@rocket_boost,[Description("radar")]@radar,[Description("ammos")]@ammos,[Description("repair")]@repair}[Serializable] public enum effect_media_type{[Description("bullet")]@bullet,[Description("radar_wave")]@radar_wave,[Description("summon")]@summon,[Description("self")]@self}[Serializable] public enum bot_use_cond{[Description("CantUse")]@CantUse,[Description("HpBlowPercent")]@HpBlowPercent,[Description("EnemyOnSight")]@EnemyOnSight,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("ShieldBlowPercent")]@ShieldBlowPercent}[Serializable] public enum PushType{[Description("Vector")]@Vector,[Description("Center")]@Center}[Serializable] public enum radar_wave_id{[Description("alert_trick_r")]@alert_trick_r,[Description("mine_trick_r")]@mine_trick_r,[Description("r1")]@r1}[Serializable] public enum self_id{[Description("r1")]@r1,[Description("h1")]@h1,[Description("c1")]@c1,[Description("f1")]@f1}[Serializable] public enum skill_id{[Description("test_r_2")]@test_r_2,[Description("test_h_3")]@test_h_3,[Description("out_vehicle")]@out_vehicle,[Description("test_l_3")]@test_l_3,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_l_2")]@test_l_2,[Description("test_r_3")]@test_r_3,[Description("test_h_1")]@test_h_1,[Description("test_s_1")]@test_s_1,[Description("test_h_2")]@test_h_2,[Description("test_r_1")]@test_r_1,[Description("test_cought_skill")]@test_cought_skill,[Description("test_l_1")]@test_l_1}[Serializable] public enum op_Act{[Description("Op1")]@Op1,[Description("BreakOut")]@BreakOut,[Description("Op2")]@Op2,[Description("CaughtTrick")]@CaughtTrick,[Description("Switch")]@Switch}[Serializable] public enum weapon_id{[Description("test_gun")]@test_gun,[Description("test_sword")]@test_sword,[Description("unarmed")]@unarmed}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum vehicle_id{[Description("type_c")]@type_c,[Description("type_b")]@type_b,[Description("type_a")]@type_a}[Serializable] public enum can_be_hit{[Description("trap")]@trap,[Description("vehicle")]@vehicle,[Description("character")]@character}[Serializable] public enum action_type{[Description("interaction")]@interaction,[Description("skill")]@skill,[Description("prop")]@prop}[Serializable] public enum hit_media{[Description("bullet")]@bullet,[Description("radar_wave")]@radar_wave,[Description("lock_area")]@lock_area}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_npc","body","bullet","caught_buff","character","interaction","item","lock_area","map_raws","other_config","passive","play_buff","prop","push_buff","radar_wave","rogue_game_chapter","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
