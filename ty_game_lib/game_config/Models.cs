...
public Point[][] StartPoints { get; set; }  
 /// <summary> : </summary>
public TelPoint[] TransPoint { get; set; }  } [Serializable] public enum item_id{[Description("free_ticket")]@free_ticket,[Description("chip_4")]@chip_4,[Description("exp")]@exp,[Description("chip_3")]@chip_3,[Description("chip")]@chip,[Description("coin")]@coin,[Description("chip_2")]@chip_2,[Description("rand_show")]@rand_show}[Serializable] public enum ItemType{[Description("money")]@money,[Description("bag")]@bag,[Description("battle_exp")]@battle_exp,[Description("forShow")]@forShow}[Serializable] public enum can_be_hit{[Description("character")]@character,[Description("trap")]@trap,[Description("vehicle")]@vehicle}[Serializable] public enum action_type{[Description("prop")]@prop,[Description("interaction")]@interaction,[Description("skill")]@skill}[Serializable] public enum hit_media{[Description("bullet")]@bullet,[Description("lock_area")]@lock_area,[Description("radar_wave")]@radar_wave}[Serializable] public enum skill_id{[Description("test_cross_bow_h_1")]@test_cross_bow_h_1,[Description("test_r_1")]@test_r_1,[Description("test_cross_bow_l_1")]@test_cross_bow_l_1,[Description("test_axe_l_2")]@test_axe_l_2,[Description("test_bow_h_1")]@test_bow_h_1,[Description("cross_bow_block")]@cross_bow_block,[Description("test_l_3")]@test_l_3,[Description("test_l_2")]@test_l_2,[Description("test_cross_bow_switch")]@test_cross_bow_switch,[Description("test_h_1")]@test_h_1,[Description("test_h_2")]@test_h_2,[Description("test_h_3")]@test_h_3,[Description("test_r_s")]@test_r_s,[Description("test_s_1")]@test_s_1,[Description("test_axe_h_2")]@test_axe_h_2,[Description("test_axe_h_3")]@test_axe_h_3,[Description("sword_block")]@sword_block,[Description("test_cross_bow_h_trick")]@test_cross_bow_h_trick,[Description("bow_block")]@bow_block,[Description("test_axe_l_3")]@test_axe_l_3,[Description("test_axe_switch")]@test_axe_switch,[Description("test_h_1_caught")]@test_h_1_caught,[Description("axe_block")]@axe_block,[Description("test_axe_l_1")]@test_axe_l_1,[Description("test_bow_l_2")]@test_bow_l_2,[Description("test_r_2")]@test_r_2,[Description("test_bow_switch")]@test_bow_switch,[Description("test_r_3")]@test_r_3,[Description("test_bow_l_1")]@test_bow_l_1,[Description("test_l_1")]@test_l_1,[Description("gun_block")]@gun_block,[Description("test_bow_l_3")]@test_bow_l_3,[Description("test_axe_h_1")]@test_axe_h_1,[Description("test_cought_skill")]@test_cought_skill,[Description("out_vehicle")]@out_vehicle,[Description("default_take_out")]@default_take_out}[Serializable] public enum op_Act{[Description("Block")]@Block,[Description("ByTrick")]@ByTrick,[Description("Op2")]@Op2,[Description("Op1")]@Op1,[Description("BreakAway")]@BreakAway,[Description("CaughtTrick")]@CaughtTrick,[Description("TakeOut")]@TakeOut,[Description("Switch")]@Switch}[Serializable] public enum weapon_id{[Description("test_axe")]@test_axe,[Description("unarmed")]@unarmed,[Description("test_cross_bow")]@test_cross_bow,[Description("test_gun")]@test_gun,[Description("test_bow")]@test_bow,[Description("test_sword")]@test_sword}[Serializable] public enum prop_id{[Description("rocket_boost")]@rocket_boost,[Description("ammos")]@ammos,[Description("all_reg")]@all_reg,[Description("radar")]@radar,[Description("trap")]@trap,[Description("heal")]@heal,[Description("repair")]@repair,[Description("battery")]@battery,[Description("alert")]@alert}[Serializable] public enum effect_media_type{[Description("bullet")]@bullet,[Description("radar_wave")]@radar_wave,[Description("self")]@self,[Description("summon")]@summon}[Serializable] public enum bot_use_cond{[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("HpBlowPercent")]@HpBlowPercent,[Description("CantUse")]@CantUse,[Description("EnemyOnSight")]@EnemyOnSight,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("ShieldBlowPercent")]@ShieldBlowPercent}[Serializable] public enum trap_id{[Description("mine")]@mine,[Description("alert")]@alert}[Serializable] public enum size{[Description("tiny")]@tiny,[Description("medium")]@medium,[Description("small")]@small,[Description("big")]@big,[Description("default")]@default}[Serializable] public enum botOp{[Description("op1")]@op1,[Description("op2")]@op2,[Description("none")]@none}[Serializable] public enum radar_wave_id{[Description("alert_trick_r")]@alert_trick_r,[Description("r1")]@r1,[Description("mine_trick_r")]@mine_trick_r}[Serializable] public enum raw_shape{[Description("line")]@line,[Description("rectangle")]@rectangle,[Description("sector")]@sector,[Description("round")]@round}[Serializable] public enum sale_type{[Description("prop")]@prop,[Description("passive")]@passive,[Description("weapon")]@weapon}[Serializable] public enum interactionAct{[Description("pick_up_cage")]@pick_up_cage,[Description("kick_vehicle")]@kick_vehicle,[Description("recycle_cage")]@recycle_cage,[Description("apply")]@apply,[Description("get_in_vehicle")]@get_in_vehicle,[Description("get_info")]@get_info}[Serializable] public enum bullet_id{[Description("test_b_1_b_1")]@test_b_1_b_1,[Description("test_cb_h_1")]@test_cb_h_1,[Description("test_cb_l_2")]@test_cb_l_2,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("test_axe_h_1_b_2")]@test_axe_h_1_b_2,[Description("test_cb_t_1")]@test_cb_t_1,[Description("mine_atk")]@mine_atk,[Description("test_axe_l_1_b_1")]@test_axe_l_1_b_1,[Description("test_axe_l_1_b_2")]@test_axe_l_1_b_2,[Description("test_cb_t_2")]@test_cb_t_2,[Description("test_axe_h_1_b_1")]@test_axe_h_1_b_1,[Description("test_l_1_b_1")]@test_l_1_b_1,[Description("test_cb_l_1")]@test_cb_l_1,[Description("test_axe_h_1_b_3")]@test_axe_h_1_b_3,[Description("test_cb_l_3")]@test_cb_l_3,[Description("test_l_1_k_1")]@test_l_1_k_1,[Description("test_axe_l_1_b_3")]@test_axe_l_1_b_3,[Description("vehicle_boom")]@vehicle_boom,[Description("test_cb_t_3")]@test_cb_t_3,[Description("test_cb_h_2")]@test_cb_h_2,[Description("default_block_1")]@default_block_1,[Description("test_cb_h_3")]@test_cb_h_3,[Description("rocket_punch")]@rocket_punch}[Serializable] public enum buff_type{[Description("push_buff")]@push_buff,[Description("caught_buff")]@caught_buff}[Serializable] public enum hit_type{[Description("range")]@range,[Description("melee")]@melee}[Serializable] public enum target_type{[Description("all_team")]@all_team,[Description("other_team")]@other_team}[Serializable] public enum PushType{[Description("Center")]@Center,[Description("Vector")]@Vector}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum interactableType{[Description("vehicle")]@vehicle,[Description("default")]@default,[Description("prop")]@prop,[Description("weapon")]@weapon}[Serializable] public enum vehicle_id{[Description("type_b")]@type_b,[Description("type_a")]@type_a,[Description("type_c")]@type_c}[Serializable] public enum play_buff_effect_type{[Description("Tough")]@Tough,[Description("Break")]@Break,[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("TakeDamageAdd")]@TakeDamageAdd}[Serializable] public enum stack_mode{[Description("OverWrite")]@OverWrite,[Description("Time")]@Time,[Description("Stack")]@Stack}[Serializable] public enum self_id{[Description("f1")]@f1,[Description("a1")]@a1,[Description("c1")]@c1,[Description("h1")]@h1,[Description("r1")]@r1}[Serializable] public enum lock_area_id{[Description("test_h_1_lock")]@test_h_1_lock,[Description("test_l_1_lock")]@test_l_1_lock}[Serializable] public enum passive_id{[Description("on_break")]@on_break,[Description("revenge")]@revenge,[Description("shield_trans")]@shield_trans,[Description("light_armor2")]@light_armor2,[Description("vicious_armor1")]@vicious_armor1,[Description("armor_absorb")]@armor_absorb,[Description("sharded_atk_power")]@sharded_atk_power,[Description("defence_boost")]@defence_boost,[Description("shield_absorb")]@shield_absorb,[Description("ticket_add")]@ticket_add,[Description("shield_boost")]@shield_boost,[Description("shield_trans1")]@shield_trans1,[Description("reload_boost")]@reload_boost,[Description("absorb_up")]@absorb_up,[Description("fix_boost")]@fix_boost,[Description("main_atk")]@main_atk,[Description("trap_atk")]@trap_atk,[Description("shield_reg_boost")]@shield_reg_boost,[Description("armor_boost")]@armor_boost,[Description("back_stab_small")]@back_stab_small,[Description("weakness")]@weakness,[Description("hp_absorb")]@hp_absorb,[Description("life_power")]@life_power,[Description("shield_overload1")]@shield_overload1,[Description("sturdy_up")]@sturdy_up,[Description("sturdy_weight_up")]@sturdy_weight_up,[Description("emergency_shield")]@emergency_shield,[Description("protect_time_boost")]@protect_time_boost,[Description("stun_power")]@stun_power,[Description("energy_armor")]@energy_armor,[Description("push_power")]@push_power,[Description("max_ammo_boost")]@max_ammo_boost,[Description("recycle_boost")]@recycle_boost,[Description("protect_absorb")]@protect_absorb,[Description("light_armor")]@light_armor,[Description("speed_boost")]@speed_boost,[Description("back_stab")]@back_stab,[Description("charge_boost")]@charge_boost,[Description("prop_boost")]@prop_boost,[Description("other_to_armor")]@other_to_armor,[Description("sharded_atk")]@sharded_atk,[Description("light_armor1")]@light_armor1,[Description("weight_up")]@weight_up,[Description("emergency_armor")]@emergency_armor,[Description("ticket_add_5")]@ticket_add_5,[Description("sweep")]@sweep,[Description("other_to_shield")]@other_to_shield,[Description("main_atk_power")]@main_atk_power,[Description("sharded_atk_small")]@sharded_atk_small,[Description("vicious_armor")]@vicious_armor,[Description("tough_max")]@tough_max,[Description("main_atk_small")]@main_atk_small,[Description("heal_effect_boost")]@heal_effect_boost,[Description("other_to_hp")]@other_to_hp,[Description("shield_overload")]@shield_overload,[Description("hp_boost")]@hp_boost,[Description("trap_survive")]@trap_survive,[Description("ammo_absorb")]@ammo_absorb}[Serializable] public enum passive_type{[Description("SpecialDamageAdd")]@SpecialDamageAdd,[Description("HitWinBuff")]@HitWinBuff,[Description("Attack")]@Attack,[Description("TransRegeneration")]@TransRegeneration,[Description("Survive")]@Survive,[Description("AddItem")]@AddItem,[Description("Other")]@Other,[Description("TickAdd")]@TickAdd,[Description("TrapAbout")]@TrapAbout,[Description("Regen")]@Regen,[Description("StunFix")]@StunFix,[Description("AbsorbAdd")]@AbsorbAdd}[Serializable] public enum direction{[Description("North")]@North,[Description("South")]@South,[Description("East")]@East,[Description("West")]@West}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(skill), "skill_s.json"},{typeof(bad_words), "bad_words_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(talent), "talent_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(trap), "trap_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(sale_unit), "sale_unit_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(body), "body_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(character), "character_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(summon), "summon_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(item), "item_s.json"},{typeof(weapon), "weapon_s.json"},{typeof(bot_other_config), "bot_other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(map_raws), "map_raws_s.json"}};public static string[] Names{get;} = { "skill","bad_words","caught_buff","prop","talent","other_config","trap","battle_bot","radar_wave","sale_unit","standard_level_up","snipe","body","skill_group","interaction","show_text","bullet","character","push_buff","summon","rogue_game_chapter","battle_npc","vehicle","play_buff","self_effect","lock_area","item","weapon","bot_other_config","passive","base_attribute","map_raws"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
