...
public uint absorb_stun_buff_pause { get; set; }  
 /// <summary> : </summary>
public float PauseProtectMutli { get; set; }  } [Serializable] public class trap:IGameConfig {  
 /// <summary> : </summary>
