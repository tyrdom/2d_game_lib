...
public int Snipe2 { get; set; }  
 /// <summary> : </summary>
public int Snipe3 { get; set; }  } [Serializable] public enum item_id{[Description("chip_4")]@chip_4,[Description("exp")]@exp,[Description("chip")]@chip,[Description("coin")]@coin,[Description("chip_2")]@chip_2,[Description("free_ticket")]@free_ticket,[Description("rand_show")]@rand_show,[Description("chip_3")]@chip_3}[Serializable] public enum ItemType{[Description("battle_exp")]@battle_exp,[Description("money")]@money,[Description("bag")]@bag,[Description("forShow")]@forShow}[Serializable] public enum can_be_hit{[Description("trap")]@trap,[Description("character")]@character,[Description("vehicle")]@vehicle}[Serializable] public enum action_type{[Description("skill")]@skill,[Description("interaction")]@interaction,[Description("prop")]@prop}[Serializable] public enum hit_media{[Description("bullet")]@bullet,[Description("lock_area")]@lock_area,[Description("radar_wave")]@radar_wave}[Serializable] public enum botOp{[Description("op1")]@op1,[Description("op2")]@op2,[Description("none")]@none}[Serializable] public enum size{[Description("medium")]@medium,[Description("default")]@default,[Description("small")]@small,[Description("big")]@big,[Description("tiny")]@tiny}[Serializable] public enum interactableType{[Description("prop")]@prop,[Description("default")]@default,[Description("weapon")]@weapon,[Description("vehicle")]@vehicle}[Serializable] public enum bullet_id{[Description("mine_atk")]@mine_atk,[Description("vehicle_boom")]@vehicle_boom,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("rocket_punch")]@rocket_punch,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_l_1_k_1")]@test_l_1_k_1,[Description("test_l_1_b_1")]@test_l_1_b_1}[Serializable] public enum raw_shape{[Description("rectangle")]@rectangle,[Description("line")]@line,[Description("round")]@round,[Description("sector")]@sector}[Serializable] public enum buff_type{[Description("push_buff")]@push_buff,[Description("caught_buff")]@caught_buff}[Serializable] public enum hit_type{[Description("range")]@range,[Description("melee")]@melee}[Serializable] public enum target_type{[Description("other_team")]@other_team,[Description("all_team")]@all_team}[Serializable] public enum interactionAct{[Description("recycle_cage")]@recycle_cage,[Description("pick_up_cage")]@pick_up_cage,[Description("apply")]@apply,[Description("get_in_vehicle")]@get_in_vehicle,[Description("kick_vehicle")]@kick_vehicle,[Description("get_info")]@get_info}[Serializable] public enum lock_area_id{[Description("test_h_1_lock")]@test_h_1_lock,[Description("test_l_1_lock")]@test_l_1_lock}[Serializable] public enum direction{[Description("East")]@East,[Description("West")]@West,[Description("North")]@North,[Description("South")]@South}[Serializable] public enum passive_id{[Description("sharded_atk_small")]@sharded_atk_small,[Description("other_to_shield")]@other_to_shield,[Description("vicious_armor")]@vicious_armor,[Description("reload_boost")]@reload_boost,[Description("main_atk")]@main_atk,[Description("max_ammo_boost")]@max_ammo_boost,[Description("defence_boost")]@defence_boost,[Description("charge_boost")]@charge_boost,[Description("emergency_armor")]@emergency_armor,[Description("protect_time_boost")]@protect_time_boost,[Description("life_power")]@life_power,[Description("hp_absorb")]@hp_absorb,[Description("shield_overload")]@shield_overload,[Description("back_stab")]@back_stab,[Description("ticket_add_5")]@ticket_add_5,[Description("main_atk_small")]@main_atk_small,[Description("shield_boost")]@shield_boost,[Description("ammo_absorb")]@ammo_absorb,[Description("trap_survive")]@trap_survive,[Description("tough_max")]@tough_max,[Description("vicious_armor1")]@vicious_armor1,[Description("light_armor2")]@light_armor2,[Description("sweep")]@sweep,[Description("shield_trans")]@shield_trans,[Description("protect_absorb")]@protect_absorb,[Description("back_stab_small")]@back_stab_small,[Description("other_to_armor")]@other_to_armor,[Description("speed_boost")]@speed_boost,[Description("recycle_boost")]@recycle_boost,[Description("armor_boost")]@armor_boost,[Description("prop_boost")]@prop_boost,[Description("other_to_hp")]@other_to_hp,[Description("trap_atk")]@trap_atk,[Description("shield_reg_boost")]@shield_reg_boost,[Description("light_armor")]@light_armor,[Description("armor_absorb")]@armor_absorb,[Description("shield_overload1")]@shield_overload1,[Description("shield_absorb")]@shield_absorb,[Description("hp_boost")]@hp_boost,[Description("fix_boost")]@fix_boost,[Description("heal_effect_boost")]@heal_effect_boost,[Description("sharded_atk")]@sharded_atk,[Description("emergency_shield")]@emergency_shield,[Description("energy_armor")]@energy_armor,[Description("light_armor1")]@light_armor1,[Description("ticket_add")]@ticket_add,[Description("shield_trans1")]@shield_trans1}[Serializable] public enum passive_type{[Description("Regen")]@Regen,[Description("Survive")]@Survive,[Description("Attack")]@Attack,[Description("TransRegeneration")]@TransRegeneration,[Description("TickAdd")]@TickAdd,[Description("AddItem")]@AddItem,[Description("AbsorbAdd")]@AbsorbAdd,[Description("SpecialSurviveDamageAdd")]@SpecialSurviveDamageAdd,[Description("HitWinBuff")]@HitWinBuff,[Description("TrapAbout")]@TrapAbout,[Description("Other")]@Other}[Serializable] public enum play_buff_effect_type{[Description("TakeDamageAdd")]@TakeDamageAdd,[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("Break")]@Break,[Description("Tough")]@Tough}[Serializable] public enum stack_mode{[Description("OverWrite")]@OverWrite,[Description("Stack")]@Stack,[Description("Time")]@Time}[Serializable] public enum prop_id{[Description("ammos")]@ammos,[Description("alert")]@alert,[Description("rocket_boost")]@rocket_boost,[Description("battery")]@battery,[Description("repair")]@repair,[Description("trap")]@trap,[Description("heal")]@heal,[Description("radar")]@radar}[Serializable] public enum effect_media_type{[Description("bullet")]@bullet,[Description("radar_wave")]@radar_wave,[Description("self")]@self,[Description("summon")]@summon}[Serializable] public enum bot_use_cond{[Description("HpBlowPercent")]@HpBlowPercent,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("ShieldBlowPercent")]@ShieldBlowPercent,[Description("CantUse")]@CantUse,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("EnemyOnSight")]@EnemyOnSight}[Serializable] public enum PushType{[Description("Vector")]@Vector,[Description("Center")]@Center}[Serializable] public enum radar_wave_id{[Description("r1")]@r1,[Description("mine_trick_r")]@mine_trick_r,[Description("alert_trick_r")]@alert_trick_r}[Serializable] public enum sale_type{[Description("passive")]@passive,[Description("prop")]@prop}[Serializable] public enum self_id{[Description("f1")]@f1,[Description("r1")]@r1,[Description("c1")]@c1,[Description("h1")]@h1}[Serializable] public enum skill_id{[Description("test_h_3")]@test_h_3,[Description("default_take_out")]@default_take_out,[Description("test_bow_h_1")]@test_bow_h_1,[Description("test_l_1")]@test_l_1,[Description("test_h_1")]@test_h_1,[Description("test_r_3")]@test_r_3,[Description("test_bow_l_2")]@test_bow_l_2,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_bow_l_3")]@test_bow_l_3,[Description("out_vehicle")]@out_vehicle,[Description("test_r_1")]@test_r_1,[Description("test_bow_l_1")]@test_bow_l_1,[Description("test_cought_skill")]@test_cought_skill,[Description("test_r_s")]@test_r_s,[Description("test_s_1")]@test_s_1,[Description("test_r_2")]@test_r_2,[Description("test_h_2")]@test_h_2,[Description("test_bow_switch")]@test_bow_switch,[Description("test_l_3")]@test_l_3,[Description("test_l_2")]@test_l_2}[Serializable] public enum op_Act{[Description("Switch")]@Switch,[Description("CaughtTrick")]@CaughtTrick,[Description("BreakAway")]@BreakAway,[Description("TakeOut")]@TakeOut,[Description("Op1")]@Op1,[Description("Op2")]@Op2}[Serializable] public enum weapon_id{[Description("test_sword")]@test_sword,[Description("test_gun")]@test_gun,[Description("unarmed")]@unarmed,[Description("test_bow")]@test_bow}[Serializable] public enum summon_id{[Description("s_a_alert")]@s_a_alert,[Description("s_a_mine")]@s_a_mine}[Serializable] public enum vehicle_id{[Description("type_a")]@type_a,[Description("type_c")]@type_c,[Description("type_b")]@type_b}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(sale_unit), "sale_unit_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_bot","battle_npc","body","bullet","caught_buff","character","interaction","item","lock_area","map_raws","other_config","passive","play_buff","prop","push_buff","radar_wave","rogue_game_chapter","sale_unit","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
