...
namespace game_config
{
    ...
    public enum play_buff_id
    {
        ...
        [Description("maxSpeedDown")] @maxSpeedDown,
    ...
    public static class ResNames
    {
        public static Dictionary<Type, string> NamesDictionary { get; } = new Dictionary<Type, string>
        {
            ...
            {typeof(battle_bot), "battle_bot_s.json"}, {typeof(battle_npc), "battle_npc_s.json"},
            {typeof(body), "body_s.json"}, {typeof(bot_other_config), "bot_other_config_s.json"},
            {typeof(bullet), "bullet_s.json"}, {typeof(caught_buff), "caught_buff_s.json"},
            {typeof(character), "character_s.json"}, {typeof(interaction), "interaction_s.json"},
            {typeof(item), "item_s.json"}, {typeof(lock_area), "lock_area_s.json"},
            {typeof(new_helper), "new_helper_s.json"}, {typeof(other_config), "other_config_s.json"},
            {typeof(passive), "passive_s.json"}, {typeof(play_buff), "play_buff_s.json"}, {typeof(prop), "prop_s.json"},
            {typeof(pull_buff), "pull_buff_s.json"}, {typeof(push_buff), "push_buff_s.json"},
            {typeof(radar_wave), "radar_wave_s.json"}, {typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},
            {typeof(sale_unit), "sale_unit_s.json"}, {typeof(self_effect), "self_effect_s.json"},
        ...
        {
            "bad_words", "base_attribute", "battle_bot", "battle_npc", "body", "bot_other_config", "bullet",
            "caught_buff", "character", "interaction", "item", "lock_area", "new_helper", "other_config", "passive",
            "play_buff", "prop", "pull_buff", "push_buff", "radar_wave", "rogue_game_chapter", "sale_unit",
            "self_effect", "show_text", "skill", "skill_group", "snipe", "standard_level_up", "summon", "talent",
            "trap", "vehicle", "weapon", "map_raws"
        };
    }
    ...
    public class ConfigDictionaries
    {
        ...
        public ConfigDictionaries()
        {
            ...
            {
                bad_wordss, base_attributes, battle_bots, battle_npcs, bodys, bot_other_configs, bullets, caught_buffs,
                characters, interactions, items, lock_areas, new_helpers, other_configs, passives, play_buffs, props,
                pull_buffs, push_buffs, radar_waves, rogue_game_chapters, sale_units, self_effects, show_texts, skills,
                skill_groups, snipes, standard_level_ups, summons, talents, traps, vehicles, weapons, map_rawss
            };
        }
#endif
        ...
        public void LoadAllByDll()
        {
            ...
            battle_bots =
                GameConfigTools.GenConfigDict<int, battle_bot>();
            battle_npcs = GameConfigTools.GenConfigDict<int, battle_npc>();
            bodys
                = GameConfigTools.GenConfigDict<size, body>();
            bot_other_configs =
                GameConfigTools.GenConfigDict<int, bot_other_config>();
            bullets =
                GameConfigTools.GenConfigDict<bullet_id, bullet>();
            caught_buffs =
            ...
            items =
                GameConfigTools.GenConfigDict<item_id, item>();
            lock_areas =
                GameConfigTools.GenConfigDict<lock_area_id, lock_area>();
            new_helpers =
                GameConfigTools.GenConfigDict<int, new_helper>();
            other_configs =
                GameConfigTools.GenConfigDict<int, other_config>();
            passives =
                GameConfigTools.GenConfigDict<passive_id, passive>();
            play_buffs =
                GameConfigTools.GenConfigDict<play_buff_id, play_buff>();
            props =
                GameConfigTools.GenConfigDict<prop_id, prop>();
            pull_buffs =
                GameConfigTools.GenConfigDict<string, pull_buff>();
            push_buffs =
                GameConfigTools.GenConfigDict<string, push_buff>();
            radar_waves =
                GameConfigTools.GenConfigDict<radar_wave_id, radar_wave>();
            rogue_game_chapters =
                GameConfigTools.GenConfigDict<int, rogue_game_chapter>();
            sale_units =
                GameConfigTools.GenConfigDict<int, sale_unit>();
            self_effects =
                GameConfigTools.GenConfigDict<self_id, self_effect>();
            show_texts =
                GameConfigTools.GenConfigDict<string, show_text>();
            skills =
                GameConfigTools.GenConfigDict<skill_id, skill>();
            skill_groups =
            ...
            summons =
                GameConfigTools.GenConfigDict<summon_id, summon>();
            talents = GameConfigTools.GenConfigDict<int, talent>();
            traps =
                GameConfigTools.GenConfigDict<trap_id, trap>();
            vehicles =
                GameConfigTools.GenConfigDict<vehicle_id, vehicle>();
            weapons =
