...
public SimpleObj1[] GetBuffWhenAbsorb { get; set; }  
 /// <summary> 吸收时如果技能释放，给对手添加BUFF: </summary>
public SimpleObj1[] SetBuffToOpponentWhenAbsorb { get; set; }  } [Serializable] public class bad_words:IGameConfig {  
 /// <summary> : </summary>
...
public SimpleObj2[] CatchKeyPoints { get; set; }  
...
public Point[][] StartPoints { get; set; }  
 /// <summary> : </summary>
public TelPoint[] TransPoint { get; set; }  } [Serializable] public class summon:IGameConfig {  
 /// <summary> id: </summary>
...
public string[] PassiveRange { get; set; }  
 /// <summary> : </summary>
public SimpleObj5[] MustPassive { get; set; }  
...
public float KeepDistance { get; set; }  
 /// <summary> : </summary>
public SimpleObj6[] BodySizeUseAndSnipeSpeedFix { get; set; }  
 /// <summary> : </summary>
public SimpleObj7[] BodySizeToBlockSkill { get; set; }  
...
public float ProtectAbsorb { get; set; }  
 /// <summary> : </summary>
public float ListenRange { get; set; }  } [Serializable] public enum item_id{[Description("coin")]@coin,[Description("rand_show")]@rand_show,[Description("chip_4")]@chip_4,[Description("free_ticket")]@free_ticket,[Description("chip_2")]@chip_2,[Description("chip_3")]@chip_3,[Description("exp")]@exp,[Description("chip")]@chip}[Serializable] public enum ItemType{[Description("bag")]@bag,[Description("forShow")]@forShow,[Description("battle_exp")]@battle_exp,[Description("money")]@money}[Serializable] public enum can_be_hit{[Description("trap")]@trap,[Description("vehicle")]@vehicle,[Description("character")]@character}[Serializable] public enum action_type{[Description("interaction")]@interaction,[Description("skill")]@skill,[Description("prop")]@prop}[Serializable] public enum hit_media{[Description("radar_wave")]@radar_wave,[Description("lock_area")]@lock_area,[Description("bullet")]@bullet}[Serializable] public enum skill_id{[Description("test_axe_l_3")]@test_axe_l_3,[Description("test_bow_l_2")]@test_bow_l_2,[Description("test_bow_l_3")]@test_bow_l_3,[Description("out_vehicle")]@out_vehicle,[Description("test_axe_h_1")]@test_axe_h_1,[Description("test_r_1")]@test_r_1,[Description("test_cought_skill")]@test_cought_skill,[Description("test_axe_switch")]@test_axe_switch,[Description("test_r_s")]@test_r_s,[Description("test_cross_bow_h_1")]@test_cross_bow_h_1,[Description("test_bow_h_1")]@test_bow_h_1,[Description("test_h_2")]@test_h_2,[Description("test_axe_h_2")]@test_axe_h_2,[Description("test_r_2")]@test_r_2,[Description("test_l_1")]@test_l_1,[Description("test_s_1")]@test_s_1,[Description("gun_block")]@gun_block,[Description("default_take_out")]@default_take_out,[Description("test_h_3")]@test_h_3,[Description("bow_block")]@bow_block,[Description("test_bow_l_1")]@test_bow_l_1,[Description("test_axe_l_1")]@test_axe_l_1,[Description("test_axe_l_2")]@test_axe_l_2,[Description("test_l_3")]@test_l_3,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_l_2")]@test_l_2,[Description("axe_block")]@axe_block,[Description("test_axe_h_3")]@test_axe_h_3,[Description("test_cross_bow_h_trick")]@test_cross_bow_h_trick,[Description("sword_block")]@sword_block,[Description("cross_bow_block")]@cross_bow_block,[Description("test_cross_bow_l_1")]@test_cross_bow_l_1,[Description("test_bow_switch")]@test_bow_switch,[Description("test_r_3")]@test_r_3,[Description("test_cross_bow_switch")]@test_cross_bow_switch,[Description("test_h_1")]@test_h_1}[Serializable] public enum op_Act{[Description("TakeOut")]@TakeOut,[Description("ByTrick")]@ByTrick,[Description("CaughtTrick")]@CaughtTrick,[Description("Op1")]@Op1,[Description("Block")]@Block,[Description("BreakAway")]@BreakAway,[Description("Switch")]@Switch,[Description("Op2")]@Op2}[Serializable] public enum weapon_id{[Description("test_axe")]@test_axe,[Description("test_sword")]@test_sword,[Description("unarmed")]@unarmed,[Description("test_gun")]@test_gun,[Description("test_bow")]@test_bow,[Description("test_cross_bow")]@test_cross_bow}[Serializable] public enum prop_id{[Description("all_reg")]@all_reg,[Description("rocket_boost")]@rocket_boost,[Description("alert")]@alert,[Description("repair")]@repair,[Description("ammos")]@ammos,[Description("radar")]@radar,[Description("battery")]@battery,[Description("heal")]@heal,[Description("trap")]@trap}[Serializable] public enum effect_media_type{[Description("summon")]@summon,[Description("radar_wave")]@radar_wave,[Description("bullet")]@bullet,[Description("self")]@self}[Serializable] public enum bot_use_cond{[Description("ShieldBlowPercent")]@ShieldBlowPercent,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("EnemyOnSight")]@EnemyOnSight,[Description("HpBlowPercent")]@HpBlowPercent,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("CantUse")]@CantUse}[Serializable] public enum trap_id{[Description("alert")]@alert,[Description("mine")]@mine}[Serializable] public enum size{[Description("medium")]@medium,[Description("small")]@small,[Description("tiny")]@tiny,[Description("default")]@default,[Description("big")]@big}[Serializable] public enum botOp{[Description("op2")]@op2,[Description("none")]@none,[Description("op1")]@op1}[Serializable] public enum radar_wave_id{[Description("r1")]@r1,[Description("mine_trick_r")]@mine_trick_r,[Description("alert_trick_r")]@alert_trick_r}[Serializable] public enum raw_shape{[Description("round")]@round,[Description("sector")]@sector,[Description("rectangle")]@rectangle,[Description("line")]@line}[Serializable] public enum sale_type{[Description("prop")]@prop,[Description("passive")]@passive,[Description("weapon")]@weapon}[Serializable] public enum interactionAct{[Description("apply")]@apply,[Description("get_info")]@get_info,[Description("recycle_cage")]@recycle_cage,[Description("get_in_vehicle")]@get_in_vehicle,[Description("pick_up_cage")]@pick_up_cage,[Description("kick_vehicle")]@kick_vehicle}[Serializable] public enum bullet_id{[Description("mine_atk")]@mine_atk,[Description("test_axe_l_1_b_3")]@test_axe_l_1_b_3,[Description("test_cb_l_3")]@test_cb_l_3,[Description("default_block_1")]@default_block_1,[Description("test_l_1_k_1")]@test_l_1_k_1,[Description("test_cb_t_1")]@test_cb_t_1,[Description("test_l_1_b_1")]@test_l_1_b_1,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("test_axe_h_1_b_3")]@test_axe_h_1_b_3,[Description("test_cb_t_3")]@test_cb_t_3,[Description("vehicle_boom")]@vehicle_boom,[Description("test_cb_h_3")]@test_cb_h_3,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_cb_h_1")]@test_cb_h_1,[Description("test_cb_l_1")]@test_cb_l_1,[Description("test_b_1_b_1")]@test_b_1_b_1,[Description("test_axe_l_1_b_1")]@test_axe_l_1_b_1,[Description("test_axe_h_1_b_1")]@test_axe_h_1_b_1,[Description("test_cb_l_2")]@test_cb_l_2,[Description("rocket_punch")]@rocket_punch,[Description("test_cb_t_2")]@test_cb_t_2,[Description("test_axe_l_1_b_2")]@test_axe_l_1_b_2,[Description("test_axe_h_1_b_2")]@test_axe_h_1_b_2,[Description("test_cb_h_2")]@test_cb_h_2}[Serializable] public enum buff_type{[Description("play_buff")]@play_buff,[Description("caught_buff")]@caught_buff,[Description("push_buff")]@push_buff}[Serializable] public enum hit_type{[Description("melee")]@melee,[Description("range")]@range}[Serializable] public enum target_type{[Description("other_team")]@other_team,[Description("all_team")]@all_team}[Serializable] public enum PushType{[Description("Vector")]@Vector,[Description("Center")]@Center}[Serializable] public enum direction{[Description("North")]@North,[Description("West")]@West,[Description("South")]@South,[Description("East")]@East}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum interactableType{[Description("weapon")]@weapon,[Description("default")]@default,[Description("vehicle")]@vehicle,[Description("prop")]@prop}[Serializable] public enum vehicle_id{[Description("type_a")]@type_a,[Description("type_c")]@type_c,[Description("type_b")]@type_b}[Serializable] public enum play_buff_id{[Description("takeDamageAdd")]@takeDamageAdd,[Description("makeDamageAdd")]@makeDamageAdd,[Description("break")]@break,[Description("tough")]@tough,[Description("makeDamageAdd2")]@makeDamageAdd2}[Serializable] public enum play_buff_effect_type{[Description("Break")]@Break,[Description("Tough")]@Tough,[Description("TakeDamageAdd")]@TakeDamageAdd,[Description("MakeDamageAdd")]@MakeDamageAdd}[Serializable] public enum stack_mode{[Description("OverWrite")]@OverWrite,[Description("Time")]@Time,[Description("Stack")]@Stack}[Serializable] public enum self_id{[Description("f1")]@f1,[Description("c1")]@c1,[Description("r1")]@r1,[Description("a1")]@a1,[Description("h1")]@h1}[Serializable] public enum lock_area_id{[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_h_1_lock")]@test_h_1_lock}[Serializable] public enum passive_id{[Description("reload_boost")]@reload_boost,[Description("trap_atk")]@trap_atk,[Description("vicious_armor1")]@vicious_armor1,[Description("max_ammo_boost")]@max_ammo_boost,[Description("defence_boost")]@defence_boost,[Description("sturdy_up")]@sturdy_up,[Description("other_to_shield")]@other_to_shield,[Description("sharded_atk")]@sharded_atk,[Description("ammo_absorb")]@ammo_absorb,[Description("on_break")]@on_break,[Description("push_power")]@push_power,[Description("energy_armor")]@energy_armor,[Description("shield_boost")]@shield_boost,[Description("fix_boost")]@fix_boost,[Description("sweep")]@sweep,[Description("light_armor2")]@light_armor2,[Description("ticket_add")]@ticket_add,[Description("main_atk_power")]@main_atk_power,[Description("shield_reg_boost")]@shield_reg_boost,[Description("protect_time_boost")]@protect_time_boost,[Description("sharded_atk_small")]@sharded_atk_small,[Description("main_atk")]@main_atk,[Description("weight_up")]@weight_up,[Description("sturdy_weight_up")]@sturdy_weight_up,[Description("absorb_up")]@absorb_up,[Description("weakness")]@weakness,[Description("shield_trans1")]@shield_trans1,[Description("emergency_shield")]@emergency_shield,[Description("hp_absorb")]@hp_absorb,[Description("trap_survive")]@trap_survive,[Description("shield_trans")]@shield_trans,[Description("hp_boost")]@hp_boost,[Description("back_stab")]@back_stab,[Description("protect_absorb")]@protect_absorb,[Description("life_power")]@life_power,[Description("heal_effect_boost")]@heal_effect_boost,[Description("armor_absorb")]@armor_absorb,[Description("ticket_add_5")]@ticket_add_5,[Description("stun_power")]@stun_power,[Description("tough_max")]@tough_max,[Description("main_atk_small")]@main_atk_small,[Description("light_armor")]@light_armor,[Description("prop_boost")]@prop_boost,[Description("armor_boost")]@armor_boost,[Description("shield_overload")]@shield_overload,[Description("charge_boost")]@charge_boost,[Description("sharded_atk_power")]@sharded_atk_power,[Description("revenge")]@revenge,[Description("light_armor1")]@light_armor1,[Description("other_to_hp")]@other_to_hp,[Description("shield_overload1")]@shield_overload1,[Description("emergency_armor")]@emergency_armor,[Description("other_to_armor")]@other_to_armor,[Description("speed_boost")]@speed_boost,[Description("back_stab_small")]@back_stab_small,[Description("vicious_armor")]@vicious_armor,[Description("shield_absorb")]@shield_absorb,[Description("recycle_boost")]@recycle_boost}[Serializable] public enum passive_type{[Description("Survive")]@Survive,[Description("StunFix")]@StunFix,[Description("TickAdd")]@TickAdd,[Description("TransRegeneration")]@TransRegeneration,[Description("AbsorbAdd")]@AbsorbAdd,[Description("SpecialDamageAdd")]@SpecialDamageAdd,[Description("Regen")]@Regen,[Description("Other")]@Other,[Description("HitWinBuff")]@HitWinBuff,[Description("TrapAbout")]@TrapAbout,[Description("Attack")]@Attack,[Description("AddItem")]@AddItem}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(skill), "skill_s.json"},{typeof(bad_words), "bad_words_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(talent), "talent_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(trap), "trap_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(sale_unit), "sale_unit_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(body), "body_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(character), "character_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(summon), "summon_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(item), "item_s.json"},{typeof(weapon), "weapon_s.json"},{typeof(bot_other_config), "bot_other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(base_attribute), "base_attribute_s.json"}};public static string[] Names{get;} = { "skill","bad_words","caught_buff","prop","talent","other_config","trap","battle_bot","radar_wave","sale_unit","standard_level_up","snipe","body","skill_group","interaction","show_text","bullet","character","push_buff","map_raws","summon","rogue_game_chapter","battle_npc","vehicle","play_buff","self_effect","lock_area","item","weapon","bot_other_config","passive","base_attribute"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
...
public  ImmutableDictionary < passive_id,passive> passives { get; set; } 
 /// <summary> None </summary>
public  ImmutableDictionary < int,base_attribute> base_attributes { get; set; }public  IDictionary[] all_Immutable_dictionary  {get;set;}
#if NETCOREAPP
