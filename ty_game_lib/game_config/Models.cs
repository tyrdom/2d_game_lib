...
public uint TotalTime { get; set; }  } [Serializable] public class item:IShowSchemeConfig,IGameConfig {  
 /// <summary> id: </summary>
...
public string default_take_out_skill { get; set; }  } [Serializable] public class passive:IShowSchemeConfig,IGameConfig {  
 /// <summary> : </summary>
...
public bool IsRandomSale { get; set; }  
 /// <summary> 数量: </summary>
public int Stack { get; set; }  } [Serializable] public enum item_id{[Description("rand_show")]@rand_show,[Description("金币")]@金币,[Description("chip_2")]@chip_2,[Description("代金券")]@代金券,[Description("芯片_4")]@芯片_4,[Description("芯片")]@芯片,[Description("芯片_2")]@芯片_2,[Description("free_ticket")]@free_ticket,[Description("exp")]@exp,[Description("chip")]@chip,[Description("芯片_3")]@芯片_3,[Description("chip_3")]@chip_3,[Description("chip_4")]@chip_4,[Description("coin")]@coin,[Description("战斗经验")]@战斗经验}[Serializable] public enum ItemType{[Description("battle_exp")]@battle_exp,[Description("money")]@money,[Description("bag")]@bag,[Description("forShow")]@forShow}[Serializable] public enum can_be_hit{[Description("trap")]@trap,[Description("character")]@character,[Description("vehicle")]@vehicle}[Serializable] public enum action_type{[Description("skill")]@skill,[Description("prop")]@prop,[Description("interaction")]@interaction}[Serializable] public enum hit_media{[Description("bullet")]@bullet,[Description("radar_wave")]@radar_wave,[Description("lock_area")]@lock_area}[Serializable] public enum size{[Description("medium")]@medium,[Description("default")]@default,[Description("tiny")]@tiny,[Description("small")]@small,[Description("big")]@big}[Serializable] public enum interactableType{[Description("default")]@default,[Description("prop")]@prop,[Description("vehicle")]@vehicle,[Description("weapon")]@weapon}[Serializable] public enum botOp{[Description("op1")]@op1,[Description("none")]@none,[Description("op2")]@op2}[Serializable] public enum bullet_id{[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_l_1_b_1")]@test_l_1_b_1,[Description("mine_atk")]@mine_atk,[Description("rocket_punch")]@rocket_punch,[Description("vehicle_boom")]@vehicle_boom,[Description("test_h_1_b_1")]@test_h_1_b_1}[Serializable] public enum raw_shape{[Description("sector")]@sector,[Description("round")]@round,[Description("rectangle")]@rectangle,[Description("line")]@line}[Serializable] public enum buff_type{[Description("push_buff")]@push_buff,[Description("caught_buff")]@caught_buff}[Serializable] public enum hit_type{[Description("melee")]@melee,[Description("range")]@range}[Serializable] public enum target_type{[Description("all_team")]@all_team,[Description("other_team")]@other_team}[Serializable] public enum interactionAct{[Description("get_info")]@get_info,[Description("recycle_cage")]@recycle_cage,[Description("apply")]@apply,[Description("get_in_vehicle")]@get_in_vehicle,[Description("pick_up_cage")]@pick_up_cage,[Description("kick_vehicle")]@kick_vehicle}[Serializable] public enum lock_area_id{[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_h_1_lock")]@test_h_1_lock}[Serializable] public enum direction{[Description("West")]@West,[Description("East")]@East,[Description("North")]@North,[Description("South")]@South}[Serializable] public enum passive_id{[Description("vicious_armor1")]@vicious_armor1,[Description("shield_trans")]@shield_trans,[Description("life_power")]@life_power,[Description("energy_armor1")]@energy_armor1,[Description("trap_survive")]@trap_survive,[Description("vicious_armor")]@vicious_armor,[Description("ticket_add_5")]@ticket_add_5,[Description("ammo_absorb")]@ammo_absorb,[Description("armor_boost")]@armor_boost,[Description("protect_time_boost")]@protect_time_boost,[Description("ticket_add")]@ticket_add,[Description("sharded_atk")]@sharded_atk,[Description("shield_reg_boost")]@shield_reg_boost,[Description("defence_boost")]@defence_boost,[Description("other_to_shield")]@other_to_shield,[Description("sweep")]@sweep,[Description("light_armor1")]@light_armor1,[Description("shield_overload1")]@shield_overload1,[Description("main_atk_small")]@main_atk_small,[Description("prop_boost")]@prop_boost,[Description("hp_absorb")]@hp_absorb,[Description("charge_boost")]@charge_boost,[Description("armor_absorb")]@armor_absorb,[Description("shield_absorb")]@shield_absorb,[Description("light_armor")]@light_armor,[Description("sharded_atk_small")]@sharded_atk_small,[Description("shield_boost")]@shield_boost,[Description("trap_atk")]@trap_atk,[Description("light_armor2")]@light_armor2,[Description("back_stab_small")]@back_stab_small,[Description("speed_boost")]@speed_boost,[Description("fix_boost")]@fix_boost,[Description("heal_effect_boost")]@heal_effect_boost,[Description("shield_trans1")]@shield_trans1,[Description("max_ammo_boost")]@max_ammo_boost,[Description("reload_boost")]@reload_boost,[Description("back_stab")]@back_stab,[Description("emergency_shield")]@emergency_shield,[Description("emergency_armor")]@emergency_armor,[Description("shield_overload")]@shield_overload,[Description("recycle_boost")]@recycle_boost,[Description("hp_boost")]@hp_boost,[Description("protect_absorb")]@protect_absorb,[Description("other_to_hp")]@other_to_hp,[Description("energy_armor")]@energy_armor,[Description("main_atk")]@main_atk,[Description("tough_max")]@tough_max,[Description("other_to_armor")]@other_to_armor}[Serializable] public enum passive_type{[Description("TickAdd")]@TickAdd,[Description("TransRegeneration")]@TransRegeneration,[Description("Regen")]@Regen,[Description("TrapAbout")]@TrapAbout,[Description("AddItem")]@AddItem,[Description("Attack")]@Attack,[Description("SpecialSurviveDamageAdd")]@SpecialSurviveDamageAdd,[Description("HitWinBuff")]@HitWinBuff,[Description("Survive")]@Survive,[Description("Other")]@Other,[Description("AbsorbAdd")]@AbsorbAdd}[Serializable] public enum play_buff_effect_type{[Description("Break")]@Break,[Description("TakeDamageAdd")]@TakeDamageAdd,[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("Tough")]@Tough}[Serializable] public enum stack_mode{[Description("Stack")]@Stack,[Description("Time")]@Time,[Description("OverWrite")]@OverWrite}[Serializable] public enum prop_id{[Description("repair")]@repair,[Description("rocket_boost")]@rocket_boost,[Description("radar")]@radar,[Description("heal")]@heal,[Description("trap")]@trap,[Description("alert")]@alert,[Description("ammos")]@ammos,[Description("battery")]@battery}[Serializable] public enum effect_media_type{[Description("radar_wave")]@radar_wave,[Description("bullet")]@bullet,[Description("self")]@self,[Description("summon")]@summon}[Serializable] public enum bot_use_cond{[Description("EnemyOnSight")]@EnemyOnSight,[Description("CantUse")]@CantUse,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("ShieldBlowPercent")]@ShieldBlowPercent,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("HpBlowPercent")]@HpBlowPercent}[Serializable] public enum PushType{[Description("Vector")]@Vector,[Description("Center")]@Center}[Serializable] public enum radar_wave_id{[Description("r1")]@r1,[Description("alert_trick_r")]@alert_trick_r,[Description("mine_trick_r")]@mine_trick_r}[Serializable] public enum self_id{[Description("r1")]@r1,[Description("c1")]@c1,[Description("f1")]@f1,[Description("h1")]@h1}[Serializable] public enum skill_id{[Description("test_s_1")]@test_s_1,[Description("test_r_1")]@test_r_1,[Description("test_r_2")]@test_r_2,[Description("default_take_out")]@default_take_out,[Description("test_bow_l_1")]@test_bow_l_1,[Description("test_l_3")]@test_l_3,[Description("test_r_s")]@test_r_s,[Description("out_vehicle")]@out_vehicle,[Description("test_bow_l_2")]@test_bow_l_2,[Description("test_l_2")]@test_l_2,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_l_1")]@test_l_1,[Description("test_cought_skill")]@test_cought_skill,[Description("test_bow_h_1")]@test_bow_h_1,[Description("test_h_2")]@test_h_2,[Description("test_h_1")]@test_h_1,[Description("test_r_3")]@test_r_3,[Description("test_h_3")]@test_h_3,[Description("test_bow_switch")]@test_bow_switch,[Description("test_bow_l_3")]@test_bow_l_3}[Serializable] public enum op_Act{[Description("Op1")]@Op1,[Description("TakeOut")]@TakeOut,[Description("Switch")]@Switch,[Description("Op2")]@Op2,[Description("BreakAway")]@BreakAway,[Description("CaughtTrick")]@CaughtTrick}[Serializable] public enum weapon_id{[Description("test_bow")]@test_bow,[Description("unarmed")]@unarmed,[Description("test_sword")]@test_sword,[Description("test_gun")]@test_gun}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum vehicle_id{[Description("type_a")]@type_a,[Description("type_b")]@type_b,[Description("type_c")]@type_c}[Serializable] public enum sale_type{[Description("passive")]@passive,[Description("prop")]@prop}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(sale_unit), "sale_unit_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_npc","body","bullet","caught_buff","character","interaction","item","lock_area","map_raws","other_config","passive","play_buff","prop","push_buff","radar_wave","rogue_game_chapter","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon","battle_bot","sale_unit"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
