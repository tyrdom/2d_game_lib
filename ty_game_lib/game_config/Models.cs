...
namespace game_config
{
    ...
    public static class ResNames
    {
        ...
        public static string[] Names { get; } =
        {
            ...
            "standard_level_up", "snipe", "body", "skill_group", "interaction", "show_text", "bullet", "character",
            "push_buff", "map_raws", "summon", "rogue_game_chapter", "battle_npc", "vehicle", "play_buff",
            "self_effect", "lock_area", "item", "weapon", "passive", "base_attribute"
        };
    }
    ...
    public class ConfigDictionaries
    {
        ...
        public ConfigDictionaries()
        {
            ...
            all_Immutable_dictionary = new IDictionary[]
            {
                ...
                snipes, bodys, skill_groups, interactions, show_texts, bullets, characters, push_buffs, map_rawss,
                summons, rogue_game_chapters, battle_npcs, vehicles, play_buffs, self_effects, lock_areas, items,
                weapons, passives, base_attributes
            };
        }
#endif
