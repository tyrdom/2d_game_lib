...
namespace game_config
{
    ...
    public static class ResNames
    {
        public static Dictionary<Type, string> NamesDictionary { get; } = new Dictionary<Type, string>
        {
            ...
            {typeof(snipe), "snipe_s.json"}, {typeof(skill_group), "skill_group_s.json"},
            {typeof(interaction), "interaction_s.json"}
        };

        public static string[] Names { get; } =
        {
            "skill", "bad_words", "caught_buff", "other_config", "body", "show_text", "bullet", "push_buff", "fish",
            "lock_area", "item", "weapon", "snipe", "skill_group", "interaction"
        };
    }
    ...
    public class ConfigDictionaries
    {
        ...
        public ImmutableDictionary<string, interaction> interactions { get; set; }
        ...
        public ConfigDictionaries()
        {
            ...
            all_Immutable_dictionary = new IDictionary[]
            {
                ...
                lock_areas, items, weapons, snipes, skill_groups, interactions
            };
        }
#endif
        ...
        public void LoadAllByDll()
        {
            ...
            interactions = GameConfigTools.GenConfigDict<string, interaction>();
        }
#endif
        public void LoadAllByJson(string path = "")
        {
            ...
            interactions = GameConfigTools.GenConfigDictByJsonFile<string, interaction>(path);
        }
        ...
        public void LoadAllByJsonString(Dictionary<string, string> nameToJsonString)
        {
            ...
            interactions =
                GameConfigTools.GenConfigDictByJsonString<string, interaction>(nameToJsonString["interaction"]);
        }
    }
