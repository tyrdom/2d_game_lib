...
public Buff[] GetBuffWhenAbsorb { get; set; }  
 /// <summary> 吸收时如果技能释放，给对手添加BUFF: </summary>
public Buff[] SetBuffToOpponentWhenAbsorb { get; set; }  } [Serializable] public class skill_group:IGameConfig {  
 /// <summary> : </summary>
public string id { get; set; }  
