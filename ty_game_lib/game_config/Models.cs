...
namespace game_config
{
    ...
    public static class ResNames
    {
        public static Dictionary<Type, string> NamesDictionary { get; } = new Dictionary<Type, string>
        {
            ...
            {typeof(map_raws), "map_raws_s.json"}, {typeof(other_config), "other_config_s.json"},
            ...
            {typeof(rogue_game_chapter), "rogue_game_chapter_s.json"}, {typeof(sale_unit), "sale_unit_s.json"},
            {typeof(self_effect), "self_effect_s.json"}, {typeof(show_text), "show_text_s.json"},
            {typeof(skill), "skill_s.json"}, {typeof(skill_group), "skill_group_s.json"},
            {typeof(snipe), "snipe_s.json"}, {typeof(standard_level_up), "standard_level_up_s.json"},
            {typeof(summon), "summon_s.json"}, {typeof(talent), "talent_s.json"}, {typeof(trap), "trap_s.json"},
            {typeof(vehicle), "vehicle_s.json"}, {typeof(weapon), "weapon_s.json"}
        };

        public static string[] Names { get; } =
        {
            "bad_words", "base_attribute", "battle_bot", "battle_npc", "body", "bot_other_config", "bullet",
            "caught_buff", "character", "interaction", "item", "lock_area", "map_raws", "other_config", "passive",
            "play_buff", "prop", "push_buff", "radar_wave", "rogue_game_chapter", "sale_unit", "self_effect",
            "show_text", "skill", "skill_group", "snipe", "standard_level_up", "summon", "talent", "trap", "vehicle",
            "weapon"
        };
    }
    ...
    public class ConfigDictionaries
    {
        ...
        public ConfigDictionaries(string jsonPath = "")
        {
            ...
            all_Immutable_dictionary = new IDictionary[]
            {
                ...
                characters, interactions, items, lock_areas, map_rawss, other_configs, passives, play_buffs, props,
                push_buffs, radar_waves, rogue_game_chapters, sale_units, self_effects, show_texts, skills,
                skill_groups, snipes, standard_level_ups, summons, talents, traps, vehicles, weapons
            };
        }
...
public  void LoadAllByDll(){bad_wordss = GameConfigTools.GenConfigDict <int,bad_words> ();base_attributes =
 GameConfigTools.GenConfigDict <int,base_attribute> ();battle_bots =
 GameConfigTools.GenConfigDict <int,battle_bot> ();battle_npcs = GameConfigTools.GenConfigDict <int,battle_npc> ();bodys
 = GameConfigTools.GenConfigDict <size,body> ();bot_other_configs =
 GameConfigTools.GenConfigDict <int,bot_other_config> ();bullets =
 GameConfigTools.GenConfigDict <bullet_id,bullet> ();caught_buffs =
 ...
 GameConfigTools.GenConfigDict <int,rogue_game_chapter> ();sale_units =
 GameConfigTools.GenConfigDict <int,sale_unit> ();self_effects =
 GameConfigTools.GenConfigDict <self_id,self_effect> ();show_texts =
 GameConfigTools.GenConfigDict <string,show_text> ();skills =
 GameConfigTools.GenConfigDict <skill_id,skill> ();skill_groups =
 ...
 GameConfigTools.GenConfigDict <trap_id,trap> ();vehicles =
 GameConfigTools.GenConfigDict <vehicle_id,vehicle> ();weapons = GameConfigTools.GenConfigDict <weapon_id,weapon> ();}
#endif
