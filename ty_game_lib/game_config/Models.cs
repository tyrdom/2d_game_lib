...
namespace game_config
{
    ...
    public enum passive_type
    {
        ...
        [Description("SpecialSurviveDamageAdd")]
        @SpecialSurviveDamageAdd,
    ...
    public static class ResNames
    {
        public static Dictionary<Type, string> NamesDictionary { get; } = new Dictionary<Type, string>
        {
            ...
            {typeof(bot_other_config), "bot_other_config_s.json"}
        };

        public static string[] Names { get; } =
        {
            "bad_words", "base_attribute", "battle_bot", "battle_npc", "body", "bullet", "caught_buff", "character",
            "interaction", "item", "lock_area", "map_raws", "other_config", "passive", "play_buff", "prop", "push_buff",
            "radar_wave", "rogue_game_chapter", "sale_unit", "self_effect", "show_text", "skill", "skill_group",
            "snipe", "standard_level_up", "summon", "talent", "trap", "vehicle", "weapon", "bot_other_config"
        };
    }
    ...
    public class ConfigDictionaries
    {
        ...
        public ConfigDictionaries(string jsonPath = "")
        {
            ...
            all_Immutable_dictionary = new IDictionary[]
            {
                bad_wordss, base_attributes, battle_bots, battle_npcs, bodys, bullets, caught_buffs, characters,
                interactions, items, lock_areas, map_rawss, other_configs, passives, play_buffs, props, push_buffs,
                radar_waves, rogue_game_chapters, sale_units, self_effects, show_texts, skills, skill_groups, snipes,
                standard_level_ups, summons, talents, traps, vehicles, weapons, bot_other_configs
            };
        }
...
public  void LoadAllByDll(){bad_wordss = GameConfigTools.GenConfigDict <int,bad_words> ();base_attributes =
 ...
 = GameConfigTools.GenConfigDict <size,body> ();bullets =
 ...
 GameConfigTools.GenConfigDict <vehicle_id,vehicle> ();weapons =
