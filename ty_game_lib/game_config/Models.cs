...
namespace game_config
{
    ...
    public class other_config : IGameConfig
    {
        ...
        public uint tick_per_sec { get; set; }
        ...
        public uint standard_trap_max { get; set; }
    }
    ...
    public class trap : IGameConfig
    {
        ...
        public float CallTrapTime { get; set; }
        public float MaxLifeTime { get; set; }
        public int TrapMedia { get; set; }
        public uint TrickStack { get; set; }
        public int LaunchType { get; set; }
        public int LauchMedia { get; set; }
        public int TrickDelayTime { get; set; }
    }
    ...
    public class base_attribute : IGameConfig
    {
        ...
        public float SheildAbsorb { get; set; }
    ...
    public static class ResNames
    {
        public static Dictionary<Type, string> NamesDictionary { get; } = new Dictionary<Type, string>
        {
            ...
            {typeof(trap), "trap_s.json"}, {typeof(snipe), "snipe_s.json"}, {typeof(body), "body_s.json"},
            {typeof(skill_group), "skill_group_s.json"}, {typeof(interaction), "interaction_s.json"},
            ...
            {typeof(base_attribute), "base_attribute_s.json"}, {typeof(creep), "creep_s.json"},
            {typeof(character), "character_s.json"}
        };

        public static string[] Names { get; } =
        {
            "skill", "bad_words", "caught_buff", "prop", "talent", "other_config", "trap", "snipe", "body",
            "skill_group", "interaction", "show_text", "bullet", "push_buff", "fish", "summon", "vehicle", "lock_area",
            "item", "weapon", "passive", "base_attribute", "creep", "character"
        };
    }
    ...
    public class ConfigDictionaries
    {
        ...
        public ConfigDictionaries()
        {
            ...
            {
               skills,bad_wordss,caught_buffs,props,talents,other_configs,traps,snipes,bodys,skill_groups,interactions,show_texts,bullets,push_buffs,fishs,summons,vehicles,lock_areas,items,weapons,passives,base_attributes,creeps,characters
            };
        }
#endif
        ...
        public ConfigDictionaries(string jsonPath = "")
        {
            ...
            all_Immutable_dictionary = new IDictionary[]
            {
                skills, bad_wordss, caught_buffs, props, talents, other_configs, traps, snipes, bodys, skill_groups,
                interactions, show_texts, bullets, push_buffs, fishs, summons, vehicles, lock_areas, items, weapons,
                passives, base_attributes, creeps, characters
            };
        }
...
#if NETCOREAPP
public  void LoadAllByDll(){skills = GameConfigTools.GenConfigDict <string,skill> ();bad_wordss =
 GameConfigTools.GenConfigDict <int,bad_words> ();caught_buffs =
 GameConfigTools.GenConfigDict <string,caught_buff> ();props = GameConfigTools.GenConfigDict <int,prop> ();talents =
 GameConfigTools.GenConfigDict <int,talent> ();other_configs = GameConfigTools.GenConfigDict <int,other_config> ();traps
 = GameConfigTools.GenConfigDict <string,trap> ();snipes = GameConfigTools.GenConfigDict <int,snipe> ();bodys =
 ...
 GameConfigTools.GenConfigDict <string,bullet> ();push_buffs = GameConfigTools.GenConfigDict <string,push_buff> ();fishs
 = GameConfigTools.GenConfigDict <int,fish> ();summons = GameConfigTools.GenConfigDict <string,summon> ();vehicles =
 GameConfigTools.GenConfigDict <int,vehicle> ();lock_areas = GameConfigTools.GenConfigDict <string,lock_area> ();items =
 GameConfigTools.GenConfigDict <int,item> ();weapons = GameConfigTools.GenConfigDict <int,weapon> ();passives =
 GameConfigTools.GenConfigDict <int,passive> ();base_attributes =
 GameConfigTools.GenConfigDict <base_attr_id,base_attribute> ();creeps =
 GameConfigTools.GenConfigDict <int,creep> ();characters = GameConfigTools.GenConfigDict <int,character> ();}
#endif
