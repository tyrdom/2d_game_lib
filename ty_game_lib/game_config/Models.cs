using System;using System.Collections;using System.Collections.Generic;using System.Collections.Immutable;using Newtonsoft.Json;using Newtonsoft.Json.Converters;namespace game_config {[Serializable] public class bad_words:IGameConfig {  
 /// <summary> : </summary>
...
public float rogueRebornCountDownTime { get; set; }  
 /// <summary> : </summary>
public float rogueGameCheckTickTime { get; set; }  } [Serializable] public class passive:IGameConfig {  
 /// <summary> : </summary>
public int id { get; set; }  
 /// <summary> : </summary>
public string info { get; set; }  
...
public Point[][] StartPoints { get; set; }  
 /// <summary> : </summary>
public TelPoint[] TransPoint { get; set; }  } [Serializable] public enum ItemType{@money,@bag,@battle_exp}[Serializable] public enum size{@default,@small,@tiny,@medium,@big}[Serializable] public enum interactableType{@vehicle,@prop,@weapon}[Serializable] public enum botOp{@op1,@op2,@none}[Serializable] public enum raw_shape{@sector,@round,@rectangle}[Serializable] public enum buff_type{@push_buff,@caught_buff}[Serializable] public enum hit_type{@range,@melee}[Serializable] public enum target_type{@all_team,@other_team}[Serializable] public enum interactionAct{@get_in_vehicle,@pick_up_cage,@apply,@kick_vehicle,@get_info,@recycle_cage}[Serializable] public enum passive_type{@TickAdd,@TrapAbout,@Regen,@AddItem,@Attack,@Other,@Survive,@AbsorbAdd,@HitWinBuff}[Serializable] public enum play_buff_effect_type{@Tough,@TakeDamageAdd,@Break,@MakeDamageAdd}[Serializable] public enum stack_mode{@Stack,@OverWrite,@Time}[Serializable] public enum effect_media_type{@self,@radar_wave,@bullet,@summon}[Serializable] public enum bot_use_cond{@ArmorBlowPercent,@HpBlowPercent,@CantUse,@OnPatrolRandom,@EnemyOnSight,@ShieldBlowPercent}[Serializable] public enum PushType{@Center,@Vector}[Serializable] public enum direction{@West,@North,@East,@South}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"},{typeof(map_raws), "map_raws_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_npc","body","bullet","caught_buff","character","interaction","item","lock_area","other_config","passive","play_buff","prop","push_buff","radar_wave","rogue_game_chapter","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon","map_raws"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
