...
namespace game_config
{
    ...
    public class ConfigDictionaries
    {
        ...
        {
            skills = GameConfigTools.GenConfigDict<skill_id, skill>();
            bad_wordss = GameConfigTools.GenConfigDict<int, bad_words>();
            caught_buffs = GameConfigTools.GenConfigDict<string, caught_buff>();
            props = GameConfigTools.GenConfigDict<prop_id, prop>();
            talents = GameConfigTools.GenConfigDict<int, talent>();
            other_configs = GameConfigTools.GenConfigDict<int, other_config>();
            traps = GameConfigTools.GenConfigDict<trap_id, trap>();
            battle_bots = GameConfigTools.GenConfigDict<int, battle_bot>();
            radar_waves = GameConfigTools.GenConfigDict<radar_wave_id, radar_wave>();
            sale_units = GameConfigTools.GenConfigDict<int, sale_unit>();
            ...
            bullets = GameConfigTools.GenConfigDict<bullet_id, bullet>();
            ...
            summons = GameConfigTools.GenConfigDict<summon_id, summon>();
            rogue_game_chapters = GameConfigTools.GenConfigDict<int, rogue_game_chapter>();
            battle_npcs = GameConfigTools.GenConfigDict<int, battle_npc>();
            vehicles = GameConfigTools.GenConfigDict<vehicle_id, vehicle>();
            play_buffs = GameConfigTools.GenConfigDict<play_buff_id, play_buff>();
            self_effects = GameConfigTools.GenConfigDict<self_id, self_effect>();
            lock_areas = GameConfigTools.GenConfigDict<lock_area_id, lock_area>();
            items = GameConfigTools.GenConfigDict<item_id, item>();
            weapons = GameConfigTools.GenConfigDict<weapon_id, weapon>();
            bot_other_configs = GameConfigTools.GenConfigDict<int, bot_other_config>();
            passives = GameConfigTools.GenConfigDict<passive_id, passive>();
            base_attributes = GameConfigTools.GenConfigDict<int, base_attribute>();
            pull_buffs = GameConfigTools.GenConfigDict<string, pull_buff>();
            new_helpers = GameConfigTools.GenConfigDict<int, new_helper>();
        }
#endif
