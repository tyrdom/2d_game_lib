using System;using System.Collections;using System.Collections.Generic;using System.ComponentModel;using Newtonsoft.Json;using Newtonsoft.Json.Converters;namespace game_config {[Serializable] public class bad_words:IGameConfig {  
 /// <summary> : </summary>
...
public string[] PassiveRange { get; set; }  
 /// <summary> : </summary>
public SimpleObj3[] MustPassive { get; set; }  
...
public int steady { get; set; }  } [Serializable] public class bot_other_config:IGameConfig {  
...
public float NaviPloyRadMulti { get; set; }  } [Serializable] public class bullet:IGameConfig {  
 /// <summary> id: </summary>
...
public bool CanMakeBladeWave { get; set; }  
 /// <summary> 使用副手武器产生尖风: </summary>
public bool MakeBladeWaveBySubWeapon { get; set; }  
...
public SimpleObj4[] CatchKeyPoints { get; set; }  
...
public int LocalRotate { get; set; }  } [Serializable] public class new_helper:IGameConfig {  
 /// <summary> id: </summary>
public int id { get; set; }  
 /// <summary> : </summary>
...
public int[] MapResNeed { get; set; }  
 /// <summary> : </summary>
public int Queue { get; set; }  } [Serializable] public class other_config:IGameConfig {  
 /// <summary> 识别序号: </summary>
public int id { get; set; }  
...
public int NewHelperTeam { get; set; }  } [Serializable] public class passive:IShowSchemeConfig,IGameConfig {  
 /// <summary> : </summary>
...
[JsonConverter(typeof(StringEnumConverter))]public stack_mode StackMode { get; set; }  
 /// <summary> : </summary>
public int UseStack { get; set; }  } [Serializable] public class prop:IShowSchemeConfig,IGameConfig {  
 /// <summary> : </summary>
...
public Point[] MoveAdds { get; set; }  } [Serializable] public class pull_buff:IGameConfig {  
 /// <summary> id: </summary>
public string id { get; set; }  
 /// <summary> : </summary>
public uint LastTime { get; set; }  
...
public Point[] FixVector { get; set; }  } [Serializable] public class push_buff:IGameConfig {  
 /// <summary> id: </summary>
public string id { get; set; }  
...
[JsonConverter(typeof(StringEnumConverter))]public op_Act OpAct { get; set; }  
 /// <summary> 属于的动作连击表现号,前端编号: </summary>
...
public SimpleObj5[] ChargeGetPlayingBuffs { get; set; }  
 /// <summary> 蓄力时间获得技能变化id: </summary>
public SimpleObj6[] ChargeChangeSkill { get; set; }  
...
public Buff[] SetStunBuffToOpponentWhenAbsorb { get; set; }  } [Serializable] public class skill_group:IGameConfig {  
 /// <summary> : </summary>
public string id { get; set; }  
...
public Dictionary<int,string> ChargeSwitch { get; set; }  } [Serializable] public class snipe:IGameConfig {  
 /// <summary> id: </summary>
public int id { get; set; }  
 /// <summary> 开镜音效: </summary>
public string OnSniperSound { get; set; }  
 /// <summary> 触发按住时间:0.1秒一个tick </summary>
public uint TrickTick { get; set; }  
...
public int OffTickSpeed { get; set; }  
 /// <summary> 移动速度调整比率: </summary>
public float MoveMulti { get; set; }  
 /// <summary> 瞄准到程度增加的状态: </summary>
public Dictionary<int,string[]> StepToBuff { get; set; }  
 /// <summary> : </summary>
public float ZoomOnTime { get; set; }  
 /// <summary> : </summary>
public float ZoomOffTime { get; set; }  } [Serializable] public class standard_level_up:IGameConfig {  
 /// <summary> : </summary>
public int id { get; set; }  
 /// <summary> : </summary>
...
public int Snipe2 { get; set; }  
 /// <summary> : </summary>
public int Snipe3 { get; set; }  } [Serializable] public class map_raws:IGameConfig {  
 /// <summary> : </summary>
public int id { get; set; }  
 /// <summary> : </summary>
public string info { get; set; }  
...
public int[] GrassIdx { get; set; }  
 /// <summary> : </summary>
public int[] PoolIdx { get; set; }  } [Serializable] public enum item_id{[Description("chip")]@chip,[Description("chip_4")]@chip_4,[Description("chip_3")]@chip_3,[Description("exp")]@exp,[Description("coin")]@coin,[Description("rand_show")]@rand_show,[Description("free_ticket")]@free_ticket,[Description("chip_2")]@chip_2}[Serializable] public enum ItemType{[Description("forShow")]@forShow,[Description("battle_exp")]@battle_exp,[Description("money")]@money,[Description("bag")]@bag}[Serializable] public enum play_buff_id{[Description("hitDaze")]@hitDaze,[Description("takeDamageAdd")]@takeDamageAdd,[Description("bow_damage_up")]@bow_damage_up,[Description("tough")]@tough,[Description("makeDamageAdd2")]@makeDamageAdd2,[Description("takeDamageDecrease")]@takeDamageDecrease,[Description("tough_up")]@tough_up,[Description("pullMark")]@pullMark,[Description("bow_power_up")]@bow_power_up,[Description("maxSpeedDown")]@maxSpeedDown,[Description("break")]@break,[Description("changeComboStatus")]@changeComboStatus,[Description("makeDamageAdd")]@makeDamageAdd}[Serializable] public enum can_be_hit{[Description("character")]@character,[Description("trap")]@trap,[Description("vehicle")]@vehicle}[Serializable] public enum action_type{[Description("skill")]@skill,[Description("interaction")]@interaction,[Description("prop")]@prop}[Serializable] public enum hit_media{[Description("bullet")]@bullet,[Description("lock_area")]@lock_area,[Description("radar_wave")]@radar_wave}[Serializable] public enum botOp{[Description("op1")]@op1,[Description("op2")]@op2,[Description("none")]@none}[Serializable] public enum size{[Description("default")]@default,[Description("big")]@big,[Description("small")]@small,[Description("tiny")]@tiny,[Description("medium")]@medium}[Serializable] public enum interactableType{[Description("weapon")]@weapon,[Description("prop")]@prop,[Description("default")]@default,[Description("vehicle")]@vehicle}[Serializable] public enum bullet_id{[Description("test_cb_h_3")]@test_cb_h_3,[Description("test_cb_l_2")]@test_cb_l_2,[Description("test_cb_h_1")]@test_cb_h_1,[Description("test_ss_l_1_b_1")]@test_ss_l_1_b_1,[Description("test_spr_h_1_b_1")]@test_spr_h_1_b_1,[Description("default_block_1")]@default_block_1,[Description("test_b_1_b_1")]@test_b_1_b_1,[Description("vehicle_boom")]@vehicle_boom,[Description("test_dsw_l_3_b_4")]@test_dsw_l_3_b_4,[Description("test_cb_l_1")]@test_cb_l_1,[Description("test_axe_h_1_b_2")]@test_axe_h_1_b_2,[Description("test_spr_l_1_b_1")]@test_spr_l_1_b_1,[Description("test_dsw_l_1_b_3")]@test_dsw_l_1_b_3,[Description("test_dsw_l_1_b_2")]@test_dsw_l_1_b_2,[Description("test_ss_h_1_b_2")]@test_ss_h_1_b_2,[Description("test_dsw_h_1_b_1")]@test_dsw_h_1_b_1,[Description("rocket_punch")]@rocket_punch,[Description("test_l_1_b_1")]@test_l_1_b_1,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_l_1_k_1")]@test_l_1_k_1,[Description("test_cb_t_1")]@test_cb_t_1,[Description("test_cb_h_2")]@test_cb_h_2,[Description("test_cb_t_2")]@test_cb_t_2,[Description("test_dsw_l_1_b_4")]@test_dsw_l_1_b_4,[Description("test_l_1_k_back")]@test_l_1_k_back,[Description("test_cb_t_3")]@test_cb_t_3,[Description("mine_atk")]@mine_atk,[Description("test_ss_h_1_sp_1")]@test_ss_h_1_sp_1,[Description("test_spr_l_1_b_3")]@test_spr_l_1_b_3,[Description("test_axe_h_1_b_3")]@test_axe_h_1_b_3,[Description("test_ss_h_1_b_1")]@test_ss_h_1_b_1,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("test_cb_l_3")]@test_cb_l_3,[Description("test_dsw_l_1_b_1")]@test_dsw_l_1_b_1,[Description("test_dsw_switch_1")]@test_dsw_switch_1,[Description("test_ss_l_1_b_4")]@test_ss_l_1_b_4,[Description("test_ss_l_1_b_3")]@test_ss_l_1_b_3,[Description("test_spr_l_1_b_2")]@test_spr_l_1_b_2,[Description("test_axe_l_1_b_1")]@test_axe_l_1_b_1,[Description("test_axe_l_1_b_2")]@test_axe_l_1_b_2,[Description("test_axe_h_1_b_1")]@test_axe_h_1_b_1,[Description("test_dsw_l_3_b_3")]@test_dsw_l_3_b_3,[Description("test_l_1_k_b")]@test_l_1_k_b,[Description("test_ss_l_1_b_2")]@test_ss_l_1_b_2,[Description("test_ss_h_1_sp_2")]@test_ss_h_1_sp_2,[Description("test_dsw_h_1_b_2")]@test_dsw_h_1_b_2,[Description("test_axe_l_1_b_3")]@test_axe_l_1_b_3}[Serializable] public enum raw_shape{[Description("round")]@round,[Description("rectangle")]@rectangle,[Description("line")]@line,[Description("sector")]@sector}[Serializable] public enum buff_type{[Description("caught_buff")]@caught_buff,[Description("pull_buff")]@pull_buff,[Description("push_buff")]@push_buff}[Serializable] public enum hit_type{[Description("melee")]@melee,[Description("range")]@range}[Serializable] public enum target_type{[Description("other_team")]@other_team,[Description("all_team")]@all_team}[Serializable] public enum interactionAct{[Description("kick_vehicle")]@kick_vehicle,[Description("get_info")]@get_info,[Description("apply")]@apply,[Description("recycle_cage")]@recycle_cage,[Description("pick_up_cage")]@pick_up_cage,[Description("get_in_vehicle")]@get_in_vehicle}[Serializable] public enum lock_area_id{[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_h_1_lock")]@test_h_1_lock,[Description("test_long_lock")]@test_long_lock}[Serializable] public enum passive_id{[Description("defence_boost")]@defence_boost,[Description("shield_absorb")]@shield_absorb,[Description("protect_absorb")]@protect_absorb,[Description("shield_overload1")]@shield_overload1,[Description("emergency_heal")]@emergency_heal,[Description("main_atk_small")]@main_atk_small,[Description("emergency_protect")]@emergency_protect,[Description("recycle_boost")]@recycle_boost,[Description("push_power")]@push_power,[Description("emergency_armor")]@emergency_armor,[Description("armor_absorb")]@armor_absorb,[Description("shield_overload")]@shield_overload,[Description("heal_effect_boost")]@heal_effect_boost,[Description("weakness")]@weakness,[Description("sharded_atk_power")]@sharded_atk_power,[Description("sturdy_weight_up")]@sturdy_weight_up,[Description("vicious_armor1")]@vicious_armor1,[Description("trap_survive")]@trap_survive,[Description("prop_boost")]@prop_boost,[Description("on_break")]@on_break,[Description("protect_time_boost")]@protect_time_boost,[Description("other_to_armor")]@other_to_armor,[Description("shield_boost")]@shield_boost,[Description("sweep")]@sweep,[Description("energy_armor")]@energy_armor,[Description("tough_max")]@tough_max,[Description("hp_boost")]@hp_boost,[Description("blade_wave")]@blade_wave,[Description("shield_trans")]@shield_trans,[Description("sharded_atk_small")]@sharded_atk_small,[Description("speed_boost")]@speed_boost,[Description("max_ammo_boost")]@max_ammo_boost,[Description("back_stab")]@back_stab,[Description("vicious_armor")]@vicious_armor,[Description("other_to_hp")]@other_to_hp,[Description("armor_boost")]@armor_boost,[Description("sharded_atk")]@sharded_atk,[Description("main_atk_power")]@main_atk_power,[Description("revenge")]@revenge,[Description("ticket_add")]@ticket_add,[Description("emergency_shield")]@emergency_shield,[Description("back_stab_small")]@back_stab_small,[Description("charge_boost")]@charge_boost,[Description("sturdy_up")]@sturdy_up,[Description("blade_wave_atk")]@blade_wave_atk,[Description("reload_boost")]@reload_boost,[Description("shield_trans1")]@shield_trans1,[Description("vicious_armor2")]@vicious_armor2,[Description("light_armor2")]@light_armor2,[Description("trap_atk")]@trap_atk,[Description("main_atk")]@main_atk,[Description("fix_boost")]@fix_boost,[Description("light_armor")]@light_armor,[Description("life_power")]@life_power,[Description("stun_power")]@stun_power,[Description("other_to_shield")]@other_to_shield,[Description("light_armor3")]@light_armor3,[Description("light_armor1")]@light_armor1,[Description("shield_reg_boost")]@shield_reg_boost,[Description("absorb_up")]@absorb_up,[Description("weight_up")]@weight_up,[Description("ammo_absorb")]@ammo_absorb,[Description("hp_absorb")]@hp_absorb,[Description("ticket_add_5")]@ticket_add_5}[Serializable] public enum passive_type{[Description("Regen")]@Regen,[Description("HitWinBuff")]@HitWinBuff,[Description("SpecialDamageAdd")]@SpecialDamageAdd,[Description("TrapAbout")]@TrapAbout,[Description("AbsorbAdd")]@AbsorbAdd,[Description("BladeWave")]@BladeWave,[Description("Other")]@Other,[Description("TransRegeneration")]@TransRegeneration,[Description("StunFix")]@StunFix,[Description("AddItem")]@AddItem,[Description("Attack")]@Attack,[Description("TrickRegeneration")]@TrickRegeneration,[Description("Survive")]@Survive,[Description("TickAdd")]@TickAdd}[Serializable] public enum play_buff_effect_type{[Description("MaxSpeedChange")]@MaxSpeedChange,[Description("PowerUp")]@PowerUp,[Description("TakeDamageAdd")]@TakeDamageAdd,[Description("Break")]@Break,[Description("Tough")]@Tough,[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("ToughUp")]@ToughUp,[Description("ChangeComboStatus")]@ChangeComboStatus,[Description("PullMark")]@PullMark}[Serializable] public enum stack_mode{[Description("OverWrite")]@OverWrite,[Description("Stack")]@Stack,[Description("Time")]@Time}[Serializable] public enum prop_id{[Description("ammos")]@ammos,[Description("heal")]@heal,[Description("repair")]@repair,[Description("radar")]@radar,[Description("all_reg")]@all_reg,[Description("trap")]@trap,[Description("alert")]@alert,[Description("rocket_boost")]@rocket_boost,[Description("battery")]@battery}[Serializable] public enum effect_media_type{[Description("radar_wave")]@radar_wave,[Description("self")]@self,[Description("summon")]@summon,[Description("bullet")]@bullet}[Serializable] public enum bot_use_cond{[Description("EnemyOnSight")]@EnemyOnSight,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("HpBlowPercent")]@HpBlowPercent,[Description("CantUse")]@CantUse,[Description("ShieldBlowPercent")]@ShieldBlowPercent}[Serializable] public enum PushType{[Description("Center")]@Center,[Description("Vector")]@Vector}[Serializable] public enum radar_wave_id{[Description("mine_trick_r")]@mine_trick_r,[Description("alert_trick_r")]@alert_trick_r,[Description("r1")]@r1}[Serializable] public enum sale_type{[Description("weapon")]@weapon,[Description("prop")]@prop,[Description("passive")]@passive}[Serializable] public enum self_id{[Description("c1")]@c1,[Description("r1")]@r1,[Description("h1")]@h1,[Description("a1")]@a1,[Description("f1")]@f1}[Serializable] public enum skill_id{[Description("test_bow_h_1")]@test_bow_h_1,[Description("test_cross_bow_switch")]@test_cross_bow_switch,[Description("test_bow_l_1")]@test_bow_l_1,[Description("test_r_3")]@test_r_3,[Description("test_spear_h_1")]@test_spear_h_1,[Description("test_dual_swords_h_2")]@test_dual_swords_h_2,[Description("test_cross_bow_h_trick")]@test_cross_bow_h_trick,[Description("test_spear_sp_2")]@test_spear_sp_2,[Description("out_vehicle")]@out_vehicle,[Description("test_spear_l_2")]@test_spear_l_2,[Description("test_sword_shield_l_1")]@test_sword_shield_l_1,[Description("test_axe_h_3")]@test_axe_h_3,[Description("test_axe_l_3")]@test_axe_l_3,[Description("test_cross_bow_h_1")]@test_cross_bow_h_1,[Description("test_l_3")]@test_l_3,[Description("test_axe_h_2")]@test_axe_h_2,[Description("test_dual_swords_l_1")]@test_dual_swords_l_1,[Description("test_axe_l_2")]@test_axe_l_2,[Description("test_axe_h_1")]@test_axe_h_1,[Description("test_sword_shield_l_3")]@test_sword_shield_l_3,[Description("axe_block")]@axe_block,[Description("test_spear_l_3")]@test_spear_l_3,[Description("test_h_1")]@test_h_1,[Description("test_dual_swords_l_3")]@test_dual_swords_l_3,[Description("test_r_1")]@test_r_1,[Description("test_h_3")]@test_h_3,[Description("test_dual_swords_switch")]@test_dual_swords_switch,[Description("gun_block")]@gun_block,[Description("test_sword_shield_switch")]@test_sword_shield_switch,[Description("test_sword_shield_h_1")]@test_sword_shield_h_1,[Description("test_bow_l_3")]@test_bow_l_3,[Description("cross_bow_block")]@cross_bow_block,[Description("test_cought_skill")]@test_cought_skill,[Description("test_dual_swords_l_4")]@test_dual_swords_l_4,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_spear_block")]@test_spear_block,[Description("test_r_2")]@test_r_2,[Description("test_dual_swords_h_1")]@test_dual_swords_h_1,[Description("test_l_1")]@test_l_1,[Description("test_dual_swords_block")]@test_dual_swords_block,[Description("test_s_1")]@test_s_1,[Description("bow_block")]@bow_block,[Description("test_sword_shield_l_2")]@test_sword_shield_l_2,[Description("test_l_2")]@test_l_2,[Description("test_dual_swords_l_2")]@test_dual_swords_l_2,[Description("test_h_2")]@test_h_2,[Description("test_cross_bow_l_1")]@test_cross_bow_l_1,[Description("test_axe_switch")]@test_axe_switch,[Description("sword_block")]@sword_block,[Description("test_sword_shield_block")]@test_sword_shield_block,[Description("test_axe_l_1")]@test_axe_l_1,[Description("test_r_s")]@test_r_s,[Description("default_take_out")]@default_take_out,[Description("test_bow_switch")]@test_bow_switch,[Description("test_spear_sp_1")]@test_spear_sp_1,[Description("test_spear_l_1")]@test_spear_l_1,[Description("test_bow_l_2")]@test_bow_l_2,[Description("test_spear_switch")]@test_spear_switch}[Serializable] public enum op_Act{[Description("BreakAway")]@BreakAway,[Description("ByTrick")]@ByTrick,[Description("CaughtTrick")]@CaughtTrick,[Description("Switch")]@Switch,[Description("TakeOut")]@TakeOut,[Description("Op1")]@Op1,[Description("Block")]@Block,[Description("Op2")]@Op2}[Serializable] public enum weapon_id{[Description("unarmed")]@unarmed,[Description("test_gun")]@test_gun,[Description("test_bow")]@test_bow,[Description("test_axe")]@test_axe,[Description("test_spear")]@test_spear,[Description("test_cross_bow")]@test_cross_bow,[Description("test_sword_shield")]@test_sword_shield,[Description("test_dual_swords")]@test_dual_swords,[Description("test_sword")]@test_sword}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum trap_id{[Description("mine")]@mine,[Description("alert")]@alert}[Serializable] public enum vehicle_id{[Description("type_b")]@type_b,[Description("type_a")]@type_a,[Description("type_c")]@type_c}[Serializable] public enum direction{[Description("East")]@East,[Description("South")]@South,[Description("North")]@North,[Description("West")]@West}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bot_other_config), "bot_other_config_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(new_helper), "new_helper_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(pull_buff), "pull_buff_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(sale_unit), "sale_unit_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"},{typeof(map_raws), "map_raws_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_bot","battle_npc","body","bot_other_config","bullet","caught_buff","character","interaction","item","lock_area","new_helper","other_config","passive","play_buff","prop","pull_buff","push_buff","radar_wave","rogue_game_chapter","sale_unit","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon","map_raws"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
...
public Dictionary < int,new_helper> new_helpers { get; set; } 
...
public Dictionary < int,map_raws> map_rawss { get; set; }public  IDictionary[] all_Immutable_dictionary  {get;set;}
#if NETCOREAPP
...
#if NETCOREAPP
public  void LoadAllByDll(){bad_wordss = GameConfigTools.GenConfigDict <int,bad_words> ();base_attributes = GameConfigTools.GenConfigDict <int,base_attribute> ();battle_bots = GameConfigTools.GenConfigDict <int,battle_bot> ();battle_npcs = GameConfigTools.GenConfigDict <int,battle_npc> ();bodys = GameConfigTools.GenConfigDict <size,body> ();bot_other_configs = GameConfigTools.GenConfigDict <int,bot_other_config> ();bullets = GameConfigTools.GenConfigDict <bullet_id,bullet> ();caught_buffs = GameConfigTools.GenConfigDict <string,caught_buff> ();characters = GameConfigTools.GenConfigDict <int,character> ();interactions = GameConfigTools.GenConfigDict <interactionAct,interaction> ();items = GameConfigTools.GenConfigDict <item_id,item> ();lock_areas = GameConfigTools.GenConfigDict <lock_area_id,lock_area> ();new_helpers = GameConfigTools.GenConfigDict <int,new_helper> ();other_configs = GameConfigTools.GenConfigDict <int,other_config> ();passives = GameConfigTools.GenConfigDict <passive_id,passive> ();play_buffs = GameConfigTools.GenConfigDict <play_buff_id,play_buff> ();props = GameConfigTools.GenConfigDict <prop_id,prop> ();pull_buffs = GameConfigTools.GenConfigDict <string,pull_buff> ();push_buffs = GameConfigTools.GenConfigDict <string,push_buff> ();radar_waves = GameConfigTools.GenConfigDict <radar_wave_id,radar_wave> ();rogue_game_chapters = GameConfigTools.GenConfigDict <int,rogue_game_chapter> ();sale_units = GameConfigTools.GenConfigDict <int,sale_unit> ();self_effects = GameConfigTools.GenConfigDict <self_id,self_effect> ();show_texts = GameConfigTools.GenConfigDict <string,show_text> ();skills = GameConfigTools.GenConfigDict <skill_id,skill> ();skill_groups = GameConfigTools.GenConfigDict <string,skill_group> ();snipes = GameConfigTools.GenConfigDict <int,snipe> ();standard_level_ups = GameConfigTools.GenConfigDict <int,standard_level_up> ();summons = GameConfigTools.GenConfigDict <summon_id,summon> ();talents = GameConfigTools.GenConfigDict <int,talent> ();traps = GameConfigTools.GenConfigDict <trap_id,trap> ();vehicles = GameConfigTools.GenConfigDict <vehicle_id,vehicle> ();weapons = GameConfigTools.GenConfigDict <weapon_id,weapon> ();map_rawss = GameConfigTools.GenConfigDict <int,map_raws> ();}
#endif
public  void LoadAllByJson(string path = ""){bad_wordss = GameConfigTools.GenConfigDictByJsonFile <int,bad_words> (path);base_attributes = GameConfigTools.GenConfigDictByJsonFile <int,base_attribute> (path);battle_bots = GameConfigTools.GenConfigDictByJsonFile <int,battle_bot> (path);battle_npcs = GameConfigTools.GenConfigDictByJsonFile <int,battle_npc> (path);bodys = GameConfigTools.GenConfigDictByJsonFile <size,body> (path);bot_other_configs = GameConfigTools.GenConfigDictByJsonFile <int,bot_other_config> (path);bullets = GameConfigTools.GenConfigDictByJsonFile <bullet_id,bullet> (path);caught_buffs = GameConfigTools.GenConfigDictByJsonFile <string,caught_buff> (path);characters = GameConfigTools.GenConfigDictByJsonFile <int,character> (path);interactions = GameConfigTools.GenConfigDictByJsonFile <interactionAct,interaction> (path);items = GameConfigTools.GenConfigDictByJsonFile <item_id,item> (path);lock_areas = GameConfigTools.GenConfigDictByJsonFile <lock_area_id,lock_area> (path);new_helpers = GameConfigTools.GenConfigDictByJsonFile <int,new_helper> (path);other_configs = GameConfigTools.GenConfigDictByJsonFile <int,other_config> (path);passives = GameConfigTools.GenConfigDictByJsonFile <passive_id,passive> (path);play_buffs = GameConfigTools.GenConfigDictByJsonFile <play_buff_id,play_buff> (path);props = GameConfigTools.GenConfigDictByJsonFile <prop_id,prop> (path);pull_buffs = GameConfigTools.GenConfigDictByJsonFile <string,pull_buff> (path);push_buffs = GameConfigTools.GenConfigDictByJsonFile <string,push_buff> (path);radar_waves = GameConfigTools.GenConfigDictByJsonFile <radar_wave_id,radar_wave> (path);rogue_game_chapters = GameConfigTools.GenConfigDictByJsonFile <int,rogue_game_chapter> (path);sale_units = GameConfigTools.GenConfigDictByJsonFile <int,sale_unit> (path);self_effects = GameConfigTools.GenConfigDictByJsonFile <self_id,self_effect> (path);show_texts = GameConfigTools.GenConfigDictByJsonFile <string,show_text> (path);skills = GameConfigTools.GenConfigDictByJsonFile <skill_id,skill> (path);skill_groups = GameConfigTools.GenConfigDictByJsonFile <string,skill_group> (path);snipes = GameConfigTools.GenConfigDictByJsonFile <int,snipe> (path);standard_level_ups = GameConfigTools.GenConfigDictByJsonFile <int,standard_level_up> (path);summons = GameConfigTools.GenConfigDictByJsonFile <summon_id,summon> (path);talents = GameConfigTools.GenConfigDictByJsonFile <int,talent> (path);traps = GameConfigTools.GenConfigDictByJsonFile <trap_id,trap> (path);vehicles = GameConfigTools.GenConfigDictByJsonFile <vehicle_id,vehicle> (path);weapons = GameConfigTools.GenConfigDictByJsonFile <weapon_id,weapon> (path);map_rawss = GameConfigTools.GenConfigDictByJsonFile <int,map_raws> (path);}public void LoadAllByJsonString(Dictionary<string,string> nameToJsonString ){bad_wordss = GameConfigTools.GenConfigDictByJsonString <int,bad_words> (nameToJsonString["bad_words"] );base_attributes = GameConfigTools.GenConfigDictByJsonString <int,base_attribute> (nameToJsonString["base_attribute"] );battle_bots = GameConfigTools.GenConfigDictByJsonString <int,battle_bot> (nameToJsonString["battle_bot"] );battle_npcs = GameConfigTools.GenConfigDictByJsonString <int,battle_npc> (nameToJsonString["battle_npc"] );bodys = GameConfigTools.GenConfigDictByJsonString <size,body> (nameToJsonString["body"] );bot_other_configs = GameConfigTools.GenConfigDictByJsonString <int,bot_other_config> (nameToJsonString["bot_other_config"] );bullets = GameConfigTools.GenConfigDictByJsonString <bullet_id,bullet> (nameToJsonString["bullet"] );caught_buffs = GameConfigTools.GenConfigDictByJsonString <string,caught_buff> (nameToJsonString["caught_buff"] );characters = GameConfigTools.GenConfigDictByJsonString <int,character> (nameToJsonString["character"] );interactions = GameConfigTools.GenConfigDictByJsonString <interactionAct,interaction> (nameToJsonString["interaction"] );items = GameConfigTools.GenConfigDictByJsonString <item_id,item> (nameToJsonString["item"] );lock_areas = GameConfigTools.GenConfigDictByJsonString <lock_area_id,lock_area> (nameToJsonString["lock_area"] );new_helpers = GameConfigTools.GenConfigDictByJsonString <int,new_helper> (nameToJsonString["new_helper"] );other_configs = GameConfigTools.GenConfigDictByJsonString <int,other_config> (nameToJsonString["other_config"] );passives = GameConfigTools.GenConfigDictByJsonString <passive_id,passive> (nameToJsonString["passive"] );play_buffs = GameConfigTools.GenConfigDictByJsonString <play_buff_id,play_buff> (nameToJsonString["play_buff"] );props = GameConfigTools.GenConfigDictByJsonString <prop_id,prop> (nameToJsonString["prop"] );pull_buffs = GameConfigTools.GenConfigDictByJsonString <string,pull_buff> (nameToJsonString["pull_buff"] );push_buffs = GameConfigTools.GenConfigDictByJsonString <string,push_buff> (nameToJsonString["push_buff"] );radar_waves = GameConfigTools.GenConfigDictByJsonString <radar_wave_id,radar_wave> (nameToJsonString["radar_wave"] );rogue_game_chapters = GameConfigTools.GenConfigDictByJsonString <int,rogue_game_chapter> (nameToJsonString["rogue_game_chapter"] );sale_units = GameConfigTools.GenConfigDictByJsonString <int,sale_unit> (nameToJsonString["sale_unit"] );self_effects = GameConfigTools.GenConfigDictByJsonString <self_id,self_effect> (nameToJsonString["self_effect"] );show_texts = GameConfigTools.GenConfigDictByJsonString <string,show_text> (nameToJsonString["show_text"] );skills = GameConfigTools.GenConfigDictByJsonString <skill_id,skill> (nameToJsonString["skill"] );skill_groups = GameConfigTools.GenConfigDictByJsonString <string,skill_group> (nameToJsonString["skill_group"] );snipes = GameConfigTools.GenConfigDictByJsonString <int,snipe> (nameToJsonString["snipe"] );standard_level_ups = GameConfigTools.GenConfigDictByJsonString <int,standard_level_up> (nameToJsonString["standard_level_up"] );summons = GameConfigTools.GenConfigDictByJsonString <summon_id,summon> (nameToJsonString["summon"] );talents = GameConfigTools.GenConfigDictByJsonString <int,talent> (nameToJsonString["talent"] );traps = GameConfigTools.GenConfigDictByJsonString <trap_id,trap> (nameToJsonString["trap"] );vehicles = GameConfigTools.GenConfigDictByJsonString <vehicle_id,vehicle> (nameToJsonString["vehicle"] );weapons = GameConfigTools.GenConfigDictByJsonString <weapon_id,weapon> (nameToJsonString["weapon"] );map_rawss = GameConfigTools.GenConfigDictByJsonString <int,map_raws> (nameToJsonString["map_raws"] );}}[Serializable] public class SimpleObj1:IGameConfig { public int weight { get; set; } [JsonConverter(typeof(StringEnumConverter))]public botOp op { get; set; }  } [Serializable] public class SimpleObj2:IGameConfig { public uint item1 { get; set; } public uint item2 { get; set; }  } [Serializable] public class Gain:IGameConfig { public string item { get; set; } public int num { get; set; }  } [Serializable] public class SimpleObj3:IGameConfig { public string pass { get; set; } public uint level { get; set; }  } [Serializable] public class Point:IGameConfig { public float x { get; set; } public float y { get; set; }  } [Serializable] public class Buff:IGameConfig { [JsonConverter(typeof(StringEnumConverter))]public size size { get; set; } [JsonConverter(typeof(StringEnumConverter))]public buff_type buff_type { get; set; } public string buff_id { get; set; }  } [Serializable] public class SimpleObj4:IGameConfig { public uint key_time { get; set; } public Point key_point { get; set; }  } [Serializable] public class Media:IGameConfig { [JsonConverter(typeof(StringEnumConverter))]public effect_media_type media_type { get; set; } public string e_id { get; set; }  } [Serializable] public class VendorSaleGroup:IGameConfig { public int Num { get; set; } public int[] Range { get; set; }  } [Serializable] public class SimpleObj5:IGameConfig { public uint t { get; set; } public string[] buffs { get; set; }  } [Serializable] public class SimpleObj6:IGameConfig { public uint t { get; set; } public string skillName { get; set; }  } [Serializable] public class Cost:IGameConfig { public string item { get; set; } public int num { get; set; } public int first_use_pay { get; set; }  } [Serializable] public class SimpleObj7:IGameConfig { [JsonConverter(typeof(StringEnumConverter))]public size body { get; set; } public float snipe_speed_fix { get; set; } public string skill_group { get; set; }  } [Serializable] public class SimpleObj8:IGameConfig { [JsonConverter(typeof(StringEnumConverter))]public size body { get; set; } public string blockSkill { get; set; }  } [Serializable] public class TelPoint:IGameConfig { [JsonConverter(typeof(StringEnumConverter))]public direction Direction { get; set; } public Point[] Teleport { get; set; }  } }