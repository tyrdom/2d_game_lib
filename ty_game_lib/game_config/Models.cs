...
public int NewHelperTeam { get; set; }  
 /// <summary> 机器人默认方向探索时间，（被攻击会积累）: </summary>
public uint BotAimTraceDefaultTime { get; set; }  } [Serializable] public class passive:IShowSchemeConfig,IGameConfig {  
 /// <summary> : </summary>
...
public  ImmutableDictionary < int,new_helper> new_helpers { get; set; } 
...
public  ImmutableDictionary < play_buff_id,play_buff> play_buffs { get; set; } 
 /// <summary> rogue游戏章节 </summary>
public  ImmutableDictionary < prop_id,prop> props { get; set; } 
 /// <summary> 自作用媒介 </summary>
public  ImmutableDictionary < string,pull_buff> pull_buffs { get; set; } 
