...
namespace game_config
{
    ...
    public class skill : IGameConfig
    {
        ...
        public Buff[] SetStunBuffToOpponentWhenAbsorb { get; set; }
    }
    ...
    [Serializable]
    public class prop : IShowSchemeConfig, IGameConfig
    {
        /// <summary> : </summary>
        [JsonConverter(typeof(StringEnumConverter))]
    ...
    public class other_config : IGameConfig
    {
        ...
        /// <summary> : </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public play_buff_id atkPassBuffId { get; set; }

        /// <summary> : </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public play_buff_id defPassBuffId { get; set; }

        /// <summary> 未硬直是转化为减速buff: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public play_buff_id dazeBuffId { get; set; }
        ...
        [JsonConverter(typeof(StringEnumConverter))]
        public can_be_hit config_type_enum1 { get; set; }

        /// <summary> 表格对应枚举类型: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public can_be_hit config_type_enum2 { get; set; }

        /// <summary> 表格对应枚举类型: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public can_be_hit config_type_enum3 { get; set; }

        /// <summary> 表格对应枚举类型: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public action_type config_type_enum4 { get; set; }

        /// <summary> 表格对应枚举类型: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public action_type config_type_enum5 { get; set; }

        /// <summary> 表格对应枚举类型: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public action_type config_type_enum6 { get; set; }

        /// <summary> 表格对应枚举类型: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public hit_media config_type_enum7 { get; set; }

        /// <summary> 表格对应枚举类型: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public hit_media config_type_enum8 { get; set; }

        /// <summary> 表格对应枚举类型: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public hit_media config_type_enum9 { get; set; }
    ...
    [Serializable]
    public class battle_bot : IGameConfig
    {
        /// <summary> : </summary>
        public int id { get; set; }
    ...
    public class radar_wave : IGameConfig
    {
        /// <summary> id: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public radar_wave_id id { get; set; }
    ...
    [Serializable]
    public class sale_unit : IGameConfig
    {
        /// <summary> : </summary>
        public int id { get; set; }
        ...
        [JsonConverter(typeof(StringEnumConverter))]
        public sale_type SaleType { get; set; }
    ...
    public class skill_group : IGameConfig
    {
        ...
        public Dictionary<int, string> ChargeSwitch { get; set; }
    }
    ...
    public class rogue_game_chapter : IGameConfig
    {
        ...
        public int ExtraPassiveNum { get; set; }
    }
    ...
    [Serializable]
    public class vehicle : IShowSchemeConfig, IGameConfig
    {
        /// <summary> : </summary>
        [JsonConverter(typeof(StringEnumConverter))]
    ...
    public class play_buff : IGameConfig
    {
        /// <summary> id: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public play_buff_id id { get; set; }
    ...
    public class lock_area : IGameConfig
    {
        /// <summary> id: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public lock_area_id id { get; set; }
    ...
    [Serializable]
    public class item : IShowSchemeConfig, IGameConfig
    {
        /// <summary> id: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
    ...
    [Serializable]
    public class weapon : IShowSchemeConfig, IGameConfig
    {
        /// <summary> id: </summary>
        [JsonConverter(typeof(StringEnumConverter))]
    ...
    [Serializable]
    public class bot_other_config : IGameConfig
    {
        /// <summary> 识别序号: </summary>
        public int id { get; set; }
        ...
        public float NaviPloyRadMulti { get; set; }
    }

    [Serializable]
    public class passive : IShowSchemeConfig, IGameConfig
    {
        /// <summary> : </summary>
        [JsonConverter(typeof(StringEnumConverter))]
    ...
    [Serializable]
    public class pull_buff : IGameConfig
    {
        /// <summary> id: </summary>
        public string id { get; set; }
    ...
    [Serializable]
    public class new_helper : IGameConfig
    {
        /// <summary> id: </summary>
        public int id { get; set; }
    ...
    public enum item_id
    {
        [Description("rand_show")] @rand_show,
        [Description("chip_3")] @chip_3,
        [Description("chip_2")] @chip_2,
        [Description("coin")] @coin,
        [Description("exp")] @exp,
        [Description("free_ticket")] @free_ticket,
        [Description("chip")] @chip,
        [Description("chip_4")] @chip_4
    }
    ...
    public enum ItemType
    {
        ...
        [Description("forShow")] @forShow,
        [Description("bag")] @bag,
        [Description("battle_exp")] @battle_exp
    }

    [Serializable]
    public enum can_be_hit
    {
    ...
    [Serializable]
    public enum hit_media
    {
        [Description("radar_wave")] @radar_wave,
        [Description("bullet")] @bullet,
        [Description("lock_area")] @lock_area
    }

    [Serializable]
    public enum skill_id
    {
        [Description("test_bow_l_3")] @test_bow_l_3,
        [Description("test_sword_shield_l_3")] @test_sword_shield_l_3,
        [Description("test_axe_l_1")] @test_axe_l_1,
        [Description("test_h_1_caught")] @test_h_1_caught,
        [Description("test_bow_l_2")] @test_bow_l_2,
        [Description("test_h_3")] @test_h_3,
        [Description("axe_block")] @axe_block,
        [Description("test_l_2")] @test_l_2,
        [Description("test_sword_shield_h_1")] @test_sword_shield_h_1,
        [Description("test_spear_sp_2")] @test_spear_sp_2,
        [Description("test_l_3")] @test_l_3,
        [Description("test_axe_h_3")] @test_axe_h_3,
        [Description("test_r_3")] @test_r_3,

        [Description("test_sword_shield_switch")]
        @test_sword_shield_switch,
        [Description("test_axe_l_2")] @test_axe_l_2,
        [Description("gun_block")] @gun_block,

        [Description("test_cross_bow_h_trick")]
        @test_cross_bow_h_trick,
        [Description("test_sword_shield_l_1")] @test_sword_shield_l_1,

        [Description("test_sword_shield_block")]
        @test_sword_shield_block,
        [Description("test_spear_sp_1")] @test_spear_sp_1,
        [Description("test_cought_skill")] @test_cought_skill,
        [Description("sword_block")] @sword_block,
        [Description("cross_bow_block")] @cross_bow_block,
        [Description("test_r_s")] @test_r_s,
        [Description("out_vehicle")] @out_vehicle,
        [Description("test_r_1")] @test_r_1,
        [Description("test_bow_h_1")] @test_bow_h_1,
        [Description("test_spear_switch")] @test_spear_switch,
        [Description("test_h_2")] @test_h_2,
        [Description("test_sword_shield_l_2")] @test_sword_shield_l_2,
        [Description("default_take_out")] @default_take_out,
        [Description("test_cross_bow_h_1")] @test_cross_bow_h_1,
        [Description("test_spear_h_1")] @test_spear_h_1,
        [Description("test_cross_bow_switch")] @test_cross_bow_switch,
        [Description("test_spear_l_3")] @test_spear_l_3,
        [Description("test_r_2")] @test_r_2,
        [Description("bow_block")] @bow_block,
        [Description("test_axe_h_2")] @test_axe_h_2,
        [Description("test_spear_l_2")] @test_spear_l_2,
        [Description("test_bow_switch")] @test_bow_switch,
        [Description("test_cross_bow_l_1")] @test_cross_bow_l_1,
        [Description("test_axe_l_3")] @test_axe_l_3,
        [Description("test_spear_l_1")] @test_spear_l_1,
        [Description("test_axe_switch")] @test_axe_switch,
        [Description("test_s_1")] @test_s_1,
        [Description("test_h_1")] @test_h_1,
        [Description("test_spear_block")] @test_spear_block,
        [Description("test_axe_h_1")] @test_axe_h_1,
        [Description("test_bow_l_1")] @test_bow_l_1,
    ...
    public enum op_Act
    {
        ...
        [Description("TakeOut")] @TakeOut,
        [Description("Op1")] @Op1,
        [Description("ByTrick")] @ByTrick,
        [Description("BreakAway")] @BreakAway,
    ...
    public enum weapon_id
    {
        ...
        [Description("test_spear")] @test_spear,
        [Description("test_cross_bow")] @test_cross_bow,
        [Description("test_sword")] @test_sword,
        [Description("test_gun")] @test_gun,
        [Description("test_axe")] @test_axe,
        [Description("test_bow")] @test_bow,
        [Description("test_sword_shield")] @test_sword_shield
    }

    [Serializable]
    public enum prop_id
    {
        [Description("all_reg")] @all_reg,
    ...
    {
        [Description("test_cb_h_2")] @test_cb_h_2,
        [Description("default_block_1")] @default_block_1,
        [Description("test_cb_l_1")] @test_cb_l_1,
        [Description("test_axe_h_1_b_2")] @test_axe_h_1_b_2,
        [Description("test_spr_l_1_b_1")] @test_spr_l_1_b_1,
        [Description("test_l_1_k_1")] @test_l_1_k_1,
        [Description("test_axe_l_1_b_1")] @test_axe_l_1_b_1,
        [Description("test_axe_h_1_b_3")] @test_axe_h_1_b_3,
        [Description("test_axe_l_1_b_2")] @test_axe_l_1_b_2,
        [Description("rocket_punch")] @rocket_punch,
        [Description("test_ss_l_1_b_2")] @test_ss_l_1_b_2,
        [Description("test_ss_h_1_b_1")] @test_ss_h_1_b_1,
        [Description("test_cb_t_1")] @test_cb_t_1,
        [Description("test_cb_l_2")] @test_cb_l_2,
        [Description("test_cb_l_3")] @test_cb_l_3,
        [Description("test_ss_h_1_sp_1")] @test_ss_h_1_sp_1,
        [Description("test_ss_l_1_b_1")] @test_ss_l_1_b_1,
        [Description("test_l_1_k_b")] @test_l_1_k_b,
        [Description("test_spr_h_1_b_1")] @test_spr_h_1_b_1,
        [Description("test_ss_h_1_b_2")] @test_ss_h_1_b_2,
        [Description("test_l_1_b_1")] @test_l_1_b_1,
        [Description("test_spr_l_1_b_3")] @test_spr_l_1_b_3,
        [Description("test_axe_l_1_b_3")] @test_axe_l_1_b_3,
        [Description("test_r_1_b_1")] @test_r_1_b_1,
        [Description("test_spr_l_1_b_2")] @test_spr_l_1_b_2,
        [Description("vehicle_boom")] @vehicle_boom,
        [Description("test_cb_t_2")] @test_cb_t_2,
        [Description("test_cb_t_3")] @test_cb_t_3,
        [Description("test_cb_h_1")] @test_cb_h_1,
        [Description("test_axe_h_1_b_1")] @test_axe_h_1_b_1,
        [Description("mine_atk")] @mine_atk,
        [Description("test_ss_l_1_b_3")] @test_ss_l_1_b_3,
        [Description("test_cb_h_3")] @test_cb_h_3,
        [Description("test_ss_h_1_sp_2")] @test_ss_h_1_sp_2,
        [Description("test_h_1_b_1")] @test_h_1_b_1,
        [Description("test_b_1_b_1")] @test_b_1_b_1
    }

    [Serializable]
    public enum buff_type
    {
        [Description("caught_buff")] @caught_buff,
        [Description("play_buff")] @play_buff,
        [Description("push_buff")] @push_buff,
        [Description("pull_buff")] @pull_buff
    }
    ...
    [Serializable]
    public enum play_buff_id
    {
        [Description("tough_up")] @tough_up,
        [Description("makeDamageAdd")] @makeDamageAdd,
        [Description("break")] @break,
        [Description("hitDaze")] @hitDaze,
        [Description("changeComboStatus")] @changeComboStatus,
        [Description("makeDamageAdd2")] @makeDamageAdd2,
        [Description("takeDamageDecrease")] @takeDamageDecrease,
        [Description("takeDamageAdd")] @takeDamageAdd,
        [Description("bow_damage_up")] @bow_damage_up,
        [Description("tough")] @tough,
        [Description("bow_power_up")] @bow_power_up,
        [Description("pullMark")] @pullMark
    }
    ...
    {
        [Description("Tough")] @Tough,
        [Description("PowerUp")] @PowerUp,
        [Description("ChangeComboStatus")] @ChangeComboStatus,
        [Description("TakeDamageAdd")] @TakeDamageAdd,
        [Description("Break")] @Break,
        [Description("PullMark")] @PullMark,
        [Description("MaxSpeedChange")] @MaxSpeedChange,
        [Description("ToughUp")] @ToughUp,
        [Description("MakeDamageAdd")] @MakeDamageAdd
    }
    ...
    {
        [Description("light_armor2")] @light_armor2,
        [Description("shield_absorb")] @shield_absorb,
        [Description("on_break")] @on_break,
        [Description("ammo_absorb")] @ammo_absorb,
        [Description("sturdy_up")] @sturdy_up,
        [Description("armor_absorb")] @armor_absorb,
        [Description("main_atk_small")] @main_atk_small,
        [Description("weight_up")] @weight_up,
        [Description("other_to_armor")] @other_to_armor,
        [Description("sharded_atk_power")] @sharded_atk_power,
        [Description("push_power")] @push_power,
        [Description("shield_trans1")] @shield_trans1,
        [Description("vicious_armor")] @vicious_armor,
        [Description("ticket_add_5")] @ticket_add_5,
        [Description("emergency_armor")] @emergency_armor,
        [Description("sturdy_weight_up")] @sturdy_weight_up,
        ...
        [Description("light_armor")] @light_armor,
        [Description("ticket_add")] @ticket_add,
        [Description("absorb_up")] @absorb_up,
        [Description("hp_boost")] @hp_boost,
        [Description("armor_boost")] @armor_boost,
        [Description("light_armor1")] @light_armor1,
        [Description("recycle_boost")] @recycle_boost,
        [Description("charge_boost")] @charge_boost,
        [Description("other_to_shield")] @other_to_shield,
        [Description("stun_power")] @stun_power,
        [Description("vicious_armor2")] @vicious_armor2,
        [Description("main_atk_power")] @main_atk_power,
        ...
        [Description("shield_overload")] @shield_overload,
        [Description("heal_effect_boost")] @heal_effect_boost,
        [Description("hp_absorb")] @hp_absorb,
        [Description("shield_overload1")] @shield_overload1,
        [Description("revenge")] @revenge,
        [Description("tough_max")] @tough_max,
        [Description("light_armor3")] @light_armor3,
        [Description("main_atk")] @main_atk,
        [Description("fix_boost")] @fix_boost,
        [Description("energy_armor")] @energy_armor,
        [Description("emergency_shield")] @emergency_shield,
        ...
        [Description("other_to_hp")] @other_to_hp,
        [Description("bladeWave")] @bladeWave,
        [Description("vicious_armor1")] @vicious_armor1,
        [Description("life_power")] @life_power,
    ...
    public enum passive_type
    {
        ...
        [Description("TransRegeneration")] @TransRegeneration,
        [Description("Attack")] @Attack,
        [Description("TickAdd")] @TickAdd,
        [Description("SpecialDamageAdd")] @SpecialDamageAdd,
        [Description("TrapAbout")] @TrapAbout,
        [Description("AddItem")] @AddItem,
        [Description("StunFix")] @StunFix,
    ...
    public static class ResNames
    {
        public static Dictionary<Type, string> NamesDictionary { get; } = new Dictionary<Type, string>
        {
            ...
            { typeof(trap), "trap_s.json" }, { typeof(battle_bot), "battle_bot_s.json" },
            { typeof(radar_wave), "radar_wave_s.json" }, { typeof(sale_unit), "sale_unit_s.json" },
            { typeof(standard_level_up), "standard_level_up_s.json" }, { typeof(snipe), "snipe_s.json" },
            ...
            { typeof(push_buff), "push_buff_s.json" }, { typeof(map_raws), "map_raws_s.json" },
            { typeof(summon), "summon_s.json" }, { typeof(rogue_game_chapter), "rogue_game_chapter_s.json" },
            { typeof(battle_npc), "battle_npc_s.json" }, { typeof(vehicle), "vehicle_s.json" },
            { typeof(play_buff), "play_buff_s.json" }, { typeof(self_effect), "self_effect_s.json" },
            { typeof(lock_area), "lock_area_s.json" }, { typeof(item), "item_s.json" },
            { typeof(weapon), "weapon_s.json" }, { typeof(bot_other_config), "bot_other_config_s.json" },
            { typeof(passive), "passive_s.json" }, { typeof(base_attribute), "base_attribute_s.json" },
            { typeof(pull_buff), "pull_buff_s.json" }, { typeof(new_helper), "new_helper_s.json" }
        };

        public static string[] Names { get; } =
        {
            "skill", "bad_words", "caught_buff", "prop", "talent", "other_config", "trap", "battle_bot", "radar_wave",
            "sale_unit", "standard_level_up", "snipe", "body", "skill_group", "interaction", "show_text", "bullet",
            "character", "push_buff", "map_raws", "summon", "rogue_game_chapter", "battle_npc", "vehicle", "play_buff",
            "self_effect", "lock_area", "item", "weapon", "bot_other_config", "passive", "base_attribute", "pull_buff",
            "new_helper"
        };
    }
    ...
    public class ConfigDictionaries
    {
        ...
        public ConfigDictionaries(string jsonPath = "")
        {
            ...
            all_Immutable_dictionary = new IDictionary[]
            {
                skills, bad_wordss, caught_buffs, props, talents, other_configs, traps, battle_bots, radar_waves,
                sale_units, standard_level_ups, snipes, bodys, skill_groups, interactions, show_texts, bullets,
                characters, push_buffs, map_rawss, summons, rogue_game_chapters, battle_npcs, vehicles, play_buffs,
                self_effects, lock_areas, items, weapons, bot_other_configs, passives, base_attributes, pull_buffs,
                new_helpers
            };
        }
...
#if NETCOREAPP
public  void LoadAllByDll(){skills = GameConfigTools.GenConfigDict <skill_id,skill> ();bad_wordss =
 GameConfigTools.GenConfigDict <int,bad_words> ();caught_buffs =
 GameConfigTools.GenConfigDict <string,caught_buff> ();props = GameConfigTools.GenConfigDict <prop_id,prop> ();talents =
 GameConfigTools.GenConfigDict <int,talent> ();other_configs = GameConfigTools.GenConfigDict <int,other_config> ();traps
 = GameConfigTools.GenConfigDict <trap_id,trap> ();battle_bots =
 GameConfigTools.GenConfigDict <int,battle_bot> ();radar_waves =
 GameConfigTools.GenConfigDict <radar_wave_id,radar_wave> ();sale_units =
 GameConfigTools.GenConfigDict <int,sale_unit> ();standard_level_ups =
 GameConfigTools.GenConfigDict <int,standard_level_up> ();snipes = GameConfigTools.GenConfigDict <int,snipe> ();bodys =
 GameConfigTools.GenConfigDict <size,body> ();skill_groups =
 GameConfigTools.GenConfigDict <string,skill_group> ();interactions =
 GameConfigTools.GenConfigDict <interactionAct,interaction> ();show_texts =
 GameConfigTools.GenConfigDict <string,show_text> ();bullets =
 GameConfigTools.GenConfigDict <bullet_id,bullet> ();characters =
 GameConfigTools.GenConfigDict <int,character> ();push_buffs =
 GameConfigTools.GenConfigDict <string,push_buff> ();map_rawss = GameConfigTools.GenConfigDict <int,map_raws> ();summons
 = GameConfigTools.GenConfigDict <summon_id,summon> ();rogue_game_chapters =
 GameConfigTools.GenConfigDict <int,rogue_game_chapter> ();battle_npcs =
 GameConfigTools.GenConfigDict <int,battle_npc> ();vehicles =
 GameConfigTools.GenConfigDict <vehicle_id,vehicle> ();play_buffs =
 GameConfigTools.GenConfigDict <play_buff_id,play_buff> ();self_effects =
 GameConfigTools.GenConfigDict <self_id,self_effect> ();lock_areas =
 GameConfigTools.GenConfigDict <lock_area_id,lock_area> ();items =
 GameConfigTools.GenConfigDict <item_id,item> ();weapons =
 GameConfigTools.GenConfigDict <weapon_id,weapon> ();bot_other_configs =
 GameConfigTools.GenConfigDict <int,bot_other_config> ();passives =
 GameConfigTools.GenConfigDict <passive_id,passive> ();base_attributes =
 GameConfigTools.GenConfigDict <int,base_attribute> ();pull_buffs =
 GameConfigTools.GenConfigDict <string,pull_buff> ();new_helpers = GameConfigTools.GenConfigDict <int,new_helper> ();}
#endif
        public void LoadAllByJson(string path = "")
        {
            skills = GameConfigTools.GenConfigDictByJsonFile<skill_id, skill>(path);
            ...
            traps = GameConfigTools.GenConfigDictByJsonFile<trap_id, trap>(path);
            battle_bots = GameConfigTools.GenConfigDictByJsonFile<int, battle_bot>(path);
            radar_waves = GameConfigTools.GenConfigDictByJsonFile<radar_wave_id, radar_wave>(path);
            sale_units = GameConfigTools.GenConfigDictByJsonFile<int, sale_unit>(path);
            ...
            bullets = GameConfigTools.GenConfigDictByJsonFile<bullet_id, bullet>(path);
            ...
            play_buffs = GameConfigTools.GenConfigDictByJsonFile<play_buff_id, play_buff>(path);
            self_effects = GameConfigTools.GenConfigDictByJsonFile<self_id, self_effect>(path);
            ...
            bot_other_configs = GameConfigTools.GenConfigDictByJsonFile<int, bot_other_config>(path);
            ...
            pull_buffs = GameConfigTools.GenConfigDictByJsonFile<string, pull_buff>(path);
            new_helpers = GameConfigTools.GenConfigDictByJsonFile<int, new_helper>(path);
        }

        public void LoadAllByJsonString(Dictionary<string, string> nameToJsonString)
        {
            skills = GameConfigTools.GenConfigDictByJsonString<skill_id, skill>(nameToJsonString["skill"]);
            ...
            traps = GameConfigTools.GenConfigDictByJsonString<trap_id, trap>(nameToJsonString["trap"]);
            battle_bots = GameConfigTools.GenConfigDictByJsonString<int, battle_bot>(nameToJsonString["battle_bot"]);
            radar_waves =
                GameConfigTools.GenConfigDictByJsonString<radar_wave_id, radar_wave>(nameToJsonString["radar_wave"]);
            sale_units = GameConfigTools.GenConfigDictByJsonString<int, sale_unit>(nameToJsonString["sale_unit"]);
            standard_level_ups =
            ...
            bullets = GameConfigTools.GenConfigDictByJsonString<bullet_id, bullet>(nameToJsonString["bullet"]);
            ...
            play_buffs =
                GameConfigTools.GenConfigDictByJsonString<play_buff_id, play_buff>(nameToJsonString["play_buff"]);
            self_effects =
                GameConfigTools.GenConfigDictByJsonString<self_id, self_effect>(nameToJsonString["self_effect"]);
            lock_areas =
            ...
            bot_other_configs =
                GameConfigTools.GenConfigDictByJsonString<int, bot_other_config>(nameToJsonString["bot_other_config"]);
            ...
            pull_buffs = GameConfigTools.GenConfigDictByJsonString<string, pull_buff>(nameToJsonString["pull_buff"]);
            new_helpers = GameConfigTools.GenConfigDictByJsonString<int, new_helper>(nameToJsonString["new_helper"]);
        }
    }
    ...
    [Serializable]
    public class VendorSaleGroup : IGameConfig
    {
        public int Num { get; set; }
    ...
    public class SimpleObj8 : IGameConfig
    {
        ...
        public string blockSkill { get; set; }
    }
}