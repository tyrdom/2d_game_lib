...
public float AmmoAbsorb { get; set; }  
 /// <summary> : </summary>
public float ProtectAbsorb { get; set; }  } [Serializable] public class battle_bot:IGameConfig {  
 /// <summary> : </summary>
public int id { get; set; }  
 /// <summary> 说明: </summary>
public string info { get; set; }  
...
public int Snipe2 { get; set; }  
 /// <summary> : </summary>
public int Snipe3 { get; set; }  } [Serializable] public enum item_id{[Description("chip_4")]@chip_4,[Description("chip_3")]@chip_3,[Description("chip_2")]@chip_2,[Description("chip")]@chip,[Description("coin")]@coin,[Description("exp")]@exp,[Description("free_ticket")]@free_ticket}[Serializable] public enum ItemType{[Description("bag")]@bag,[Description("battle_exp")]@battle_exp,[Description("money")]@money}[Serializable] public enum can_be_hit{[Description("character")]@character,[Description("trap")]@trap,[Description("vehicle")]@vehicle}[Serializable] public enum action_type{[Description("skill")]@skill,[Description("interaction")]@interaction,[Description("prop")]@prop}[Serializable] public enum hit_media{[Description("radar_wave")]@radar_wave,[Description("bullet")]@bullet,[Description("lock_area")]@lock_area}[Serializable] public enum botOp{[Description("none")]@none,[Description("op1")]@op1,[Description("op2")]@op2}[Serializable] public enum size{[Description("big")]@big,[Description("tiny")]@tiny,[Description("small")]@small,[Description("medium")]@medium,[Description("default")]@default}[Serializable] public enum interactableType{[Description("weapon")]@weapon,[Description("prop")]@prop,[Description("vehicle")]@vehicle,[Description("default")]@default}[Serializable] public enum bullet_id{[Description("vehicle_boom")]@vehicle_boom,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("test_l_1_b_1")]@test_l_1_b_1}[Serializable] public enum raw_shape{[Description("round")]@round,[Description("sector")]@sector,[Description("line")]@line,[Description("rectangle")]@rectangle}[Serializable] public enum buff_type{[Description("push_buff")]@push_buff,[Description("caught_buff")]@caught_buff}[Serializable] public enum hit_type{[Description("melee")]@melee,[Description("range")]@range}[Serializable] public enum target_type{[Description("other_team")]@other_team,[Description("all_team")]@all_team}[Serializable] public enum interactionAct{[Description("pick_up_cage")]@pick_up_cage,[Description("recycle_cage")]@recycle_cage,[Description("kick_vehicle")]@kick_vehicle,[Description("get_in_vehicle")]@get_in_vehicle,[Description("get_info")]@get_info,[Description("apply")]@apply}[Serializable] public enum lock_area_id{[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_h_1_lock")]@test_h_1_lock}[Serializable] public enum direction{[Description("North")]@North,[Description("South")]@South,[Description("West")]@West,[Description("East")]@East}[Serializable] public enum passive_id{[Description("ammo_absorb")]@ammo_absorb,[Description("hp_boost")]@hp_boost,[Description("protect_time_boost")]@protect_time_boost,[Description("emergency_shield")]@emergency_shield,[Description("heal_effect_boost")]@heal_effect_boost,[Description("ticket_add_5")]@ticket_add_5,[Description("vicious_armor1")]@vicious_armor1,[Description("armor_boost")]@armor_boost,[Description("max_ammo_boost")]@max_ammo_boost,[Description("light_armor2")]@light_armor2,[Description("recycle_boost")]@recycle_boost,[Description("reload_boost")]@reload_boost,[Description("protect_absorb")]@protect_absorb,[Description("shield_trans1")]@shield_trans1,[Description("back_stab")]@back_stab,[Description("prop_boost")]@prop_boost,[Description("shield_absorb")]@shield_absorb,[Description("other_to_hp")]@other_to_hp,[Description("shield_boost")]@shield_boost,[Description("main_atk")]@main_atk,[Description("sharded_atk")]@sharded_atk,[Description("charge_boost")]@charge_boost,[Description("back_stab_small")]@back_stab_small,[Description("light_armor")]@light_armor,[Description("energy_armor")]@energy_armor,[Description("life_power")]@life_power,[Description("fix_boost")]@fix_boost,[Description("shield_overload")]@shield_overload,[Description("defence_boost")]@defence_boost,[Description("trap_survive")]@trap_survive,[Description("shield_reg_boost")]@shield_reg_boost,[Description("energy_armor1")]@energy_armor1,[Description("sharded_atk_small")]@sharded_atk_small,[Description("hp_absorb")]@hp_absorb,[Description("trap_atk")]@trap_atk,[Description("speed_boost")]@speed_boost,[Description("light_armor1")]@light_armor1,[Description("shield_trans")]@shield_trans,[Description("tough_max")]@tough_max,[Description("main_atk_small")]@main_atk_small,[Description("ticket_add")]@ticket_add,[Description("emergency_armor")]@emergency_armor,[Description("other_to_armor")]@other_to_armor,[Description("sweep")]@sweep,[Description("armor_absorb")]@armor_absorb,[Description("other_to_shield")]@other_to_shield,[Description("shield_overload1")]@shield_overload1,[Description("vicious_armor")]@vicious_armor}[Serializable] public enum passive_type{[Description("TransRegeneration")]@TransRegeneration,[Description("HitWinBuff")]@HitWinBuff,[Description("TickAdd")]@TickAdd,[Description("AddItem")]@AddItem,[Description("AbsorbAdd")]@AbsorbAdd,[Description("Other")]@Other,[Description("TrapAbout")]@TrapAbout,[Description("Attack")]@Attack,[Description("Survive")]@Survive,[Description("Regen")]@Regen,[Description("SpecialSurviveDamageAdd")]@SpecialSurviveDamageAdd}[Serializable] public enum play_buff_effect_type{[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("Tough")]@Tough,[Description("Break")]@Break,[Description("TakeDamageAdd")]@TakeDamageAdd}[Serializable] public enum stack_mode{[Description("Stack")]@Stack,[Description("Time")]@Time,[Description("OverWrite")]@OverWrite}[Serializable] public enum prop_id{[Description("rocket_boost")]@rocket_boost,[Description("alert")]@alert,[Description("radar")]@radar,[Description("repair")]@repair,[Description("battery")]@battery,[Description("trap")]@trap,[Description("heal")]@heal,[Description("ammos")]@ammos}[Serializable] public enum effect_media_type{[Description("radar_wave")]@radar_wave,[Description("bullet")]@bullet,[Description("self")]@self,[Description("summon")]@summon}[Serializable] public enum bot_use_cond{[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("HpBlowPercent")]@HpBlowPercent,[Description("CantUse")]@CantUse,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("EnemyOnSight")]@EnemyOnSight,[Description("ShieldBlowPercent")]@ShieldBlowPercent}[Serializable] public enum PushType{[Description("Center")]@Center,[Description("Vector")]@Vector}[Serializable] public enum radar_wave_id{[Description("alert_trick_r")]@alert_trick_r,[Description("r1")]@r1,[Description("mine_trick_r")]@mine_trick_r}[Serializable] public enum sale_type{[Description("prop")]@prop,[Description("passive")]@passive}[Serializable] public enum self_id{[Description("r1")]@r1,[Description("h1")]@h1,[Description("c1")]@c1,[Description("f1")]@f1}[Serializable] public enum skill_id{[Description("test_cought_skill")]@test_cought_skill,[Description("test_r_3")]@test_r_3,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_r_1")]@test_r_1,[Description("out_vehicle")]@out_vehicle,[Description("test_l_1")]@test_l_1,[Description("test_s_1")]@test_s_1,[Description("test_bow_l_3")]@test_bow_l_3,[Description("test_h_3")]@test_h_3,[Description("test_r_2")]@test_r_2,[Description("test_bow_l_1")]@test_bow_l_1,[Description("test_h_2")]@test_h_2,[Description("test_bow_h_1")]@test_bow_h_1,[Description("test_l_3")]@test_l_3,[Description("test_l_2")]@test_l_2,[Description("test_h_1")]@test_h_1,[Description("test_r_s")]@test_r_s,[Description("test_bow_l_2")]@test_bow_l_2,[Description("default_take_out")]@default_take_out,[Description("test_bow_switch")]@test_bow_switch}[Serializable] public enum op_Act{[Description("CaughtTrick")]@CaughtTrick,[Description("Op1")]@Op1,[Description("BreakAway")]@BreakAway,[Description("Switch")]@Switch,[Description("Op2")]@Op2,[Description("TakeOut")]@TakeOut}[Serializable] public enum weapon_id{[Description("unarmed")]@unarmed,[Description("test_bow")]@test_bow,[Description("test_gun")]@test_gun,[Description("test_sword")]@test_sword}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum vehicle_id{[Description("type_a")]@type_a,[Description("type_c")]@type_c,[Description("type_b")]@type_b}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(sale_unit), "sale_unit_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_bot","battle_npc","body","bullet","caught_buff","character","interaction","item","lock_area","map_raws","other_config","passive","play_buff","prop","push_buff","radar_wave","rogue_game_chapter","sale_unit","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
