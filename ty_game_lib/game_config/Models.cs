...
public uint ActShowDelayTime { get; set; }  
 /// <summary> : </summary>
public int MaxCombo { get; set; }  } [Serializable] public class body:IGameConfig {  
 /// <summary> id: </summary>
...
public int Snipe2 { get; set; }  
 /// <summary> : </summary>
public int Snipe3 { get; set; }  } [Serializable] public enum item_id{[Description("代金券")]@代金券,[Description("金币")]@金币,[Description("芯片_2")]@芯片_2,[Description("芯片_3")]@芯片_3,[Description("芯片")]@芯片,[Description("战斗经验")]@战斗经验,[Description("芯片_4")]@芯片_4}[Serializable] public enum ItemType{[Description("bag")]@bag,[Description("battle_exp")]@battle_exp,[Description("money")]@money}[Serializable] public enum can_be_hit{[Description("trap")]@trap,[Description("vehicle")]@vehicle,[Description("character")]@character}[Serializable] public enum action_type{[Description("prop")]@prop,[Description("skill")]@skill,[Description("interaction")]@interaction}[Serializable] public enum hit_media{[Description("bullet")]@bullet,[Description("lock_area")]@lock_area,[Description("radar_wave")]@radar_wave}[Serializable] public enum size{[Description("tiny")]@tiny,[Description("big")]@big,[Description("medium")]@medium,[Description("default")]@default,[Description("small")]@small}[Serializable] public enum interactableType{[Description("prop")]@prop,[Description("vehicle")]@vehicle,[Description("weapon")]@weapon}[Serializable] public enum botOp{[Description("op2")]@op2,[Description("op1")]@op1,[Description("none")]@none}[Serializable] public enum bullet_id{[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("vehicle_boom")]@vehicle_boom,[Description("test_l_1_b_1")]@test_l_1_b_1}[Serializable] public enum raw_shape{[Description("sector")]@sector,[Description("line")]@line,[Description("rectangle")]@rectangle,[Description("round")]@round}[Serializable] public enum buff_type{[Description("push_buff")]@push_buff,[Description("caught_buff")]@caught_buff}[Serializable] public enum hit_type{[Description("range")]@range,[Description("melee")]@melee}[Serializable] public enum target_type{[Description("other_team")]@other_team,[Description("all_team")]@all_team}[Serializable] public enum interactionAct{[Description("pick_up_cage")]@pick_up_cage,[Description("kick_vehicle")]@kick_vehicle,[Description("recycle_cage")]@recycle_cage,[Description("get_info")]@get_info,[Description("get_in_vehicle")]@get_in_vehicle,[Description("apply")]@apply}[Serializable] public enum lock_area_id{[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_h_1_lock")]@test_h_1_lock}[Serializable] public enum direction{[Description("South")]@South,[Description("West")]@West,[Description("East")]@East,[Description("North")]@North}[Serializable] public enum passive_id{[Description("protect_time_boost")]@protect_time_boost,[Description("hp_boost")]@hp_boost,[Description("shield_reg_boost")]@shield_reg_boost,[Description("ticket_add_5")]@ticket_add_5,[Description("defence_boost")]@defence_boost,[Description("ammo_absorb")]@ammo_absorb,[Description("sharded_atk_small")]@sharded_atk_small,[Description("fix_boost")]@fix_boost,[Description("shield_boost")]@shield_boost,[Description("armor_boost")]@armor_boost,[Description("back_stab")]@back_stab,[Description("reload_boost")]@reload_boost,[Description("main_atk_small")]@main_atk_small,[Description("back_stab_small")]@back_stab_small,[Description("charge_boost")]@charge_boost,[Description("armor_absorb")]@armor_absorb,[Description("ticket_add")]@ticket_add,[Description("trap_atk")]@trap_atk,[Description("protect_absorb")]@protect_absorb,[Description("recycle_boost")]@recycle_boost,[Description("shield_absorb")]@shield_absorb,[Description("max_ammo_boost")]@max_ammo_boost,[Description("trap_survive")]@trap_survive,[Description("main_atk")]@main_atk,[Description("hp_absorb")]@hp_absorb,[Description("prop_boost")]@prop_boost,[Description("heal_effect_boost")]@heal_effect_boost,[Description("sharded_atk")]@sharded_atk,[Description("speed_boost")]@speed_boost,[Description("sweep")]@sweep,[Description("tough_max")]@tough_max}[Serializable] public enum passive_type{[Description("TrapAbout")]@TrapAbout,[Description("HitWinBuff")]@HitWinBuff,[Description("Survive")]@Survive,[Description("Regen")]@Regen,[Description("AddItem")]@AddItem,[Description("Attack")]@Attack,[Description("Other")]@Other,[Description("TickAdd")]@TickAdd,[Description("AbsorbAdd")]@AbsorbAdd}[Serializable] public enum play_buff_effect_type{[Description("Break")]@Break,[Description("TakeDamageAdd")]@TakeDamageAdd,[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("Tough")]@Tough}[Serializable] public enum stack_mode{[Description("Stack")]@Stack,[Description("Time")]@Time,[Description("OverWrite")]@OverWrite}[Serializable] public enum prop_id{[Description("trap")]@trap,[Description("alert")]@alert,[Description("rocket_boost")]@rocket_boost,[Description("repair")]@repair,[Description("ammos")]@ammos,[Description("battery")]@battery,[Description("heal")]@heal,[Description("radar")]@radar}[Serializable] public enum effect_media_type{[Description("bullet")]@bullet,[Description("summon")]@summon,[Description("radar_wave")]@radar_wave,[Description("self")]@self}[Serializable] public enum bot_use_cond{[Description("EnemyOnSight")]@EnemyOnSight,[Description("HpBlowPercent")]@HpBlowPercent,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("CantUse")]@CantUse,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("ShieldBlowPercent")]@ShieldBlowPercent}[Serializable] public enum PushType{[Description("Vector")]@Vector,[Description("Center")]@Center}[Serializable] public enum radar_wave_id{[Description("r1")]@r1,[Description("alert_trick_r")]@alert_trick_r,[Description("mine_trick_r")]@mine_trick_r}[Serializable] public enum self_id{[Description("r1")]@r1,[Description("c1")]@c1,[Description("f1")]@f1,[Description("h1")]@h1}[Serializable] public enum skill_id{[Description("test_l_1")]@test_l_1,[Description("test_r_3")]@test_r_3,[Description("test_h_3")]@test_h_3,[Description("test_l_2")]@test_l_2,[Description("test_h_1")]@test_h_1,[Description("out_vehicle")]@out_vehicle,[Description("test_l_3")]@test_l_3,[Description("default_take_out")]@default_take_out,[Description("test_r_1")]@test_r_1,[Description("test_cought_skill")]@test_cought_skill,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_r_s")]@test_r_s,[Description("test_s_1")]@test_s_1,[Description("test_h_2")]@test_h_2,[Description("test_r_2")]@test_r_2}[Serializable] public enum op_Act{[Description("TakeOut")]@TakeOut,[Description("Op2")]@Op2,[Description("BreakAway")]@BreakAway,[Description("Switch")]@Switch,[Description("Op1")]@Op1,[Description("CaughtTrick")]@CaughtTrick}[Serializable] public enum weapon_id{[Description("unarmed")]@unarmed,[Description("test_gun")]@test_gun,[Description("test_sword")]@test_sword}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum vehicle_id{[Description("type_b")]@type_b,[Description("type_c")]@type_c,[Description("type_a")]@type_a}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_npc","body","bullet","caught_buff","character","interaction","item","lock_area","map_raws","other_config","passive","play_buff","prop","push_buff","radar_wave","rogue_game_chapter","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
