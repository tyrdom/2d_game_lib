using System;using System.Collections;using System.Collections.Generic;using System.ComponentModel;using Newtonsoft.Json;using Newtonsoft.Json.Converters;namespace game_config {[Serializable] public class skill:IBodyActionConfig,IGameConfig {  
 /// <summary> : </summary>
...
public string TrickSkill { get; set; }  } [Serializable] public class prop:IShowSchemeConfig,IBodyActionConfig,IGameConfig {  
 /// <summary> : </summary>
...
public float ZoomOnTime { get; set; }  
 /// <summary> : </summary>
public float ZoomOffTime { get; set; }  } [Serializable] public class body:IGameConfig {  
 /// <summary> id: </summary>
...
public Dictionary<int,string> ChargeSwitch { get; set; }  } [Serializable] public class interaction:IBodyActionConfig,IGameConfig {  
 /// <summary> : </summary>
...
public string chinese { get; set; }  } [Serializable] public class pull_buff:IGameConfig {  
 /// <summary> id: </summary>
public string id { get; set; }  
 /// <summary> : </summary>
public uint LastTime { get; set; }  
...
public Point[] FixVector { get; set; }  } [Serializable] public class bullet:IGameConfig {  
 /// <summary> id: </summary>
...
public Point[] FixVector { get; set; }  
 /// <summary> : </summary>
public float UpForce { get; set; }  } [Serializable] public class new_helper:IGameConfig {  
 /// <summary> id: </summary>
public int id { get; set; }  
 /// <summary> : </summary>
...
public int[] MapResNeed { get; set; }  
 /// <summary> : </summary>
public int Queue { get; set; }  } [Serializable] public class map_raws:IGameConfig {  
 /// <summary> : </summary>
public int id { get; set; }  
 /// <summary> : </summary>
public string info { get; set; }  
...
public int MaxStack { get; set; }  } [Serializable] public class self_effect:IGameConfig {  
 /// <summary> id: </summary>
...
public float ProtectAbsorb { get; set; }  
 /// <summary> : </summary>
public float ListenRange { get; set; }  } [Serializable] public enum item_id{[Description("free_ticket")]@free_ticket,[Description("rand_show")]@rand_show,[Description("chip_4")]@chip_4,[Description("chip_3")]@chip_3,[Description("coin")]@coin,[Description("chip_2")]@chip_2,[Description("chip")]@chip,[Description("exp")]@exp}[Serializable] public enum ItemType{[Description("bag")]@bag,[Description("money")]@money,[Description("forShow")]@forShow,[Description("battle_exp")]@battle_exp}[Serializable] public enum play_buff_id{[Description("pullMark")]@pullMark,[Description("takeDamageDecrease")]@takeDamageDecrease,[Description("takeDamageDecrease2")]@takeDamageDecrease2,[Description("tough")]@tough,[Description("hitDaze")]@hitDaze,[Description("makeDamageAdd2")]@makeDamageAdd2,[Description("bow_damage_up")]@bow_damage_up,[Description("makeDamageAdd")]@makeDamageAdd,[Description("changeComboStatus")]@changeComboStatus,[Description("takeDamageAdd")]@takeDamageAdd,[Description("tough_up")]@tough_up,[Description("bow_power_up")]@bow_power_up,[Description("break")]@break}[Serializable] public enum can_be_hit{[Description("trap")]@trap,[Description("vehicle")]@vehicle,[Description("character")]@character}[Serializable] public enum action_type{[Description("interaction")]@interaction,[Description("prop")]@prop,[Description("skill")]@skill}[Serializable] public enum hit_media{[Description("bullet")]@bullet,[Description("lock_area")]@lock_area,[Description("radar_wave")]@radar_wave}[Serializable] public enum skill_id{[Description("test_axe_h_3")]@test_axe_h_3,[Description("test_dual_swords_switch")]@test_dual_swords_switch,[Description("test_sword_shield_l_3")]@test_sword_shield_l_3,[Description("test_spear_l_3")]@test_spear_l_3,[Description("test_sword_shield_h_1")]@test_sword_shield_h_1,[Description("test_bow_l_3")]@test_bow_l_3,[Description("test_r_3")]@test_r_3,[Description("out_vehicle")]@out_vehicle,[Description("test_axe_l_2")]@test_axe_l_2,[Description("test_s_1")]@test_s_1,[Description("test_bow_l_1")]@test_bow_l_1,[Description("test_bow_l_2")]@test_bow_l_2,[Description("test_cross_bow_h_1")]@test_cross_bow_h_1,[Description("test_dual_swords_l_3")]@test_dual_swords_l_3,[Description("test_axe_l_3")]@test_axe_l_3,[Description("test_h_3")]@test_h_3,[Description("test_spear_h_1")]@test_spear_h_1,[Description("test_cought_skill")]@test_cought_skill,[Description("test_axe_h_2")]@test_axe_h_2,[Description("test_l_1")]@test_l_1,[Description("test_spear_switch")]@test_spear_switch,[Description("test_cross_bow_l_1")]@test_cross_bow_l_1,[Description("test_spear_block")]@test_spear_block,[Description("test_axe_switch")]@test_axe_switch,[Description("test_dual_swords_l_4")]@test_dual_swords_l_4,[Description("test_sword_shield_l_2")]@test_sword_shield_l_2,[Description("cross_bow_block")]@cross_bow_block,[Description("test_cross_bow_switch")]@test_cross_bow_switch,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_sword_shield_switch")]@test_sword_shield_switch,[Description("sword_block")]@sword_block,[Description("test_dual_swords_h_1")]@test_dual_swords_h_1,[Description("test_sword_shield_l_1")]@test_sword_shield_l_1,[Description("test_h_2")]@test_h_2,[Description("test_dual_swords_block")]@test_dual_swords_block,[Description("gun_block")]@gun_block,[Description("test_r_2")]@test_r_2,[Description("bow_block")]@bow_block,[Description("test_l_3")]@test_l_3,[Description("test_spear_l_2")]@test_spear_l_2,[Description("test_dual_swords_h_2")]@test_dual_swords_h_2,[Description("axe_block")]@axe_block,[Description("test_l_2")]@test_l_2,[Description("test_axe_l_1")]@test_axe_l_1,[Description("test_dual_swords_l_1")]@test_dual_swords_l_1,[Description("test_spear_l_1")]@test_spear_l_1,[Description("test_bow_switch")]@test_bow_switch,[Description("test_h_1")]@test_h_1,[Description("test_axe_h_1")]@test_axe_h_1,[Description("test_cross_bow_h_trick")]@test_cross_bow_h_trick,[Description("test_bow_h_1")]@test_bow_h_1,[Description("default_take_out")]@default_take_out,[Description("test_spear_sp_2")]@test_spear_sp_2,[Description("test_spear_sp_1")]@test_spear_sp_1,[Description("test_r_s")]@test_r_s,[Description("test_r_1")]@test_r_1,[Description("test_sword_shield_block")]@test_sword_shield_block,[Description("test_dual_swords_l_2")]@test_dual_swords_l_2}[Serializable] public enum op_Act{[Description("CaughtTrick")]@CaughtTrick,[Description("Switch")]@Switch,[Description("Block")]@Block,[Description("BreakAway")]@BreakAway,[Description("ByTrick")]@ByTrick,[Description("Op1")]@Op1,[Description("TakeOut")]@TakeOut,[Description("Op2")]@Op2}[Serializable] public enum weapon_id{[Description("unarmed")]@unarmed,[Description("test_cross_bow")]@test_cross_bow,[Description("test_spear")]@test_spear,[Description("test_bow")]@test_bow,[Description("test_gun")]@test_gun,[Description("test_axe")]@test_axe,[Description("test_dual_swords")]@test_dual_swords,[Description("test_sword_shield")]@test_sword_shield,[Description("test_sword")]@test_sword}[Serializable] public enum size{[Description("big")]@big,[Description("medium")]@medium,[Description("small")]@small,[Description("tiny")]@tiny,[Description("default")]@default}[Serializable] public enum buff_type{[Description("caught_buff")]@caught_buff,[Description("pull_buff")]@pull_buff,[Description("push_buff")]@push_buff}[Serializable] public enum prop_id{[Description("battery")]@battery,[Description("all_reg")]@all_reg,[Description("heal")]@heal,[Description("ammos")]@ammos,[Description("alert")]@alert,[Description("trap")]@trap,[Description("rocket_boost")]@rocket_boost,[Description("radar")]@radar,[Description("repair")]@repair}[Serializable] public enum effect_media_type{[Description("radar_wave")]@radar_wave,[Description("summon")]@summon,[Description("bullet")]@bullet,[Description("self")]@self}[Serializable] public enum bot_use_cond{[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("HpBlowPercent")]@HpBlowPercent,[Description("CantUse")]@CantUse,[Description("ShieldBlowPercent")]@ShieldBlowPercent,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("EnemyOnSight")]@EnemyOnSight}[Serializable] public enum trap_id{[Description("mine")]@mine,[Description("alert")]@alert}[Serializable] public enum botOp{[Description("op1")]@op1,[Description("op2")]@op2,[Description("none")]@none}[Serializable] public enum radar_wave_id{[Description("r1")]@r1,[Description("mine_trick_r")]@mine_trick_r,[Description("alert_trick_r")]@alert_trick_r}[Serializable] public enum raw_shape{[Description("line")]@line,[Description("round")]@round,[Description("rectangle")]@rectangle,[Description("sector")]@sector}[Serializable] public enum sale_type{[Description("weapon")]@weapon,[Description("prop")]@prop,[Description("passive")]@passive}[Serializable] public enum interactionAct{[Description("kick_vehicle")]@kick_vehicle,[Description("get_info")]@get_info,[Description("pick_up_cage")]@pick_up_cage,[Description("get_in_vehicle")]@get_in_vehicle,[Description("apply")]@apply,[Description("recycle_cage")]@recycle_cage}[Serializable] public enum bullet_id{[Description("default_block_1")]@default_block_1,[Description("test_dsw_l_3_b_4")]@test_dsw_l_3_b_4,[Description("test_ss_l_1_b_2")]@test_ss_l_1_b_2,[Description("test_b_1_b_1")]@test_b_1_b_1,[Description("test_ss_h_1_b_1")]@test_ss_h_1_b_1,[Description("test_spr_l_1_b_3")]@test_spr_l_1_b_3,[Description("test_cb_t_2")]@test_cb_t_2,[Description("test_axe_l_1_b_3")]@test_axe_l_1_b_3,[Description("vehicle_boom")]@vehicle_boom,[Description("test_cb_h_2")]@test_cb_h_2,[Description("test_spr_h_1_b_1")]@test_spr_h_1_b_1,[Description("test_dsw_h_1_b_2")]@test_dsw_h_1_b_2,[Description("test_axe_h_1_b_1")]@test_axe_h_1_b_1,[Description("test_cb_l_3")]@test_cb_l_3,[Description("test_cb_h_1")]@test_cb_h_1,[Description("test_spr_l_1_b_2")]@test_spr_l_1_b_2,[Description("test_cb_h_3")]@test_cb_h_3,[Description("test_l_1_b_1")]@test_l_1_b_1,[Description("test_axe_l_1_b_1")]@test_axe_l_1_b_1,[Description("test_cb_l_2")]@test_cb_l_2,[Description("test_ss_h_1_b_2")]@test_ss_h_1_b_2,[Description("test_l_1_k_b")]@test_l_1_k_b,[Description("test_dsw_l_1_b_1")]@test_dsw_l_1_b_1,[Description("rocket_punch")]@rocket_punch,[Description("test_axe_l_1_b_2")]@test_axe_l_1_b_2,[Description("test_ss_h_1_sp_1")]@test_ss_h_1_sp_1,[Description("test_dsw_l_1_b_3")]@test_dsw_l_1_b_3,[Description("test_spr_l_1_b_1")]@test_spr_l_1_b_1,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("test_axe_h_1_b_2")]@test_axe_h_1_b_2,[Description("test_ss_l_1_b_1")]@test_ss_l_1_b_1,[Description("test_dsw_h_1_b_1")]@test_dsw_h_1_b_1,[Description("test_cb_t_3")]@test_cb_t_3,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_cb_l_1")]@test_cb_l_1,[Description("test_dsw_l_1_b_4")]@test_dsw_l_1_b_4,[Description("mine_atk")]@mine_atk,[Description("test_ss_l_1_b_4")]@test_ss_l_1_b_4,[Description("test_dsw_l_1_b_2")]@test_dsw_l_1_b_2,[Description("test_ss_h_1_sp_2")]@test_ss_h_1_sp_2,[Description("test_ss_l_1_b_3")]@test_ss_l_1_b_3,[Description("test_dsw_l_3_b_3")]@test_dsw_l_3_b_3,[Description("test_l_1_k_1")]@test_l_1_k_1,[Description("test_cb_t_1")]@test_cb_t_1,[Description("test_axe_h_1_b_3")]@test_axe_h_1_b_3,[Description("test_dsw_switch_1")]@test_dsw_switch_1}[Serializable] public enum hit_type{[Description("melee")]@melee,[Description("range")]@range}[Serializable] public enum target_type{[Description("other_team")]@other_team,[Description("all_team")]@all_team}[Serializable] public enum PushType{[Description("Center")]@Center,[Description("Vector")]@Vector}[Serializable] public enum direction{[Description("North")]@North,[Description("West")]@West,[Description("East")]@East,[Description("South")]@South}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum interactableType{[Description("prop")]@prop,[Description("default")]@default,[Description("weapon")]@weapon,[Description("vehicle")]@vehicle}[Serializable] public enum vehicle_id{[Description("type_b")]@type_b,[Description("type_c")]@type_c,[Description("type_a")]@type_a}[Serializable] public enum play_buff_effect_type{[Description("PullMark")]@PullMark,[Description("PowerUp")]@PowerUp,[Description("Tough")]@Tough,[Description("MaxSpeedChange")]@MaxSpeedChange,[Description("TakeDamageAdd")]@TakeDamageAdd,[Description("Break")]@Break,[Description("ToughUp")]@ToughUp,[Description("ChangeComboStatus")]@ChangeComboStatus,[Description("MakeDamageAdd")]@MakeDamageAdd}[Serializable] public enum stack_mode{[Description("OverWrite")]@OverWrite,[Description("Time")]@Time,[Description("Stack")]@Stack}[Serializable] public enum self_id{[Description("c1")]@c1,[Description("a1")]@a1,[Description("f1")]@f1,[Description("h1")]@h1,[Description("r1")]@r1}[Serializable] public enum lock_area_id{[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_long_lock")]@test_long_lock,[Description("test_h_1_lock")]@test_h_1_lock}[Serializable] public enum passive_id{[Description("tough_max")]@tough_max,[Description("protect_absorb")]@protect_absorb,[Description("life_power")]@life_power,[Description("vicious_armor1")]@vicious_armor1,[Description("emergency_armor")]@emergency_armor,[Description("shield_overload")]@shield_overload,[Description("defence_boost")]@defence_boost,[Description("back_stab")]@back_stab,[Description("armor_absorb")]@armor_absorb,[Description("speed_boost")]@speed_boost,[Description("atk_more_protect")]@atk_more_protect,[Description("ammo_absorb")]@ammo_absorb,[Description("shield_boost")]@shield_boost,[Description("blade_wave_atk")]@blade_wave_atk,[Description("energy_armor")]@energy_armor,[Description("light_armor1")]@light_armor1,[Description("prop_boost")]@prop_boost,[Description("push_power")]@push_power,[Description("light_armor")]@light_armor,[Description("back_stab1")]@back_stab1,[Description("other_to_armor")]@other_to_armor,[Description("main_atk_power")]@main_atk_power,[Description("shield_trans")]@shield_trans,[Description("recycle_boost")]@recycle_boost,[Description("other_to_shield")]@other_to_shield,[Description("fix_boost")]@fix_boost,[Description("full_shield_power")]@full_shield_power,[Description("trap_atk")]@trap_atk,[Description("ticket_add_5")]@ticket_add_5,[Description("sharded_atk_small")]@sharded_atk_small,[Description("sharded_atk")]@sharded_atk,[Description("revenge")]@revenge,[Description("back_stab_small")]@back_stab_small,[Description("full_hp_power")]@full_hp_power,[Description("stun_power")]@stun_power,[Description("light_armor3")]@light_armor3,[Description("ticket_add")]@ticket_add,[Description("emergency_shield")]@emergency_shield,[Description("shield_reg_boost")]@shield_reg_boost,[Description("sturdy_up")]@sturdy_up,[Description("weakness")]@weakness,[Description("vicious_armor")]@vicious_armor,[Description("hp_absorb")]@hp_absorb,[Description("sweep")]@sweep,[Description("full_shield_power1")]@full_shield_power1,[Description("shield_absorb")]@shield_absorb,[Description("max_ammo_boost")]@max_ammo_boost,[Description("emergency_heal")]@emergency_heal,[Description("weight_up")]@weight_up,[Description("light_armor2")]@light_armor2,[Description("blade_wave")]@blade_wave,[Description("sharded_atk_power")]@sharded_atk_power,[Description("absorb_up")]@absorb_up,[Description("main_atk_small")]@main_atk_small,[Description("other_to_hp")]@other_to_hp,[Description("reload_boost")]@reload_boost,[Description("sturdy_weight_up")]@sturdy_weight_up,[Description("on_break")]@on_break,[Description("shield_overload1")]@shield_overload1,[Description("other_to_shield2")]@other_to_shield2,[Description("protect_time_boost")]@protect_time_boost,[Description("charge_boost")]@charge_boost,[Description("main_atk")]@main_atk,[Description("trap_survive")]@trap_survive,[Description("vicious_armor2")]@vicious_armor2,[Description("emergency_protect")]@emergency_protect,[Description("heal_effect_boost")]@heal_effect_boost,[Description("hp_boost")]@hp_boost,[Description("armor_boost")]@armor_boost,[Description("shield_trans1")]@shield_trans1}[Serializable] public enum passive_type{[Description("Regen")]@Regen,[Description("SpecialFullDamageAdd")]@SpecialFullDamageAdd,[Description("TrickRegeneration")]@TrickRegeneration,[Description("StunFix")]@StunFix,[Description("TransRegeneration")]@TransRegeneration,[Description("AbsorbAdd")]@AbsorbAdd,[Description("HitWinBuff")]@HitWinBuff,[Description("AddItem")]@AddItem,[Description("TrapAbout")]@TrapAbout,[Description("SpecialDamageAdd")]@SpecialDamageAdd,[Description("ProtectAbout")]@ProtectAbout,[Description("Attack")]@Attack,[Description("BladeWave")]@BladeWave,[Description("Survive")]@Survive,[Description("Other")]@Other}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(skill), "skill_s.json"},{typeof(bad_words), "bad_words_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(talent), "talent_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(trap), "trap_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(sale_unit), "sale_unit_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(body), "body_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(pull_buff), "pull_buff_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(character), "character_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(new_helper), "new_helper_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(summon), "summon_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(item), "item_s.json"},{typeof(weapon), "weapon_s.json"},{typeof(bot_other_config), "bot_other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(base_attribute), "base_attribute_s.json"}};public static string[] Names{get;} = { "skill","bad_words","caught_buff","prop","talent","other_config","trap","battle_bot","radar_wave","sale_unit","standard_level_up","snipe","body","skill_group","interaction","show_text","pull_buff","bullet","character","push_buff","new_helper","map_raws","summon","rogue_game_chapter","battle_npc","vehicle","play_buff","self_effect","lock_area","item","weapon","bot_other_config","passive","base_attribute"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
...
public Dictionary < passive_id,passive> passives { get; set; } 
 /// <summary> None </summary>
public Dictionary < int,base_attribute> base_attributes { get; set; }public  IDictionary[] all_Immutable_dictionary  {get;set;}
#if NETCOREAPP
        ...
        public ConfigDictionaries()
        {
            ...
            {
               skills,bad_wordss,caught_buffs,props,talents,other_configs,traps,battle_bots,radar_waves,sale_units,standard_level_ups,snipes,bodys,skill_groups,interactions,show_texts,pull_buffs,bullets,characters,push_buffs,new_helpers,map_rawss,summons,rogue_game_chapters,battle_npcs,vehicles,play_buffs,self_effects,lock_areas,items,weapons,bot_other_configs,passives,base_attributes
            };
        }
#endif
