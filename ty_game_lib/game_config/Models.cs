...
public int[] GrassIdx { get; set; }  
 /// <summary> : </summary>
public int[] PoolIdx { get; set; }  } [Serializable] public class new_helper:IGameConfig {  
 /// <summary> id: </summary>
public int id { get; set; }  
 /// <summary> : </summary>
...
public int Snipe2 { get; set; }  
 /// <summary> : </summary>
public int Snipe3 { get; set; }  } [Serializable] public enum item_id{[Description("chip")]@chip,[Description("chip_3")]@chip_3,[Description("chip_2")]@chip_2,[Description("exp")]@exp,[Description("free_ticket")]@free_ticket,[Description("chip_4")]@chip_4,[Description("rand_show")]@rand_show,[Description("coin")]@coin}[Serializable] public enum ItemType{[Description("battle_exp")]@battle_exp,[Description("bag")]@bag,[Description("money")]@money,[Description("forShow")]@forShow}[Serializable] public enum play_buff_id{[Description("hitDaze")]@hitDaze,[Description("tough")]@tough,[Description("makeDamageAdd2")]@makeDamageAdd2,[Description("pullMark")]@pullMark,[Description("takeDamageDecrease")]@takeDamageDecrease,[Description("tough_up")]@tough_up,[Description("makeDamageAdd")]@makeDamageAdd,[Description("break")]@break,[Description("changeComboStatus")]@changeComboStatus,[Description("bow_damage_up")]@bow_damage_up,[Description("takeDamageAdd")]@takeDamageAdd,[Description("bow_power_up")]@bow_power_up}[Serializable] public enum can_be_hit{[Description("trap")]@trap,[Description("character")]@character,[Description("vehicle")]@vehicle}[Serializable] public enum action_type{[Description("skill")]@skill,[Description("prop")]@prop,[Description("interaction")]@interaction}[Serializable] public enum hit_media{[Description("lock_area")]@lock_area,[Description("bullet")]@bullet,[Description("radar_wave")]@radar_wave}[Serializable] public enum botOp{[Description("op1")]@op1,[Description("none")]@none,[Description("op2")]@op2}[Serializable] public enum size{[Description("small")]@small,[Description("medium")]@medium,[Description("default")]@default,[Description("tiny")]@tiny,[Description("big")]@big}[Serializable] public enum interactableType{[Description("vehicle")]@vehicle,[Description("weapon")]@weapon,[Description("default")]@default,[Description("prop")]@prop}[Serializable] public enum bullet_id{[Description("test_l_1_b_1")]@test_l_1_b_1,[Description("test_axe_h_1_b_3")]@test_axe_h_1_b_3,[Description("test_ss_l_1_b_1")]@test_ss_l_1_b_1,[Description("default_block_1")]@default_block_1,[Description("test_cb_t_3")]@test_cb_t_3,[Description("test_cb_l_1")]@test_cb_l_1,[Description("test_cb_h_3")]@test_cb_h_3,[Description("test_dsw_l_3_b_4")]@test_dsw_l_3_b_4,[Description("test_ss_h_1_sp_2")]@test_ss_h_1_sp_2,[Description("test_dsw_l_1_b_3")]@test_dsw_l_1_b_3,[Description("test_b_1_b_1")]@test_b_1_b_1,[Description("test_cb_l_2")]@test_cb_l_2,[Description("test_axe_l_1_b_2")]@test_axe_l_1_b_2,[Description("test_dsw_l_3_b_3")]@test_dsw_l_3_b_3,[Description("test_dsw_h_1_b_1")]@test_dsw_h_1_b_1,[Description("test_dsw_h_1_b_2")]@test_dsw_h_1_b_2,[Description("test_spr_l_1_b_3")]@test_spr_l_1_b_3,[Description("test_dsw_l_1_b_2")]@test_dsw_l_1_b_2,[Description("test_ss_h_1_sp_1")]@test_ss_h_1_sp_1,[Description("test_cb_t_2")]@test_cb_t_2,[Description("test_cb_t_1")]@test_cb_t_1,[Description("mine_atk")]@mine_atk,[Description("test_ss_h_1_b_2")]@test_ss_h_1_b_2,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("rocket_punch")]@rocket_punch,[Description("test_spr_l_1_b_2")]@test_spr_l_1_b_2,[Description("test_spr_h_1_b_1")]@test_spr_h_1_b_1,[Description("test_axe_l_1_b_3")]@test_axe_l_1_b_3,[Description("test_axe_l_1_b_1")]@test_axe_l_1_b_1,[Description("test_cb_h_1")]@test_cb_h_1,[Description("test_ss_l_1_b_4")]@test_ss_l_1_b_4,[Description("test_spr_l_1_b_1")]@test_spr_l_1_b_1,[Description("vehicle_boom")]@vehicle_boom,[Description("test_axe_h_1_b_2")]@test_axe_h_1_b_2,[Description("test_ss_l_1_b_3")]@test_ss_l_1_b_3,[Description("test_axe_h_1_b_1")]@test_axe_h_1_b_1,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_l_1_k_1")]@test_l_1_k_1,[Description("test_ss_h_1_b_1")]@test_ss_h_1_b_1,[Description("test_cb_h_2")]@test_cb_h_2,[Description("test_dsw_l_1_b_1")]@test_dsw_l_1_b_1,[Description("test_l_1_k_b")]@test_l_1_k_b,[Description("test_dsw_switch_1")]@test_dsw_switch_1,[Description("test_cb_l_3")]@test_cb_l_3,[Description("test_dsw_l_1_b_4")]@test_dsw_l_1_b_4,[Description("test_ss_l_1_b_2")]@test_ss_l_1_b_2}[Serializable] public enum raw_shape{[Description("round")]@round,[Description("line")]@line,[Description("sector")]@sector,[Description("rectangle")]@rectangle}[Serializable] public enum buff_type{[Description("caught_buff")]@caught_buff,[Description("pull_buff")]@pull_buff,[Description("push_buff")]@push_buff}[Serializable] public enum hit_type{[Description("melee")]@melee,[Description("range")]@range}[Serializable] public enum target_type{[Description("all_team")]@all_team,[Description("other_team")]@other_team}[Serializable] public enum interactionAct{[Description("get_info")]@get_info,[Description("apply")]@apply,[Description("kick_vehicle")]@kick_vehicle,[Description("pick_up_cage")]@pick_up_cage,[Description("get_in_vehicle")]@get_in_vehicle,[Description("recycle_cage")]@recycle_cage}[Serializable] public enum lock_area_id{[Description("test_h_1_lock")]@test_h_1_lock,[Description("test_l_1_lock")]@test_l_1_lock,[Description("test_long_lock")]@test_long_lock}[Serializable] public enum direction{[Description("South")]@South,[Description("West")]@West,[Description("East")]@East,[Description("North")]@North}[Serializable] public enum passive_id{[Description("speed_boost")]@speed_boost,[Description("emergency_protect")]@emergency_protect,[Description("on_break")]@on_break,[Description("trap_atk")]@trap_atk,[Description("sharded_atk_small")]@sharded_atk_small,[Description("shield_reg_boost")]@shield_reg_boost,[Description("back_stab_small")]@back_stab_small,[Description("heal_effect_boost")]@heal_effect_boost,[Description("other_to_shield")]@other_to_shield,[Description("defence_boost")]@defence_boost,[Description("main_atk_power")]@main_atk_power,[Description("prop_boost")]@prop_boost,[Description("reload_boost")]@reload_boost,[Description("energy_armor")]@energy_armor,[Description("blade_wave_atk")]@blade_wave_atk,[Description("light_armor1")]@light_armor1,[Description("shield_absorb")]@shield_absorb,[Description("atk_more_protect")]@atk_more_protect,[Description("weight_up")]@weight_up,[Description("back_stab")]@back_stab,[Description("protect_absorb")]@protect_absorb,[Description("emergency_armor")]@emergency_armor,[Description("absorb_up")]@absorb_up,[Description("other_to_hp")]@other_to_hp,[Description("emergency_heal")]@emergency_heal,[Description("ammo_absorb")]@ammo_absorb,[Description("protect_time_boost")]@protect_time_boost,[Description("vicious_armor")]@vicious_armor,[Description("armor_boost")]@armor_boost,[Description("max_ammo_boost")]@max_ammo_boost,[Description("emergency_shield")]@emergency_shield,[Description("recycle_boost")]@recycle_boost,[Description("hp_boost")]@hp_boost,[Description("sharded_atk_power")]@sharded_atk_power,[Description("vicious_armor2")]@vicious_armor2,[Description("light_armor")]@light_armor,[Description("shield_trans1")]@shield_trans1,[Description("armor_absorb")]@armor_absorb,[Description("vicious_armor1")]@vicious_armor1,[Description("shield_overload1")]@shield_overload1,[Description("main_atk")]@main_atk,[Description("push_power")]@push_power,[Description("life_power")]@life_power,[Description("stun_power")]@stun_power,[Description("ticket_add")]@ticket_add,[Description("other_to_armor")]@other_to_armor,[Description("sturdy_weight_up")]@sturdy_weight_up,[Description("fix_boost")]@fix_boost,[Description("trap_survive")]@trap_survive,[Description("ticket_add_5")]@ticket_add_5,[Description("shield_overload")]@shield_overload,[Description("main_atk_small")]@main_atk_small,[Description("weakness")]@weakness,[Description("blade_wave")]@blade_wave,[Description("tough_max")]@tough_max,[Description("charge_boost")]@charge_boost,[Description("revenge")]@revenge,[Description("light_armor2")]@light_armor2,[Description("shield_trans")]@shield_trans,[Description("light_armor3")]@light_armor3,[Description("hp_absorb")]@hp_absorb,[Description("sharded_atk")]@sharded_atk,[Description("sweep")]@sweep,[Description("sturdy_up")]@sturdy_up,[Description("shield_boost")]@shield_boost}[Serializable] public enum passive_type{[Description("AddItem")]@AddItem,[Description("Other")]@Other,[Description("StunFix")]@StunFix,[Description("HitWinBuff")]@HitWinBuff,[Description("TrapAbout")]@TrapAbout,[Description("default")]@default,[Description("ProtectAbout")]@ProtectAbout,[Description("BladeWave")]@BladeWave,[Description("TransRegeneration")]@TransRegeneration,[Description("SpecialDamageAdd")]@SpecialDamageAdd,[Description("TrickRegeneration")]@TrickRegeneration,[Description("AbsorbAdd")]@AbsorbAdd,[Description("Survive")]@Survive,[Description("Attack")]@Attack,[Description("Regen")]@Regen}[Serializable] public enum play_buff_effect_type{[Description("ToughUp")]@ToughUp,[Description("ChangeComboStatus")]@ChangeComboStatus,[Description("MaxSpeedChange")]@MaxSpeedChange,[Description("Tough")]@Tough,[Description("PullMark")]@PullMark,[Description("TakeDamageAdd")]@TakeDamageAdd,[Description("PowerUp")]@PowerUp,[Description("MakeDamageAdd")]@MakeDamageAdd,[Description("Break")]@Break}[Serializable] public enum stack_mode{[Description("Stack")]@Stack,[Description("OverWrite")]@OverWrite,[Description("Time")]@Time}[Serializable] public enum prop_id{[Description("radar")]@radar,[Description("trap")]@trap,[Description("rocket_boost")]@rocket_boost,[Description("all_reg")]@all_reg,[Description("heal")]@heal,[Description("battery")]@battery,[Description("repair")]@repair,[Description("alert")]@alert,[Description("ammos")]@ammos}[Serializable] public enum effect_media_type{[Description("bullet")]@bullet,[Description("summon")]@summon,[Description("self")]@self,[Description("radar_wave")]@radar_wave}[Serializable] public enum bot_use_cond{[Description("EnemyOnSight")]@EnemyOnSight,[Description("ShieldBlowPercent")]@ShieldBlowPercent,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("HpBlowPercent")]@HpBlowPercent,[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("CantUse")]@CantUse}[Serializable] public enum PushType{[Description("Vector")]@Vector,[Description("Center")]@Center}[Serializable] public enum radar_wave_id{[Description("mine_trick_r")]@mine_trick_r,[Description("r1")]@r1,[Description("alert_trick_r")]@alert_trick_r}[Serializable] public enum sale_type{[Description("passive")]@passive,[Description("prop")]@prop,[Description("weapon")]@weapon}[Serializable] public enum self_id{[Description("a1")]@a1,[Description("h1")]@h1,[Description("r1")]@r1,[Description("f1")]@f1,[Description("c1")]@c1}[Serializable] public enum skill_id{[Description("test_cross_bow_h_1")]@test_cross_bow_h_1,[Description("test_sword_shield_l_2")]@test_sword_shield_l_2,[Description("test_s_1")]@test_s_1,[Description("out_vehicle")]@out_vehicle,[Description("test_spear_switch")]@test_spear_switch,[Description("test_sword_shield_h_1")]@test_sword_shield_h_1,[Description("test_sword_shield_l_3")]@test_sword_shield_l_3,[Description("test_spear_l_2")]@test_spear_l_2,[Description("test_bow_l_1")]@test_bow_l_1,[Description("test_dual_swords_block")]@test_dual_swords_block,[Description("test_h_2")]@test_h_2,[Description("test_spear_sp_1")]@test_spear_sp_1,[Description("test_cross_bow_l_1")]@test_cross_bow_l_1,[Description("test_axe_l_2")]@test_axe_l_2,[Description("gun_block")]@gun_block,[Description("test_sword_shield_l_1")]@test_sword_shield_l_1,[Description("test_spear_h_1")]@test_spear_h_1,[Description("test_dual_swords_h_1")]@test_dual_swords_h_1,[Description("test_bow_switch")]@test_bow_switch,[Description("test_spear_l_3")]@test_spear_l_3,[Description("test_r_3")]@test_r_3,[Description("test_bow_l_2")]@test_bow_l_2,[Description("test_axe_h_2")]@test_axe_h_2,[Description("sword_block")]@sword_block,[Description("test_bow_l_3")]@test_bow_l_3,[Description("test_axe_l_3")]@test_axe_l_3,[Description("test_spear_l_1")]@test_spear_l_1,[Description("test_h_3")]@test_h_3,[Description("cross_bow_block")]@cross_bow_block,[Description("axe_block")]@axe_block,[Description("test_axe_l_1")]@test_axe_l_1,[Description("test_h_1")]@test_h_1,[Description("test_bow_h_1")]@test_bow_h_1,[Description("test_axe_h_3")]@test_axe_h_3,[Description("default_take_out")]@default_take_out,[Description("test_l_2")]@test_l_2,[Description("test_r_2")]@test_r_2,[Description("test_dual_swords_h_2")]@test_dual_swords_h_2,[Description("test_cross_bow_switch")]@test_cross_bow_switch,[Description("test_r_1")]@test_r_1,[Description("test_l_3")]@test_l_3,[Description("test_dual_swords_l_4")]@test_dual_swords_l_4,[Description("test_dual_swords_switch")]@test_dual_swords_switch,[Description("test_l_1")]@test_l_1,[Description("test_dual_swords_l_2")]@test_dual_swords_l_2,[Description("test_r_s")]@test_r_s,[Description("test_dual_swords_l_3")]@test_dual_swords_l_3,[Description("test_cought_skill")]@test_cought_skill,[Description("test_cross_bow_h_trick")]@test_cross_bow_h_trick,[Description("test_dual_swords_l_1")]@test_dual_swords_l_1,[Description("test_axe_switch")]@test_axe_switch,[Description("test_sword_shield_switch")]@test_sword_shield_switch,[Description("test_spear_block")]@test_spear_block,[Description("test_spear_sp_2")]@test_spear_sp_2,[Description("test_sword_shield_block")]@test_sword_shield_block,[Description("bow_block")]@bow_block,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_axe_h_1")]@test_axe_h_1}[Serializable] public enum op_Act{[Description("CaughtTrick")]@CaughtTrick,[Description("Op2")]@Op2,[Description("TakeOut")]@TakeOut,[Description("Switch")]@Switch,[Description("ByTrick")]@ByTrick,[Description("Op1")]@Op1,[Description("Block")]@Block,[Description("BreakAway")]@BreakAway}[Serializable] public enum weapon_id{[Description("test_cross_bow")]@test_cross_bow,[Description("test_sword")]@test_sword,[Description("test_bow")]@test_bow,[Description("unarmed")]@unarmed,[Description("test_spear")]@test_spear,[Description("test_dual_swords")]@test_dual_swords,[Description("test_axe")]@test_axe,[Description("test_sword_shield")]@test_sword_shield,[Description("test_gun")]@test_gun}[Serializable] public enum summon_id{[Description("s_a_alert")]@s_a_alert,[Description("s_a_mine")]@s_a_mine}[Serializable] public enum trap_id{[Description("mine")]@mine,[Description("alert")]@alert}[Serializable] public enum vehicle_id{[Description("type_c")]@type_c,[Description("type_b")]@type_b,[Description("type_a")]@type_a}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_bot), "battle_bot_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bot_other_config), "bot_other_config_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(new_helper), "new_helper_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(pull_buff), "pull_buff_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(sale_unit), "sale_unit_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_bot","battle_npc","body","bot_other_config","bullet","caught_buff","character","interaction","item","lock_area","map_raws","new_helper","other_config","passive","play_buff","prop","pull_buff","push_buff","radar_wave","rogue_game_chapter","sale_unit","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
...
public Dictionary < vehicle_id,vehicle> vehicles { get; set; } 
 /// <summary> None </summary>
public Dictionary < weapon_id,weapon> weapons { get; set; }public  IDictionary[] all_Immutable_dictionary  {get;set;}
#if NETCOREAPP
