...
public int LocalRotate { get; set; }  } [Serializable] public class other_config:IGameConfig {  
...
public int BigEliteNum { get; set; }  
 /// <summary> : </summary>
public int[] BigBossCreepRandIn { get; set; }  } [Serializable] public class self_effect:IGameConfig {  
 /// <summary> id: </summary>
...
public Point[][] StartPoints { get; set; }  
 /// <summary> : </summary>
public TelPoint[] TransPoint { get; set; }  } [Serializable] public class battle_bot:IGameConfig {  
 /// <summary> : </summary>
public int id { get; set; }  
 /// <summary> 说明: </summary>
public string info { get; set; }  
...
public uint ActShowDelayTime { get; set; }  
 /// <summary> : </summary>
public int MaxCombo { get; set; }  } [Serializable] public enum ItemType{[Description("money")]@money,[Description("battle_exp")]@battle_exp,[Description("bag")]@bag}[Serializable] public enum size{[Description("tiny")]@tiny,[Description("big")]@big,[Description("small")]@small,[Description("medium")]@medium,[Description("default")]@default}[Serializable] public enum interactableType{[Description("weapon")]@weapon,[Description("vehicle")]@vehicle,[Description("prop")]@prop}[Serializable] public enum botOp{[Description("op2")]@op2,[Description("op1")]@op1,[Description("none")]@none}[Serializable] public enum raw_shape{[Description("sector")]@sector,[Description("rectangle")]@rectangle,[Description("round")]@round,[Description("line")]@line}[Serializable] public enum buff_type{[Description("caught_buff")]@caught_buff,[Description("push_buff")]@push_buff}[Serializable] public enum hit_type{[Description("range")]@range,[Description("melee")]@melee}[Serializable] public enum target_type{[Description("all_team")]@all_team,[Description("other_team")]@other_team}[Serializable] public enum interactionAct{[Description("apply")]@apply,[Description("kick_vehicle")]@kick_vehicle,[Description("recycle_cage")]@recycle_cage,[Description("get_info")]@get_info,[Description("get_in_vehicle")]@get_in_vehicle,[Description("pick_up_cage")]@pick_up_cage}[Serializable] public enum passive_type{[Description("AbsorbAdd")]@AbsorbAdd,[Description("HitWinBuff")]@HitWinBuff,[Description("TrapAbout")]@TrapAbout,[Description("TickAdd")]@TickAdd,[Description("Other")]@Other,[Description("Survive")]@Survive,[Description("Regen")]@Regen,[Description("AddItem")]@AddItem,[Description("Attack")]@Attack}[Serializable] public enum play_buff_effect_type{[Description("Tough")]@Tough,[Description("Break")]@Break,[Description("TakeDamageAdd")]@TakeDamageAdd,[Description("MakeDamageAdd")]@MakeDamageAdd}[Serializable] public enum stack_mode{[Description("Time")]@Time,[Description("OverWrite")]@OverWrite,[Description("Stack")]@Stack}[Serializable] public enum effect_media_type{[Description("self")]@self,[Description("bullet")]@bullet,[Description("summon")]@summon,[Description("radar_wave")]@radar_wave}[Serializable] public enum bot_use_cond{[Description("ArmorBlowPercent")]@ArmorBlowPercent,[Description("EnemyOnSight")]@EnemyOnSight,[Description("OnPatrolRandom")]@OnPatrolRandom,[Description("ShieldBlowPercent")]@ShieldBlowPercent,[Description("HpBlowPercent")]@HpBlowPercent,[Description("CantUse")]@CantUse}[Serializable] public enum PushType{[Description("Center")]@Center,[Description("Vector")]@Vector}[Serializable] public enum direction{[Description("North")]@North,[Description("East")]@East,[Description("West")]@West,[Description("South")]@South}[Serializable] public enum item_id{[Description("chip_2")]@chip_2,[Description("芯片_4")]@芯片_4,[Description("金币")]@金币,[Description("chip_4")]@chip_4,[Description("芯片_3")]@芯片_3,[Description("coin")]@coin,[Description("代金券")]@代金券,[Description("exp")]@exp,[Description("芯片")]@芯片,[Description("战斗经验")]@战斗经验,[Description("芯片_2")]@芯片_2,[Description("chip")]@chip,[Description("chip_3")]@chip_3,[Description("free_ticket")]@free_ticket}[Serializable] public enum can_be_hit{[Description("trap")]@trap,[Description("character")]@character,[Description("vehicle")]@vehicle}[Serializable] public enum action_type{[Description("interaction")]@interaction,[Description("skill")]@skill,[Description("prop")]@prop}[Serializable] public enum hit_media{[Description("bullet")]@bullet,[Description("lock_area")]@lock_area,[Description("radar_wave")]@radar_wave}[Serializable] public enum bullet_id{[Description("test_l_1_b_1")]@test_l_1_b_1,[Description("test_r_1_b_1")]@test_r_1_b_1,[Description("test_h_1_b_1")]@test_h_1_b_1,[Description("vehicle_boom")]@vehicle_boom}[Serializable] public enum lock_area_id{[Description("test_h_1_lock")]@test_h_1_lock,[Description("test_l_1_lock")]@test_l_1_lock}[Serializable] public enum passive_id{[Description("main_atk_small")]@main_atk_small,[Description("shield_reg_boost")]@shield_reg_boost,[Description("ticket_add_5")]@ticket_add_5,[Description("fix_boost")]@fix_boost,[Description("trap_survive")]@trap_survive,[Description("charge_boost")]@charge_boost,[Description("armor_boost")]@armor_boost,[Description("defence_boost")]@defence_boost,[Description("protect_absorb")]@protect_absorb,[Description("sharded_atk_small")]@sharded_atk_small,[Description("shield_absorb")]@shield_absorb,[Description("ticket_add")]@ticket_add,[Description("reload_boost")]@reload_boost,[Description("tough_max")]@tough_max,[Description("hp_boost")]@hp_boost,[Description("trap_atk")]@trap_atk,[Description("shield_boost")]@shield_boost,[Description("speed_boost")]@speed_boost,[Description("back_stab")]@back_stab,[Description("armor_absorb")]@armor_absorb,[Description("main_atk")]@main_atk,[Description("prop_boost")]@prop_boost,[Description("sharded_atk")]@sharded_atk,[Description("protect_time_boost")]@protect_time_boost,[Description("ammo_absorb")]@ammo_absorb,[Description("heal_effect_boost")]@heal_effect_boost,[Description("sweep")]@sweep,[Description("hp_absorb")]@hp_absorb,[Description("back_stab_small")]@back_stab_small,[Description("max_ammo_boost")]@max_ammo_boost,[Description("recycle_boost")]@recycle_boost}[Serializable] public enum prop_id{[Description("repair")]@repair,[Description("alert")]@alert,[Description("radar")]@radar,[Description("rocket_boost")]@rocket_boost,[Description("battery")]@battery,[Description("ammos")]@ammos,[Description("trap")]@trap,[Description("heal")]@heal}[Serializable] public enum radar_wave_id{[Description("alert_trick_r")]@alert_trick_r,[Description("r1")]@r1,[Description("mine_trick_r")]@mine_trick_r}[Serializable] public enum self_id{[Description("r1")]@r1,[Description("f1")]@f1,[Description("h1")]@h1,[Description("c1")]@c1}[Serializable] public enum skill_id{[Description("test_l_2")]@test_l_2,[Description("test_s_1")]@test_s_1,[Description("test_r_2")]@test_r_2,[Description("test_h_1_caught")]@test_h_1_caught,[Description("test_h_2")]@test_h_2,[Description("test_l_1")]@test_l_1,[Description("default_take_out")]@default_take_out,[Description("test_h_1")]@test_h_1,[Description("test_h_3")]@test_h_3,[Description("test_r_s")]@test_r_s,[Description("test_r_1")]@test_r_1,[Description("test_cought_skill")]@test_cought_skill,[Description("out_vehicle")]@out_vehicle,[Description("test_l_3")]@test_l_3,[Description("test_r_3")]@test_r_3}[Serializable] public enum op_Act{[Description("Op1")]@Op1,[Description("TakeOut")]@TakeOut,[Description("CaughtTrick")]@CaughtTrick,[Description("BreakAway")]@BreakAway,[Description("Op2")]@Op2,[Description("Switch")]@Switch}[Serializable] public enum weapon_id{[Description("test_gun")]@test_gun,[Description("unarmed")]@unarmed,[Description("test_sword")]@test_sword}[Serializable] public enum summon_id{[Description("s_a_mine")]@s_a_mine,[Description("s_a_alert")]@s_a_alert}[Serializable] public enum vehicle_id{[Description("type_a")]@type_a,[Description("type_c")]@type_c,[Description("type_b")]@type_b}public static class ResNames { public static Dictionary < Type, string > NamesDictionary{get;} = new Dictionary < Type, string > { {typeof(bad_words), "bad_words_s.json"},{typeof(base_attribute), "base_attribute_s.json"},{typeof(battle_npc), "battle_npc_s.json"},{typeof(body), "body_s.json"},{typeof(bullet), "bullet_s.json"},{typeof(caught_buff), "caught_buff_s.json"},{typeof(character), "character_s.json"},{typeof(interaction), "interaction_s.json"},{typeof(item), "item_s.json"},{typeof(lock_area), "lock_area_s.json"},{typeof(other_config), "other_config_s.json"},{typeof(passive), "passive_s.json"},{typeof(play_buff), "play_buff_s.json"},{typeof(prop), "prop_s.json"},{typeof(push_buff), "push_buff_s.json"},{typeof(radar_wave), "radar_wave_s.json"},{typeof(rogue_game_chapter), "rogue_game_chapter_s.json"},{typeof(self_effect), "self_effect_s.json"},{typeof(show_text), "show_text_s.json"},{typeof(skill), "skill_s.json"},{typeof(skill_group), "skill_group_s.json"},{typeof(snipe), "snipe_s.json"},{typeof(standard_level_up), "standard_level_up_s.json"},{typeof(summon), "summon_s.json"},{typeof(talent), "talent_s.json"},{typeof(trap), "trap_s.json"},{typeof(vehicle), "vehicle_s.json"},{typeof(weapon), "weapon_s.json"},{typeof(map_raws), "map_raws_s.json"},{typeof(battle_bot), "battle_bot_s.json"}};public static string[] Names{get;} = { "bad_words","base_attribute","battle_npc","body","bullet","caught_buff","character","interaction","item","lock_area","other_config","passive","play_buff","prop","push_buff","radar_wave","rogue_game_chapter","self_effect","show_text","skill","skill_group","snipe","standard_level_up","summon","talent","trap","vehicle","weapon","map_raws","battle_bot"};}[Serializable] public  class ConfigDictionaries { 
 /// <summary> 屏蔽词 </summary>
...
public  ImmutableDictionary < int,battle_bot> battle_bots { get; set; }public  IDictionary[] all_Immutable_dictionary  {get;set;}
#if NETCOREAPP
...
#if NETCOREAPP
public  void LoadAllByDll(){bad_wordss = GameConfigTools.GenConfigDict <int,bad_words> ();base_attributes = GameConfigTools.GenConfigDict <int,base_attribute> ();battle_npcs = GameConfigTools.GenConfigDict <int,battle_npc> ();bodys = GameConfigTools.GenConfigDict <size,body> ();bullets = GameConfigTools.GenConfigDict <bullet_id,bullet> ();caught_buffs = GameConfigTools.GenConfigDict <string,caught_buff> ();characters = GameConfigTools.GenConfigDict <int,character> ();interactions = GameConfigTools.GenConfigDict <interactionAct,interaction> ();items = GameConfigTools.GenConfigDict <item_id,item> ();lock_areas = GameConfigTools.GenConfigDict <lock_area_id,lock_area> ();other_configs = GameConfigTools.GenConfigDict <int,other_config> ();passives = GameConfigTools.GenConfigDict <passive_id,passive> ();play_buffs = GameConfigTools.GenConfigDict <int,play_buff> ();props = GameConfigTools.GenConfigDict <prop_id,prop> ();push_buffs = GameConfigTools.GenConfigDict <string,push_buff> ();radar_waves = GameConfigTools.GenConfigDict <radar_wave_id,radar_wave> ();rogue_game_chapters = GameConfigTools.GenConfigDict <int,rogue_game_chapter> ();self_effects = GameConfigTools.GenConfigDict <self_id,self_effect> ();show_texts = GameConfigTools.GenConfigDict <string,show_text> ();skills = GameConfigTools.GenConfigDict <skill_id,skill> ();skill_groups = GameConfigTools.GenConfigDict <string,skill_group> ();snipes = GameConfigTools.GenConfigDict <int,snipe> ();standard_level_ups = GameConfigTools.GenConfigDict <int,standard_level_up> ();summons = GameConfigTools.GenConfigDict <summon_id,summon> ();talents = GameConfigTools.GenConfigDict <int,talent> ();traps = GameConfigTools.GenConfigDict <string,trap> ();vehicles = GameConfigTools.GenConfigDict <vehicle_id,vehicle> ();weapons = GameConfigTools.GenConfigDict <weapon_id,weapon> ();map_rawss = GameConfigTools.GenConfigDict <int,map_raws> ();battle_bots = GameConfigTools.GenConfigDict <int,battle_bot> ();}
#endif
public  void LoadAllByJson(string path = ""){bad_wordss = GameConfigTools.GenConfigDictByJsonFile <int,bad_words> (path);base_attributes = GameConfigTools.GenConfigDictByJsonFile <int,base_attribute> (path);battle_npcs = GameConfigTools.GenConfigDictByJsonFile <int,battle_npc> (path);bodys = GameConfigTools.GenConfigDictByJsonFile <size,body> (path);bullets = GameConfigTools.GenConfigDictByJsonFile <bullet_id,bullet> (path);caught_buffs = GameConfigTools.GenConfigDictByJsonFile <string,caught_buff> (path);characters = GameConfigTools.GenConfigDictByJsonFile <int,character> (path);interactions = GameConfigTools.GenConfigDictByJsonFile <interactionAct,interaction> (path);items = GameConfigTools.GenConfigDictByJsonFile <item_id,item> (path);lock_areas = GameConfigTools.GenConfigDictByJsonFile <lock_area_id,lock_area> (path);other_configs = GameConfigTools.GenConfigDictByJsonFile <int,other_config> (path);passives = GameConfigTools.GenConfigDictByJsonFile <passive_id,passive> (path);play_buffs = GameConfigTools.GenConfigDictByJsonFile <int,play_buff> (path);props = GameConfigTools.GenConfigDictByJsonFile <prop_id,prop> (path);push_buffs = GameConfigTools.GenConfigDictByJsonFile <string,push_buff> (path);radar_waves = GameConfigTools.GenConfigDictByJsonFile <radar_wave_id,radar_wave> (path);rogue_game_chapters = GameConfigTools.GenConfigDictByJsonFile <int,rogue_game_chapter> (path);self_effects = GameConfigTools.GenConfigDictByJsonFile <self_id,self_effect> (path);show_texts = GameConfigTools.GenConfigDictByJsonFile <string,show_text> (path);skills = GameConfigTools.GenConfigDictByJsonFile <skill_id,skill> (path);skill_groups = GameConfigTools.GenConfigDictByJsonFile <string,skill_group> (path);snipes = GameConfigTools.GenConfigDictByJsonFile <int,snipe> (path);standard_level_ups = GameConfigTools.GenConfigDictByJsonFile <int,standard_level_up> (path);summons = GameConfigTools.GenConfigDictByJsonFile <summon_id,summon> (path);talents = GameConfigTools.GenConfigDictByJsonFile <int,talent> (path);traps = GameConfigTools.GenConfigDictByJsonFile <string,trap> (path);vehicles = GameConfigTools.GenConfigDictByJsonFile <vehicle_id,vehicle> (path);weapons = GameConfigTools.GenConfigDictByJsonFile <weapon_id,weapon> (path);map_rawss = GameConfigTools.GenConfigDictByJsonFile <int,map_raws> (path);battle_bots = GameConfigTools.GenConfigDictByJsonFile <int,battle_bot> (path);}public void LoadAllByJsonString(Dictionary<string,string> nameToJsonString ){bad_wordss = GameConfigTools.GenConfigDictByJsonString <int,bad_words> (nameToJsonString["bad_words"] );base_attributes = GameConfigTools.GenConfigDictByJsonString <int,base_attribute> (nameToJsonString["base_attribute"] );battle_npcs = GameConfigTools.GenConfigDictByJsonString <int,battle_npc> (nameToJsonString["battle_npc"] );bodys = GameConfigTools.GenConfigDictByJsonString <size,body> (nameToJsonString["body"] );bullets = GameConfigTools.GenConfigDictByJsonString <bullet_id,bullet> (nameToJsonString["bullet"] );caught_buffs = GameConfigTools.GenConfigDictByJsonString <string,caught_buff> (nameToJsonString["caught_buff"] );characters = GameConfigTools.GenConfigDictByJsonString <int,character> (nameToJsonString["character"] );interactions = GameConfigTools.GenConfigDictByJsonString <interactionAct,interaction> (nameToJsonString["interaction"] );items = GameConfigTools.GenConfigDictByJsonString <item_id,item> (nameToJsonString["item"] );lock_areas = GameConfigTools.GenConfigDictByJsonString <lock_area_id,lock_area> (nameToJsonString["lock_area"] );other_configs = GameConfigTools.GenConfigDictByJsonString <int,other_config> (nameToJsonString["other_config"] );passives = GameConfigTools.GenConfigDictByJsonString <passive_id,passive> (nameToJsonString["passive"] );play_buffs = GameConfigTools.GenConfigDictByJsonString <int,play_buff> (nameToJsonString["play_buff"] );props = GameConfigTools.GenConfigDictByJsonString <prop_id,prop> (nameToJsonString["prop"] );push_buffs = GameConfigTools.GenConfigDictByJsonString <string,push_buff> (nameToJsonString["push_buff"] );radar_waves = GameConfigTools.GenConfigDictByJsonString <radar_wave_id,radar_wave> (nameToJsonString["radar_wave"] );rogue_game_chapters = GameConfigTools.GenConfigDictByJsonString <int,rogue_game_chapter> (nameToJsonString["rogue_game_chapter"] );self_effects = GameConfigTools.GenConfigDictByJsonString <self_id,self_effect> (nameToJsonString["self_effect"] );show_texts = GameConfigTools.GenConfigDictByJsonString <string,show_text> (nameToJsonString["show_text"] );skills = GameConfigTools.GenConfigDictByJsonString <skill_id,skill> (nameToJsonString["skill"] );skill_groups = GameConfigTools.GenConfigDictByJsonString <string,skill_group> (nameToJsonString["skill_group"] );snipes = GameConfigTools.GenConfigDictByJsonString <int,snipe> (nameToJsonString["snipe"] );standard_level_ups = GameConfigTools.GenConfigDictByJsonString <int,standard_level_up> (nameToJsonString["standard_level_up"] );summons = GameConfigTools.GenConfigDictByJsonString <summon_id,summon> (nameToJsonString["summon"] );talents = GameConfigTools.GenConfigDictByJsonString <int,talent> (nameToJsonString["talent"] );traps = GameConfigTools.GenConfigDictByJsonString <string,trap> (nameToJsonString["trap"] );vehicles = GameConfigTools.GenConfigDictByJsonString <vehicle_id,vehicle> (nameToJsonString["vehicle"] );weapons = GameConfigTools.GenConfigDictByJsonString <weapon_id,weapon> (nameToJsonString["weapon"] );map_rawss = GameConfigTools.GenConfigDictByJsonString <int,map_raws> (nameToJsonString["map_raws"] );battle_bots = GameConfigTools.GenConfigDictByJsonString <int,battle_bot> (nameToJsonString["battle_bot"] );}}[Serializable] public class Gain:IGameConfig { public string item { get; set; } public int num { get; set; }  } [Serializable] public class Point:IGameConfig { public float x { get; set; } public float y { get; set; }  } [Serializable] public class Buff:IGameConfig { [JsonConverter(typeof(StringEnumConverter))]public size size { get; set; } [JsonConverter(typeof(StringEnumConverter))]public buff_type buff_type { get; set; } public string buff_id { get; set; }  } [Serializable] public class SimpleObj1:IGameConfig { public uint key_time { get; set; } public Point key_point { get; set; }  } [Serializable] public class Media:IGameConfig { [JsonConverter(typeof(StringEnumConverter))]public effect_media_type media_type { get; set; } public string e_id { get; set; }  } [Serializable] public class Cost:IGameConfig { public string item { get; set; } public int num { get; set; } public int first_use_pay { get; set; }  } [Serializable] public class SimpleObj2:IGameConfig { [JsonConverter(typeof(StringEnumConverter))]public size body { get; set; } public float snipe_speed_fix { get; set; } public string skill_group { get; set; }  } [Serializable] public class TelPoint:IGameConfig { [JsonConverter(typeof(StringEnumConverter))]public direction Direction { get; set; } public Point[] Teleport { get; set; }  } [Serializable] public class SimpleObj3:IGameConfig { public int weight { get; set; } [JsonConverter(typeof(StringEnumConverter))]public botOp op { get; set; }  } [Serializable] public class SimpleObj4:IGameConfig { public uint item1 { get; set; } public uint item2 { get; set; }  } }